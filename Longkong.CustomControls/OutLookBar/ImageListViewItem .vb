...
#Region "Members"
        ...
        Private m_drawLarge As Boolean
...
#Region "Properties"
        ...
        <Description("Image Index used to display associated image"), Category("Appearance")> _
...
#End Region
        ...
        ByVal maxWidth As Integer, ByVal state As ListViewItemState) Implements ITabItem.Draw
            ...
            m_location = location
            If m_drawLarge Then
                m_image = m_parent.LargeImageList.Images(m_imageIndex)
            Else
                m_image = m_parent.SmallImageList.Images(m_imageIndex)
            End If
