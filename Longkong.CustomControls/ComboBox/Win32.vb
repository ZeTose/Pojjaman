...
Namespace Longkong.CustomControl.Win32
...
#Region "Enumerations"
    ...
    Public Enum CustomDrawStateFlags
        ...
        cddsPostErase = &H4
        cddsItem = &H10000
        cddsItemPrePaint = (Longkong.CustomControl.Win32.CustomDrawStateFlags.cddsItem Or Longkong.CustomControl.Win32.CustomDrawStateFlags.cddsPrePaint)
        cddsItemPostPaint = (Longkong.CustomControl.Win32.CustomDrawStateFlags.cddsItem Or Longkong.CustomControl.Win32.CustomDrawStateFlags.cddsPostPaint)
        cddsItemPreErase = (Longkong.CustomControl.Win32.CustomDrawStateFlags.cddsItem Or Longkong.CustomControl.Win32.CustomDrawStateFlags.cddsPreErase)
        cddsItemPostErase = (Longkong.CustomControl.Win32.CustomDrawStateFlags.cddsItem Or Longkong.CustomControl.Win32.CustomDrawStateFlags.cddsPostErase)
        cddsSubItem = &H20000
    End Enum
    ...
    Public Enum NotificationMessages
        nmFirst = 0
        nmCustomDraw = (Longkong.CustomControl.Win32.NotificationMessages.nmFirst - 12)
        nmNCHitTest = (Longkong.CustomControl.Win32.NotificationMessages.nmFirst - 14)
    End Enum
    ...
    Public Enum ReflectedMessages
        ocmBase = (Longkong.CustomControl.Win32.WindowMessages.wmUser + &H1C00)
        ocmCommand = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmCommand)
        ocmCTLColorButton = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmCTLColorButton)
        ocmCTLColorEdit = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmCTLColorEdit)
        ocmCTLColorDialog = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmCTLColorDialog)
        ocmCTLColorListBox = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmCTLColorListBox)
        ocmCTLColorMsgBox = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmCTLColorMsgBox)
        ocmCTLColorScrollbar = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmCTLColorScrollbar)
        ocmCTLColorStatic = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmCTLColorStatic)
        ocmCTLColor = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmCTLColor)
        ocmDrawItem = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmDrawItem)
        ocmMeasureItem = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmMeasureItem)
        ocmDeleteItem = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmDeleteItem)
        ocmVKeyToItem = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmVKeyToItem)
        ocmCharToItem = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmCharToItem)
        ocmCompareItem = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmCompareItem)
        ocmHScroll = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmHScroll)
        ocmVScroll = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmVScroll)
        ocmParentNotify = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmParentNotify)
        ocmNotify = (Longkong.CustomControl.Win32.ReflectedMessages.ocmBase + Longkong.CustomControl.Win32.WindowMessages.wmNotify)
    End Enum
...
#Region "Longkong.CustomControl Structures"

    'MinMax Info Structure
    <StructLayout(LayoutKind.Sequential)> _
    Public Structure MINMAXINFO
        Dim Reserved As Longkong.CustomControl.Win32.POINTAPI
        Dim MaxSize As Longkong.CustomControl.Win32.POINTAPI
        Dim MaxPosition As Longkong.CustomControl.Win32.POINTAPI
        Dim MinTrackSize As Longkong.CustomControl.Win32.POINTAPI
        Dim MaxTrackSize As Longkong.CustomControl.Win32.POINTAPI
    End Structure
    ...
    Public Structure PAINTSTRUCT
        ...
        Dim rcPaint As Longkong.CustomControl.Win32.RECT
...
#Region "Declarations"
        ...
        'API Declarations
        Private Declare Auto Function GetClientRect Lib "user32.dll" (ByVal hWnd As IntPtr, ByRef Rect As Longkong.CustomControl.Win32.RECT) As Integer
        ...
        Private Declare Auto Function InvalidateRect Lib "user32.dll" (ByVal hWnd As IntPtr, ByRef pRect As Longkong.CustomControl.Win32.RECT, ByVal [Erase] As Integer) As Integer
        ...
        Private Declare Auto Function RedrawWindow Lib "user32.dll" (ByVal Handle As IntPtr, ByRef UpdateRect As Longkong.CustomControl.Win32.RECT, ByVal RgnUpdate As Integer, ByVal fuRedraw As Integer) As Integer
...
#Region "Shared Properties"
        ...
        Shared Property PropertyValue(ByVal Handle As IntPtr, ByVal PropType As Longkong.CustomControl.Win32.WindowProperties) As Integer
            Get
...
#Region "Shared Methods"
        ...
        Shared Function ConvertRectangleToRECT(ByVal Rect As Rectangle) As Longkong.CustomControl.Win32.RECT
            Dim pRect As Longkong.CustomControl.Win32.RECT
        ...
        'Function to Convert a Rectangle to a RECT Structure
        Shared Function ConvertRECTtoRectangle(ByVal Rect As Longkong.CustomControl.Win32.RECT) As Rectangle
            Return New Rectangle(Rect.Left, Rect.Top, Rect.Right - Rect.Left, Rect.Bottom - Rect.Top)
        End Function

        'Function to Get a Client Rectangle
        Shared Function GetClientRectangle(ByVal Handle As IntPtr) As Rectangle
            Dim vRect As New Longkong.CustomControl.Win32.RECT
            Call Longkong.CustomControl.Win32.Window.GetClientRect(Handle, vRect)
            Return Longkong.CustomControl.Win32.Window.ConvertRECTtoRectangle(vRect)
            vRect = Nothing
        End Function
        ...
        Shared Function GetDialogItem(ByVal Dialog As IntPtr, ByVal ControlID As Integer) As IntPtr
            Return Longkong.CustomControl.Win32.Window.GetDlgItem(Dialog, ControlID)
        End Function
        ...
        Shared Sub InvalidateRectangle(ByVal Handle As IntPtr, ByRef Rect As Rectangle, ByVal [Erase] As Boolean)
            Dim vRect As Longkong.CustomControl.Win32.RECT = Longkong.CustomControl.Win32.Window.ConvertRectangleToRECT(Rect)
            Call Longkong.CustomControl.Win32.Window.InvalidateRect(Handle, vRect, Math.Abs(CType([Erase], Integer)))
            vRect = Nothing
        End Sub

        'Routine to Invalidate a Rectangle
        Shared Sub InvalidateRectangle(ByVal Handle As IntPtr, ByRef Rect As IntPtr, ByVal [Erase] As Boolean)
            Call Longkong.CustomControl.Win32.Window.InvalidateRectPointer(Handle, Rect, CType([Erase], Integer))
        End Sub
        ...
        Shared Sub Position(ByVal Handle As IntPtr, ByVal PositionMode As Longkong.CustomControl.Win32.WindowPositionModes, ByVal x As Integer, ByVal y As Integer, ByVal cx As Integer, ByVal cy As Integer, ByVal SizeMode As Longkong.CustomControl.Win32.WindowSizeModes)
            Call Window.SetWindowPos(Handle, PositionMode, x, y, cx, cy, SizeMode)
        End Sub

        'Routine to Redraw the Window
        Shared Sub ReDraw(ByVal Handle As IntPtr, ByVal RedrawMode As Longkong.CustomControl.Win32.RedrawWindowMessages)
            Call Longkong.CustomControl.Win32.Window.RedrawWindow(Handle, 0, 0, RedrawMode)
        End Sub

        'Routine to Redraw the Window
        Shared Sub ReDraw(ByVal Handle As IntPtr, ByVal DrawRect As Rectangle, ByVal RedrawMode As Longkong.CustomControl.Win32.RedrawWindowMessages)
            Dim vRect As Longkong.CustomControl.Win32.RECT = Longkong.CustomControl.Win32.Window.ConvertRectangleToRECT(DrawRect)
            Call Longkong.CustomControl.Win32.Window.RedrawWindow(Handle, vRect, 0, RedrawMode)
        End Sub
        ...
        Shared Sub Show(ByVal Handle As IntPtr, ByVal ShowMode As Longkong.CustomControl.Win32.WindowShowModes)
