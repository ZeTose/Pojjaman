    ...
    Public Sub ChangeProperty(ByVal sender As Object, ByVal e As EventArgs)
      ...
      Select Case CType(sender, Control).Name.ToLower
        ...
        Case "txtreturnpersoncode"
          ...
          dirtyFlag = RunningEmployee.GetEmployee(txtReturnPersonCode, txtReturnPersonName, Me.m_entity.ReturnPerson)
        ...
        Case "txtrecievepersoncode"
          ...
          dirtyFlag = RunningEmployee.GetEmployee(txtRecievePersonCode, txtRecievePersonName, Me.m_entity.Storeperson)
...
#Region " Event of Button controls "
    ...
    Private Sub btnReturnPersonFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReturnPersonFind.Click
      ...
      If Me.m_entity.IsExternal Then
        myEntityPanelService.OpenListDialog(New ContactCustomer, AddressOf SetReturnPersonDialog)
      Else
        myEntityPanelService.OpenListDialog(New RunningEmployee, AddressOf SetReturnPersonDialog)
      End If
    ...
    Private Sub btnRecievePersonFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnRecievePersonFind.Click
      Dim myEntityPanelService As IEntityPanelService = _
      CType(ServiceManager.Services.GetService(GetType(IEntityPanelService)), IEntityPanelService)
      myEntityPanelService.OpenListDialog(New RunningEmployee, AddressOf SetRecievePersonDialog)
    End Sub
