...
Namespace Longkong.Pojjaman.Gui.Panels
  Public Class RptMatCountFilterSubPanel
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents chkNegativeOnly As System.Windows.Forms.CheckBox
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(RptMatCountFilterSubPanel))
      Me.grbMaster = New Longkong.Pojjaman.Gui.Components.FixedGroupBox
      Me.grbDetail = New Longkong.Pojjaman.Gui.Components.FixedGroupBox
      Me.chkNoZero = New System.Windows.Forms.CheckBox
      Me.chkNegativeOnly = New System.Windows.Forms.CheckBox
      ...
      Me.grbMaster.Size = New System.Drawing.Size(472, 200)
      ...
      Me.grbDetail.Controls.Add(Me.chkNoZero)
      Me.grbDetail.Controls.Add(Me.chkNegativeOnly)
      ...
      'chkNoZero
      '
      Me.chkNoZero.FlatStyle = System.Windows.Forms.FlatStyle.System
      Me.chkNoZero.Location = New System.Drawing.Point(152, 112)
      Me.chkNoZero.Name = "chkNoZero"
      Me.chkNoZero.Size = New System.Drawing.Size(248, 24)
      Me.chkNoZero.TabIndex = 16
      Me.chkNoZero.Text = "ไม่แสดงยอด = 0"
      '
      'chkNegativeOnly
      '
      Me.chkNegativeOnly.FlatStyle = System.Windows.Forms.FlatStyle.System
      Me.chkNegativeOnly.Location = New System.Drawing.Point(152, 88)
      Me.chkNegativeOnly.Name = "chkNegativeOnly"
      Me.chkNegativeOnly.Size = New System.Drawing.Size(248, 24)
      Me.chkNegativeOnly.TabIndex = 15
      Me.chkNegativeOnly.Text = "แสดงเฉพาะยอดที่ติดลบ"
      '
      'txtLciend
      '
      ...
      Me.lblDocDateEnd.Location = New System.Drawing.Point(120, 16)
      ...
      Me.btnSearch.Location = New System.Drawing.Point(384, 168)
      ...
      Me.btnReset.Location = New System.Drawing.Point(304, 168)
      ...
      '
      'RptMatCountFilterSubPanel
      '
      Me.Controls.Add(Me.grbMaster)
      Me.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(222, Byte))
      Me.Name = "RptMatCountFilterSubPanel"
...
#Region "Methods"
    ...
    Public Overrides Function GetFilterArray() As Filter()
      Dim arr(8) As Filter
      arr(0) = New Filter("DocDateStart", DBNull.Value) 'From the beginning
      arr(1) = New Filter("DocDateEnd", IIf(Me.DocDateEnd.Equals(Date.MinValue), DBNull.Value, Me.DocDateEnd))
      arr(2) = New Filter("ToCCCodeStart", IIf(txtToCCstart.TextLength > 0, txtToCCstart.Text, DBNull.Value))
      arr(3) = New Filter("ToCCCodeEnd", IIf(txtToCCend.TextLength > 0, txtToCCend.Text, DBNull.Value))
      ...
      arr(7) = New Filter("nozero", Me.chkNoZero.Checked)
...
#Region "IReportFilterSubPanel"
    Public Function GetFixValueCollection() As BusinessLogic.DocPrintingItemCollection Implements IReportFilterSubPanel.GetFixValueCollection
      ...
      dpiColl.Add(dpi)
            ...
            'NeqativeOnly
            If chkNegativeOnly.Checked Then
                dpi = New DocPrintingItem
                dpi.Mapping = "NeqativeOnly"
                dpi.Value = chkNegativeOnly.Text
                dpi.DataType = "System.String"
                dpiColl.Add(dpi)
            Else
                dpi = New DocPrintingItem
            ...
            'NoZero
            If chkNoZero.Checked Then
                dpi = New DocPrintingItem
                dpi.Mapping = "NoZero"
                dpi.Value = chkNoZero.Text
                dpi.DataType = "System.String"
                dpiColl.Add(dpi)
            Else
                dpi = New DocPrintingItem
