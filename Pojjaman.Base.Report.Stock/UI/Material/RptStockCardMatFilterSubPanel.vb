...
Namespace Longkong.Pojjaman.Gui.Panels
  Public Class RptStockCardMatFilterSubPanel
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents chkNomove As System.Windows.Forms.CheckBox
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      Me.components = New System.ComponentModel.Container
      Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(RptStockCardMatFilterSubPanel))
      ...
      Me.chkNomove = New System.Windows.Forms.CheckBox
      ...
      Me.grbMaster.Controls.Add(Me.chkNomove)
      ...
      Me.grbMaster.Size = New System.Drawing.Size(488, 184)
      ...
      Me.btnReset.Location = New System.Drawing.Point(320, 152)
      ...
      'chkNomove
      '
      Me.chkNomove.Location = New System.Drawing.Point(170, 112)
      Me.chkNomove.Name = "chkNomove"
      Me.chkNomove.Size = New System.Drawing.Size(216, 24)
      Me.chkNomove.TabIndex = 3
      Me.chkNomove.Text = "แสดงรายการที่ไม่มีการเคลื่อนไหววัสดุ"
      '
      'RptStockCardMatFilterSubPanel
      '
      Me.Controls.Add(Me.grbMaster)
      Me.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(222, Byte))
      Me.Name = "RptStockCardMatFilterSubPanel"
...
#Region " SetLabelText "
    Public Sub SetLabelText()
      ...
      Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptStockCardMatFilterSubPanel.lblDocDateStart}")
      Me.Validator.SetDisplayName(txtDocDateStart, lblDocDateStart.Text)

      Me.lblCCstart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptStockCardMatFilterSubPanel.lblCCstart}")
      Me.Validator.SetDisplayName(txtCCstart, lblCCstart.Text)

      Me.lblLcistart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptStockCardMatFilterSubPanel.lblLcistart}")
      Me.Validator.SetDisplayName(txtLcistart, lblLcistart.Text)

      Me.chkNomove.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptStockCardMatFilterSubPanel.chkNomove}")
      ...
      ' GroupBox
      Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptStockCardMatFilterSubPanel.grbMaster}")
      Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptStockCardMatFilterSubPanel.grbDetail}")
    End Sub
#End Region
...
#Region "Methods"
    ...
    Public Overrides Function GetFilterArray() As Filter()
      ...
      arr(7) = New Filter("NoMove", IIf(chkNomove.Checked, 1, 0))
      Return arr
    End Function
...
#Region "IReportFilterSubPanel"
    Public Function GetFixValueCollection() As BusinessLogic.DocPrintingItemCollection Implements IReportFilterSubPanel.GetFixValueCollection
      ...
      'NoMove
      If chkNomove.Checked Then
        dpi = New DocPrintingItem
        dpi.Mapping = "NoTransection"
        dpi.Value = chkNomove.Text
        dpi.DataType = "System.String"
        dpiColl.Add(dpi)
      End If
