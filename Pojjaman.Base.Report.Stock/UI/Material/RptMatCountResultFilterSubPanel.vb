...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class RptMatCountResultFilterSubPanel
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(RptMatCountResultFilterSubPanel))
            ...
            Me.grbMaster.Size = New System.Drawing.Size(488, 176)
            ...
            Me.lblOrderBy.Location = New System.Drawing.Point(8, 88)
            ...
            'cmbOrderBy
            '
            Me.cmbOrderBy.Location = New System.Drawing.Point(152, 88)
            ...
            Me.btnSearch.Location = New System.Drawing.Point(400, 144)
            ...
            Me.btnReset.Location = New System.Drawing.Point(320, 144)
            ...
            '
            'RptMatCountResultFilterSubPanel
            '
            Me.Controls.Add(Me.grbMaster)
            Me.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(222, Byte))
            Me.Name = "RptMatCountResultFilterSubPanel"
            Me.Size = New System.Drawing.Size(512, 192)
...
#Region " SetLabelText "
        Public Sub SetLabelText()
            ...
            Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptMatCountResultFilterSubPanel.lblDocDateStart}")
            Me.Validator.SetDisplayName(txtDocDateStart, lblDocDateStart.Text)

            Me.lblFromCCstart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptMatCountResultFilterSubPanel.lblFromCCstart}")
            Me.Validator.SetDisplayName(txtFromCCstart, lblFromCCstart.Text)

            Me.lblToCCstart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptMatCountResultFilterSubPanel.lblToCCstart}")
            ...
            ' GroupBox
            Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptMatCountResultFilterSubPanel.grbMaster}")
            Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptMatCountResultFilterSubPanel.grbDetail}")
            Me.lblOrderBy.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptMatCountResultFilterSubPanel.lblOrderBy}")
        End Sub
#End Region
