...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class RptStockOutCardFilterSubPanel
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(RptStockOutCardFilterSubPanel))
            ...
            '
            'RptStockOutCardFilterSubPanel
            '
            Me.Controls.Add(Me.grbMaster)
            Me.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(222, Byte))
            Me.Name = "RptStockOutCardFilterSubPanel"
...
#Region " SetLabelText "
        Public Sub SetLabelText()
            ...
            Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptStockOutCardFilterSubPanel.lblDocDateStart}")
            Me.Validator.SetDisplayName(txtDocDateStart, lblDocDateStart.Text)

            Me.lblCCstart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptStockOutCardFilterSubPanel.lblCCstart}")
            Me.Validator.SetDisplayName(txtCCstart, lblCCstart.Text)

            Me.lblLcistart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptStockOutCardFilterSubPanel.lblLcistart}")
            ...
            ' GroupBox
            Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptStockOutCardFilterSubPanel.grbMaster}")
            Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptStockOutCardFilterSubPanel.grbDetail}")
        End Sub
#End Region
