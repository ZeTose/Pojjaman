...
#Region "Methods"
    ...
    Private Sub PopulateData()
      ...
      For Each row As DataRow In dt.Rows
        ...
        '  m_grid(currItemIndex, 5).CellValue = Configuration.FormatToString(CDec(row("taxbase")), DigitConfig.Price)
        '  'SumAmount += CDec(row("sc_gross"))
        'End If
        'If Not row.IsNull("aftertax") Then
        '  m_grid(currItemIndex, 6).CellValue = Configuration.FormatToString(CDec(row("aftertax")), DigitConfig.Price)
        ...
        '  m_grid(currItemIndex, 9).CellValue = Configuration.FormatToString(CDec(row("wht")), DigitConfig.Price)
        '  'SumTaxAmt += CDec(row("sc_taxamt"))
        'End If
