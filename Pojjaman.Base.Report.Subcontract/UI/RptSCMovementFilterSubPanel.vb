...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(RptSCMovementFilterSubPanel))
            ...
            Me.cmbDocStatus.Location = New System.Drawing.Point(120, 88)
            ...
            Me.lblDocStatus.Location = New System.Drawing.Point(32, 88)
            ...
            Me.lblCCStart.Location = New System.Drawing.Point(384, 40)
            ...
            Me.txtEmployee.Location = New System.Drawing.Point(152, 136)
            ...
            Me.btnEmployee.Location = New System.Drawing.Point(248, 136)
            ...
            Me.txtEmployeeName.Location = New System.Drawing.Point(272, 136)
            ...
            Me.lblEmployee.Location = New System.Drawing.Point(64, 136)
            ...
            Me.chkIsSum.Location = New System.Drawing.Point(256, 88)
            Me.chkIsSum.Name = "chkIsSum"
            Me.chkIsSum.Size = New System.Drawing.Size(128, 24)
...
#Region " SetLabelText "
        Public Sub SetLabelText()
            ...
            'Me.lblCCStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptSCMovementFilterSubPanel.lblCostcenterStart}")
...
#Region "Methods"
        ...
        Public Overrides Function GetFilterArray() As Filter()
            ...
            'arr(10) = New Filter("status", cmbStatus.SelectedIndex) ' IIf(cmbDocStatus.SelectedItem Is Nothing, DBNull.Value, CType(cmbDocStatus.SelectedItem, IdValuePair).Id))
            Return arr
        End Function
        ...
        Private Sub ChangeProperty(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Select Case CType(sender, Control).Name.ToLower
                ...
                Case "txtsupplicodestart"
                    Subcontractor.GetSupplier(txtSuppliCodeStart, Me.txtEmployee, Subcontractor)
                Case "txtsupplicodeend"
                    Subcontractor.GetSupplier(txtSuppliCodeEnd, Me.txtEmployee, Subcontractor)
