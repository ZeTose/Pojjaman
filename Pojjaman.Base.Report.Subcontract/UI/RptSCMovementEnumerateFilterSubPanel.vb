...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class RptSCMovementEnumerateFilterSubPanel
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(RptSCMovementEnumerateFilterSubPanel))
            ...
            Me.grbMaster.Size = New System.Drawing.Size(824, 200)
            ...
            Me.cmbStatus.Location = New System.Drawing.Point(496, 112)
            ...
            Me.Label1.Location = New System.Drawing.Point(432, 112)
            ...
            Me.cmbDocStatus.Location = New System.Drawing.Point(496, 88)
            ...
            Me.lblDocStatus.Location = New System.Drawing.Point(408, 88)
            ...
            Me.btnSuppliEndFind.Location = New System.Drawing.Point(752, 16)
            ...
            Me.txtSuppliCodeEnd.Location = New System.Drawing.Point(656, 16)
            ...
            Me.lblSuppliEnd.Location = New System.Drawing.Point(624, 16)
            ...
            Me.btnSuppliStartFind.Location = New System.Drawing.Point(592, 16)
            ...
            Me.txtSuppliCodeStart.Location = New System.Drawing.Point(496, 16)
            ...
            Me.lblSuppliStart.Location = New System.Drawing.Point(424, 16)
            ...
            Me.chkIncludeChildren.Location = New System.Drawing.Point(496, 64)
            ...
            Me.btnCCCodeStart.Location = New System.Drawing.Point(592, 40)
            ...
            Me.txtCCCodeStart.Location = New System.Drawing.Point(496, 40)
            ...
            Me.lblCCStart.Location = New System.Drawing.Point(424, 40)
            ...
            Me.txtCostCenterName.Location = New System.Drawing.Point(616, 40)
            ...
            Me.txtEmployee.Location = New System.Drawing.Point(120, 88)
            ...
            Me.btnEmployee.Location = New System.Drawing.Point(216, 88)
            ...
            Me.lblEmployee.Location = New System.Drawing.Point(32, 88)
            ...
            Me.btnSearch.Location = New System.Drawing.Point(732, 168)
            ...
            Me.btnReset.Location = New System.Drawing.Point(652, 168)
            ...
            '
            'RptSCMovementEnumerateFilterSubPanel
            '
            Me.Controls.Add(Me.grbMaster)
            Me.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(222, Byte))
            Me.Name = "RptSCMovementEnumerateFilterSubPanel"
            Me.Size = New System.Drawing.Size(848, 200)
...
#Region " SetLabelText "
        Public Sub SetLabelText()
            ...
            'Me.lblCCStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptSCMovementEnumerateFilterSubPanel.lblCostcenterStart}")
            'Me.Validator.SetDisplayName(txtCCCodeStart, lblCCStart.Text)

            'Me.lblSuppliStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptSCMovementEnumerateFilterSubPanel.lblSuppliStart}")
            'Me.Validator.SetDisplayName(txtSuppliCodeStart, lblSuppliStart.Text)

            'Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptSCMovementEnumerateFilterSubPanel.lblDocDateStart}")
            'Me.Validator.SetDisplayName(txtDocDateStart, lblDocDateStart.Text)

            'Me.lblDocDateEnd.Text = Me.StringParserService.Parse("${res:Global.FilterPanelTo}")
            'Me.Validator.SetDisplayName(txtDocDateEnd, lblDocDateEnd.Text)

            'Me.lblEmployee.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptSCMovementEnumerateFilterSubPanel.lblEmployee}")
            ...
            '' GroupBox
            'Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptSCMovementEnumerateFilterSubPanel.grbMaster}")
            ...
            'Me.lblDocStatus.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptSCMovementEnumerateFilterSubPanel.lblDocStatus}")
            ...
            'Me.cmbDocStatus.Items.Add(Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptSCMovementEnumerateFilterSubPanel.cbAll}"))
            'Me.cmbDocStatus.Items.Add(Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptSCMovementEnumerateFilterSubPanel.cbCancel}"))
            'Me.cmbDocStatus.Items.Add(Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptSCMovementEnumerateFilterSubPanel.cbSave}")) 'บันทึกแล้ว
            'Me.cmbDocStatus.Items.Add(Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptSCMovementEnumerateFilterSubPanel.cbClose}")) 'ปิดแล้ว
            'Me.cmbDocStatus.SelectedIndex = 0

            ''สถานะรูปแบบการแสดงผล
            ''Me.lblDocStatus.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptSCMovementEnumerateFilterSubPanel.lblDocStatus}")
            ''Me.cmbStatus.Items.Add(Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptSCMovementEnumerateFilterSubPanel.cmbDocAll}")) 'เอกสารสั่งซื้อทั้งหมด
...
#Region "Methods"
        ...
        Public Overrides Function GetFilterArray() As Filter()
            ...
            arr(7) = New Filter("SubcontractorGroupID", Me.ValidIdOrDBNull(m_subcontractorgroup))
            arr(8) = New Filter("IncludeChildSubcontractorGroup", Me.chkIncludeChildSupplierGroup.Checked)
