...
#Region "Constructors"
        Public Sub New(ByVal entity As ISimpleEntity, ByVal mode As Selection, ByVal basket As BasketDialog, ByVal filters As Filter(), ByVal entities As ArrayList)
            ...
            'Hack
            m_filterSubPanel = New GoodsReceiptFilterSubPanel
...
#Region "Methods"
        ...
        Public Sub SearchData(ByVal order As String)
            ...
            Dim dt As TreeTable = GoodsReceiptItem.GetListDatatable(newfilters)
...
#Region "Style"
        Public Function CreateListTableStyle() As DataGridTableStyle
            ...
            Dim csToCostcenter As New TreeTextColumn
            csToCostcenter.MappingName = "ToCostcenter"
            csToCostcenter.HeaderText = "ToCostcenter"
            csToCostcenter.NullText = ""
            csToCostcenter.DataAlignment = HorizontalAlignment.Center
            csToCostcenter.Width = 100
            csToCostcenter.ReadOnly = True
            ...
            'dst.GridColumnStyles.Add(csToCostcenter)
            Return dst
        End Function
#End Region
                    ...
                    For Each childRow As TreeRow In row.Childs
                        If Not IsDBNull(childRow("Selected")) Then
                            If CBool(childRow("Selected")) Then
                                ...
                                Dim fullClassName As String = "Longkong.Pojjaman.BusinessLogic.GoodsReceiptItem"
