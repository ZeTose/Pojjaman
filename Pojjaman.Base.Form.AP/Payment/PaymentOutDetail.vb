...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Protected Sub InitializeComponent()
      ...
      Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(PaymentOutDetail))
      ...
      Me.ibtnTotalCredit.Image = CType(resources.GetObject("ibtnTotalCredit.Image"), System.Drawing.Image)
        ...
        If Not Me.m_payment Is Nothing Then
          If TypeOf Me.m_payment Is IPrintableEntity Then
            ...
            ElseIf File.Exists(thePath) Then
              Dim df As New DocumentForm(thePath, CType(Me.m_payment, IPrintableEntity))
              Return df.PrintDocument
            End If
          End If
        End If
