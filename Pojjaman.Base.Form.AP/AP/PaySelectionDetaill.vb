...
#Region "IListDetail"
    ...
    Public Overrides Property Entity() As ISimpleEntity
      ...
      Set(ByVal Value As ISimpleEntity)
        ...
        RemoveHandler m_entity.PurchaseCNClick, AddressOf ItemButtonForPurChaseClick 'ItemButtonClick
        AddHandler m_entity.PurchaseCNClick, AddressOf ItemButtonForPurChaseClick 'ItemButtonClick
...
#Region "Event Handlers"
    ...
    Private Sub UpdateAutogenStatus()
      ...
      End If
    End Sub
    Public Sub ItemButtonForPurChaseClick(ByVal e As ButtonColumnEventArgs)
      Dim msgServ As IMessageService = CType(ServiceManager.Services.GetService(GetType(IMessageService)), IMessageService)
      If Me.m_entity Is Nothing Then
        Return
      End If
      ...
      filterEntities(0).Add(Me.m_entity.Supplier)

      Dim filters(0)() As Filter

      filters(0) = New Filter() {New Filter("IDList", GetItemIDList(46))}

      Dim entities(0) As ISimpleEntity
      entities(0) = New PurchaseCNForPaySelection
...
#Region "Overrides"
    ...
    Public Overrides ReadOnly Property TabPageIcon() As String
      Get
        Return (New PaySelection).DetailPanelIcon
      End Get
    End Property
#End Region
