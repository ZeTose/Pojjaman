...
Namespace Longkong.Pojjaman.Gui.Panels
  Public Class RptAPEnumerateFilterSubPanel
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(RptAPEnumerateFilterSubPanel))
      ...
      Me.grbMaster.Size = New System.Drawing.Size(448, 288)
      ...
      Me.grbDetail.Size = New System.Drawing.Size(416, 234)
      ...
      Me.btnAccountEndFind.TabIndex = 15
      ...
      Me.btnAccountStartFind.TabIndex = 14
      ...
      Me.btnSupplierGroupStart.TabIndex = 9
...
#Region " SetLabelText "
    Public Sub SetLabelText()
      ...
      Me.lblSuppliStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPEnumerateFilterSubPanel.lblSuppliStart}")
      Me.Validator.SetDisplayName(txtSuppliCodeStart, lblSuppliStart.Text)

      Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPEnumerateFilterSubPanel.lblDocDateStart}")
      Me.Validator.SetDisplayName(txtDocDateStart, lblDocDateStart.Text)

      'SupplierGroup
      Me.lblSupplierGroup.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPEnumerateFilterSubPanel.lblSupplierGroup}")
      Me.Validator.SetDisplayName(txtSupplierGroupStart, lblSupplierGroup.Text)
      Me.chkIncludeSGChildren.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPEnumerateFilterSubPanel.chkIncludeSGChildren}")

      Me.lblCCStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPEnumerateFilterSubPanel.lblCCStart}")
      ...
      ' GroupBox
      Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPEnumerateFilterSubPanel.grbMaster}")
      Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPEnumerateFilterSubPanel.grbDetail}")

      'Checkbox
      Me.chkIncludeChildren.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPEnumerateFilterSubPanel.chkIncludeChildren}")

      Me.lblAccountStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPEnumerateFilterSubPanel.lblAccountStart}")
      Me.rdbBillissue.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPEnumerateFilterSubPanel.rdbBillissue}")
      Me.rdbPaySelection.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPEnumerateFilterSubPanel.rdbPaySelection}")
    End Sub
#End Region
...
#Region "Methods"
    ...
    Public Overrides Function GetFilterArray() As Filter()
      ...
      arr(11) = New Filter("retentionview", IIf(rdbBillissue.Checked, 0, 1))
      Return arr
    End Function
