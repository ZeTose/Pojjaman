...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class RptCCExpenseSummaryFilterSubPanel
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(RptCCExpenseSummaryFilterSubPanel))
            ...
            Me.grbMaster.Size = New System.Drawing.Size(440, 248)
            ...
            Me.grbDetail.Controls.Add(Me.chkInternal)
            ...
            'chkInternal
            '
            Me.chkInternal.FlatStyle = System.Windows.Forms.FlatStyle.System
            Me.chkInternal.Location = New System.Drawing.Point(120, 160)
            Me.chkInternal.Name = "chkInternal"
            Me.chkInternal.Size = New System.Drawing.Size(128, 24)
            Me.chkInternal.TabIndex = 9
            Me.chkInternal.Text = "รวมเอกสารภายใน"
            '
            'chkIncludeChildren
            '
            ...
            Me.btnSearch.Location = New System.Drawing.Point(348, 216)
            ...
            Me.btnReset.Location = New System.Drawing.Point(268, 216)
            ...
            '
            'RptCCExpenseSummaryFilterSubPanel
            '
            Me.Controls.Add(Me.grbMaster)
            Me.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(222, Byte))
            Me.Name = "RptCCExpenseSummaryFilterSubPanel"
            Me.Size = New System.Drawing.Size(472, 264)
...
#Region " SetLabelText "
        Public Sub SetLabelText()
            ...
            Me.lblSuppliStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCExpenseSummaryFilterSubPanel.lblSuppliStart}")
            Me.Validator.SetDisplayName(txtSuppliCodeStart, lblSuppliStart.Text)

            Me.lblCCStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCExpenseSummaryFilterSubPanel.lblCostcenterStart}")
            Me.Validator.SetDisplayName(txtCCCodeStart, lblCCStart.Text)

            Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCExpenseSummaryFilterSubPanel.lblDocDateStart}")
            ...
            ' GroupBox
            Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCExpenseSummaryFilterSubPanel.grbMaster}")
            Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCExpenseSummaryFilterSubPanel.grbDetail}")

            Me.chkIncludeChildren.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCExpenseSummaryFilterSubPanel.chkIncludeChildren}")
            Me.chkInternal.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCExpenseSummaryFilterSubPanel.chkInternal}")
            Me.lblSpgStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCExpenseSummaryFilterSubPanel.lblSpgStart}")
            Me.chkIncludeChildSupplierGroup.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCExpenseSummaryFilterSubPanel.chkIncludeChildSupplierGroup}")
...
#Region "Methods"
        ...
        Public Overrides Function GetFilterArray() As Filter()
            ...
            arr(6) = New Filter("IncludeInternal", Me.chkInternal.Checked)
            arr(7) = New Filter("SupplierGroupID", Me.ValidIdOrDBNull(m_suppliergroup))
            arr(8) = New Filter("IncludeChildSupplierGroup", Me.chkIncludeChildSupplierGroup.Checked)
...
#Region "IReportFilterSubPanel"
        Public Function GetFixValueCollection() As BusinessLogic.DocPrintingItemCollection Implements IReportFilterSubPanel.GetFixValueCollection
            ...
            'CostCenter Start
            dpi = New DocPrintingItem
            dpi.Mapping = "CostcenterStartName"
            ...
            'CostCenter StartCode
            dpi = New DocPrintingItem
            dpi.Mapping = "CostcenterStartCode"
            dpi.Value = Me.txtCCCodeStart.Text
            dpi.DataType = "System.String"
            dpiColl.Add(dpi)

            'CostCenter Start Info
            dpi = New DocPrintingItem
            dpi.Mapping = "CostcenterStartInfo"
            ...
            If Me.chkIncludeChildSupplierGroup.Checked Then
                ...
                dpi.Value = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCExpenseSummaryFilterSubPanel.childSupplierGroupincluded}")
                dpi.DataType = "System.String"
                dpiColl.Add(dpi)
            End If
...
#Region " ChangeProperty "
        ...
        Private Sub ChangeProperty(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Select Case CType(sender, Control).Name.ToLower
                Case "txtcccodestart"
                    Costcenter.GetCostCenter(txtCCCodeStart, Me.txtCostCenterName, m_cc)
