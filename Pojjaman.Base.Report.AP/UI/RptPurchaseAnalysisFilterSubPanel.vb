...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class RptPurchaseAnalysisFilterSubPanel
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(RptPurchaseAnalysisFilterSubPanel))
            ...
            Me.btnSearch.Location = New System.Drawing.Point(640, 192)
            ...
            Me.btnReset.Location = New System.Drawing.Point(560, 192)
            ...
            Me.grbDisplay.Size = New System.Drawing.Size(304, 168)
            Me.grbDisplay.TabIndex = 39
            ...
            '
            'RptPurchaseAnalysisFilterSubPanel
            '
            Me.Controls.Add(Me.grbMaster)
            Me.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(222, Byte))
            Me.Name = "RptPurchaseAnalysisFilterSubPanel"
...
#Region " SetLabelText "
        Public Sub SetLabelText()
            ...
            Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPurchaseAnalysisFilterSubPanel.lblDocDateStart}")
            Me.Validator.SetDisplayName(txtDocDateStart, lblDocDateStart.Text)

            Me.lblCCStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPurchaseAnalysisFilterSubPanel.lblCCStart}")
            ...
            ' GroupBox
            Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPurchaseAnalysisFilterSubPanel.grbMaster}")
            Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPurchaseAnalysisFilterSubPanel.grbDetail}")

            'Checkbox
            Me.chkIncludeChildren.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPurchaseAnalysisFilterSubPanel.chkIncludeChildren}")
            Me.lblSpgStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPurchaseAnalysisFilterSubPanel.lblSpgStart}")
            Me.chkIncludeChildSupplierGroup.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPurchaseAnalysisFilterSubPanel.chkIncludeChildSupplierGroup}")

            Me.grbTypeDisplay.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPurchaseAnalysisFilterSubPanel.grbTypeDisplay}") 'การแสดงผลตามประเภท
            Me.chkLCI.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPurchaseAnalysisFilterSubPanel.chkLCI}") 'วัสดุ
            Me.chkEtc.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPurchaseAnalysisFilterSubPanel.chkEtc}") 'อื่น ๆ
...
#Region " IReportFilterSubPanel "
        Public Function GetFixValueCollection() As BusinessLogic.DocPrintingItemCollection Implements IReportFilterSubPanel.GetFixValueCollection
            ...
            If Me.chkIncludeChildSupplierGroup.Checked Then
                ...
                dpi.Value = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPurchaseAnalysisFilterSubPanel.childSupplierGroupincluded}")
                dpi.DataType = "System.String"
                dpiColl.Add(dpi)
            End If
            ...
            If Me.chkMechine.Checked Then
                ...
                dpi.Value = "(แสดงประเภทค่าเช่าเครื่องจักร)"
                dpi.DataType = "System.String"
                dpiColl.Add(dpi)
            End If
