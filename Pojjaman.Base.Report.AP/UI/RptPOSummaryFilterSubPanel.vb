...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class RptPOSummaryFilterSubPanel
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(RptPOSummaryFilterSubPanel))
            ...
            Me.grbMaster.Size = New System.Drawing.Size(440, 224)
            ...
            Me.chkIncludeChildren.Size = New System.Drawing.Size(208, 24)
            ...
            Me.btnSearch.Location = New System.Drawing.Point(348, 192)
            ...
            Me.btnReset.Location = New System.Drawing.Point(268, 192)
            ...
            '
            'RptPOSummaryFilterSubPanel
            '
            Me.Controls.Add(Me.grbMaster)
            Me.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(222, Byte))
            Me.Name = "RptPOSummaryFilterSubPanel"
            Me.Size = New System.Drawing.Size(472, 240)
...
#Region " SetLabelText "
        Public Sub SetLabelText()
            ...
            Me.lblSuppliStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPOSummaryFilterSubPanel.lblSuppliStart}")
            Me.Validator.SetDisplayName(txtSuppliCodeStart, lblSuppliStart.Text)

            Me.lblCCStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPOSummaryFilterSubPanel.lblCostcenterStart}")
            Me.Validator.SetDisplayName(txtCCCodeStart, lblCCStart.Text)

            Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPOSummaryFilterSubPanel.lblDocDateStart}")
            ...
            ' GroupBox
            Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPOSummaryFilterSubPanel.grbMaster}")
            Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPOSummaryFilterSubPanel.grbDetail}")
            Me.lblSpgStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPOSummaryFilterSubPanel.lblSpgStart}")
            Me.chkIncludeChildSupplierGroup.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPOSummaryFilterSubPanel.chkIncludeChildSupplierGroup}")
...
#Region "IReportFilterSubPanel"
        Public Function GetFixValueCollection() As BusinessLogic.DocPrintingItemCollection Implements IReportFilterSubPanel.GetFixValueCollection
            ...
            If Me.chkIncludeChildSupplierGroup.Checked Then
                ...
                dpi.Value = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptPOSummaryFilterSubPanel.childSupplierGroupincluded}")
                dpi.DataType = "System.String"
                dpiColl.Add(dpi)
            End If
