...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class RptBillAcceptanceStatusFilterSubPanel
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RptBillAcceptanceStatusFilterSubPanel))
            ...
            Me.grbMaster.Size = New System.Drawing.Size(448, 228)
            ...
            Me.txtTemp.Location = New System.Drawing.Point(456, 32)
            ...
            Me.grbDetail.Size = New System.Drawing.Size(416, 171)
            ...
            Me.txtSupplierGroupStart.Location = New System.Drawing.Point(112, 40)
            ...
            Me.btnSupplierGroupStart.Location = New System.Drawing.Point(208, 40)
            ...
            Me.chkIncludeSGChildren.Location = New System.Drawing.Point(112, 64)
            ...
            'chkIncludeChildren
            '
            Me.chkIncludeChildren.Enabled = False
            ...
            Me.chkIncludeChildren.Visible = False
            '
            'btnCCCodeStart
            '
            ...
            Me.txtCostCenterName.Size = New System.Drawing.Size(168, 21)
            ...
            Me.btnSearch.Location = New System.Drawing.Point(357, 196)
            ...
            Me.btnReset.Location = New System.Drawing.Point(277, 196)
            ...
            Me.ChkShowAll.Location = New System.Drawing.Point(251, 141)
            Me.ChkShowAll.Name = "ChkShowAll"
            Me.ChkShowAll.Size = New System.Drawing.Size(128, 19)
            Me.ChkShowAll.TabIndex = 55
            Me.ChkShowAll.Text = "แสดงทุกเอกสาร"
            '
            'RptBillAcceptanceStatusFilterSubPanel
            '
            Me.Controls.Add(Me.grbMaster)
            Me.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(222, Byte))
            Me.Name = "RptBillAcceptanceStatusFilterSubPanel"
            Me.Size = New System.Drawing.Size(464, 249)
...
#Region " SetLabelText "
        Public Sub SetLabelText()
            ...
            Me.lblSuppliStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptBillAcceptanceStatusFilterSubPanel.lblSuppliStart}")
            Me.Validator.SetDisplayName(txtSuppliCodeStart, lblSuppliStart.Text)

            'SupplierGroup
            Me.lblSupplierGroup.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptBillAcceptanceStatusFilterSubPanel.lblSupplierGroup}")
            Me.Validator.SetDisplayName(txtSupplierGroupStart, lblSupplierGroup.Text)
            Me.chkIncludeSGChildren.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptBillAcceptanceStatusFilterSubPanel.chkIncludeSGChildren}")

            Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptBillAcceptanceStatusFilterSubPanel.lblDocDateStart}")
            Me.Validator.SetDisplayName(txtDocDateStart, lblDocDateStart.Text)

            Me.lblCCStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptBillAcceptanceStatusFilterSubPanel.lblCostcenterStart}")
            ...
            ' GroupBox
            Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptBillAcceptanceStatusFilterSubPanel.grbMaster}")
            Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptBillAcceptanceStatusFilterSubPanel.grbDetail}")

            'Checkbox
            Me.chkIncludeChildren.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptBillAcceptanceStatusFilterSubPanel.chkIncludeChildren}")
...
#Region "Methods"
        ...
        Public Overrides Function GetFilterArray() As Filter()
            ...
            arr(9) = New Filter("ShowAll", Me.ChkShowAll.Checked)
            Return arr
        End Function
