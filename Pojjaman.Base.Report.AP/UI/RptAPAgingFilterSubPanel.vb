...
Namespace Longkong.Pojjaman.Gui.Panels
  Public Class RptAPAgingFilterSubPanel
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents chkDetail As System.Windows.Forms.CheckBox
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RptAPAgingFilterSubPanel))
      ...
      Me.rdbBillissue.Location = New System.Drawing.Point(416, 144)
      ...
      'rdbPaySelection
      '
      Me.rdbPaySelection.Location = New System.Drawing.Point(416, 168)
      ...
      '
      'RptAPAgingFilterSubPanel
      '
      Me.Controls.Add(Me.grbMaster)
      Me.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(222, Byte))
      Me.Name = "RptAPAgingFilterSubPanel"
...
#Region "Methods"
    ...
    Public Overrides Function GetFilterArray() As Filter()
      ...
      arr(10) = New Filter("ShowDetail", IIf(Me.chkDetail.Checked, 1, 0))
			...
			arr(13) = New Filter("retentionview", IIf(rdbBillissue.Checked, 0, 1))
			Return arr
    End Function
...
#Region "IReportFilterSubPanel"
    Public Function GetFixValueCollection() As BusinessLogic.DocPrintingItemCollection Implements IReportFilterSubPanel.GetFixValueCollection
      ...
      If Me.chkDetail.Checked Then
        ...
        dpi.Value = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptAPAging.ShowDetail}")        '"แสดงละเอียด"
        dpi.DataType = "System.String"
        dpiColl.Add(dpi)
      End If
