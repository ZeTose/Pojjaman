...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class RptAPRemainDetailFilterSubPanel
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents lblAccountStart As System.Windows.Forms.Label
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RptAPRemainDetailFilterSubPanel))
      ...
      Me.grbMaster.Size = New System.Drawing.Size(752, 224)
      ...
      Me.txtTemp.Location = New System.Drawing.Point(756, 32)
      ...
      Me.grbDetail.Size = New System.Drawing.Size(720, 168)
      ...
      Me.ChkShowAll.Location = New System.Drawing.Point(254, 136)
      Me.ChkShowAll.Name = "ChkShowAll"
      Me.ChkShowAll.Size = New System.Drawing.Size(128, 24)
      Me.ChkShowAll.TabIndex = 50
      ...
      Me.txtSupplierGroupName.TabIndex = 46
      '
      'lblSupplierGroup
      '
      ...
      Me.lblSupplierGroup.TabIndex = 45
      ...
      Me.txtSupplierGroupStart.TabIndex = 47
      '
      ...
      Me.btnSupplierGroupStart.TabIndex = 48
      ...
      Me.chkIncludeSGChildren.TabIndex = 49
      ...
      Me.cmbDocType.Location = New System.Drawing.Point(496, 16)
      Me.cmbDocType.Name = "cmbDocType"
      Me.cmbDocType.Size = New System.Drawing.Size(209, 21)
      ...
      Me.lblDocType.Location = New System.Drawing.Point(400, 16)
      Me.lblDocType.Name = "lblDocType"
      Me.lblDocType.Size = New System.Drawing.Size(96, 24)
      Me.lblDocType.TabIndex = 29
      Me.lblDocType.Text = "Type of Document"
      ...
      Me.lblSuppliStart.Size = New System.Drawing.Size(104, 18)
      ...
      Me.btnSearch.Location = New System.Drawing.Point(656, 192)
      ...
      Me.btnReset.Location = New System.Drawing.Point(568, 192)
      ...
      Me.txtAccountCodeEnd.Location = New System.Drawing.Point(496, 90)
      ...
      Me.txtAccountCodeEnd.TabIndex = 61
      '
      'lblAccountEnd
      '
      ...
      Me.txtAccountCodeStart.Location = New System.Drawing.Point(496, 66)
      ...
      Me.txtAccountCodeStart.TabIndex = 58
      '
      'lblAccountStart
      '
...
#Region " SetLabelText "
        Public Sub SetLabelText()
            ...
            Me.lblSuppliStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainDetailFilterSubPanel.lblSuppliStart}")
            Me.Validator.SetDisplayName(txtSuppliCodeStart, lblSuppliStart.Text)

            Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainDetailFilterSubPanel.lblDocDateStart}")
            Me.Validator.SetDisplayName(txtDocDateStart, lblDocDateStart.Text)

            'SupplierGroup
            Me.lblSupplierGroup.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainDetailFilterSubPanel.lblSupplierGroup}")
            Me.Validator.SetDisplayName(txtSupplierGroupStart, lblSupplierGroup.Text)
            Me.chkIncludeSGChildren.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainDetailFilterSubPanel.chkIncludeSGChildren}")

            Me.lblCCStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainDetailFilterSubPanel.lblCCStart}")
            ...
            ' GroupBox
            Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainDetailFilterSubPanel.grbMaster}")
            Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainDetailFilterSubPanel.grbDetail}")

            'Checkbox
            Me.chkIncludeChildren.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainDetailFilterSubPanel.chkIncludeChildren}")

            Me.lblDocType.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainDetailFilterSubPanel.lblDocType}")
...
#Region "Methods"
        ...
        .Add("รับของ,เจ้าหนี้ยกมา,ซ่อมบำรุง,ใบรับงาน")
                .Add("รับวางบิล")
            End With
      ...
      Dim arr(12) As Filter
            ...
            arr(8) = New Filter("DocType", cmbDocType.SelectedIndex)
