...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class RptAPRemainFilterSubPanel
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.grbMaster.Size = New System.Drawing.Size(547, 196)
            ...
            Me.btnSearch.Location = New System.Drawing.Point(459, 164)
            ...
            Me.btnReset.Location = New System.Drawing.Point(379, 164)
            ...
            Me.grbDetail.Size = New System.Drawing.Size(528, 176)
            ...
            Me.chkShowAll.Location = New System.Drawing.Point(224, 144)
            ...
            Me.btnCCCodeStart.Location = New System.Drawing.Point(200, 87)
            ...
            Me.lblCCStart.Location = New System.Drawing.Point(24, 87)
            ...
            Me.btnSuppliEndFind.Location = New System.Drawing.Point(360, 63)
            ...
            Me.lblSuppliEnd.Location = New System.Drawing.Point(232, 63)
            ...
            Me.btnSuppliStartFind.Location = New System.Drawing.Point(200, 63)
            ...
            Me.lblSuppliStart.Location = New System.Drawing.Point(8, 63)
            ...
            Me.Name = "RptAPRemainFilterSubPanel"
            Me.Size = New System.Drawing.Size(563, 224)
...
#Region " SetLabelText "
        Public Sub SetLabelText()
            ...
            Me.lblSuppliStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainFilterSubPanel.lblSuppliStart}")
            Me.Validator.SetDisplayName(txtSuppliCodeStart, lblSuppliStart.Text)

            Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainFilterSubPanel.lblDocDateStart}")
            Me.Validator.SetDisplayName(txtDocDateStart, lblDocDateStart.Text)

            'SupplierGroup
            Me.lblSupplierGroup.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainFilterSubPanel.lblSupplierGroup}")
            Me.Validator.SetDisplayName(txtSupplierGroupStart, lblSupplierGroup.Text)
            Me.chkIncludeSGChildren.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainFilterSubPanel.chkIncludeSGChildren}")

            Me.lblCCStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainFilterSubPanel.lblCCStart}")
            ...
            ' GroupBox
            Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainFilterSubPanel.grbMaster}")
            Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainFilterSubPanel.grbDetail}")

            'Checkbox
            Me.chkIncludeChildren.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainFilterSubPanel.chkIncludeChildren}")
            Me.chkDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainFilterSubPanel.chkDetail}")
            Me.chkShowAll.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAPRemainFilterSubPanel.chkShowAll}")
...
#Region "Methods"
        ...
        Private Sub ClearCriterias()
            ...
            Dim dtStart As Date = Date.Now.Subtract(New TimeSpan(Now.DayOfYear - 1, 0, 0, 0))
...
#Region "Export Excel"
        ...
        Public Sub xlsexport()
            ...
            Dim filename As String = "Export " & "RptAPRemain" & ctime.ToString("yyyyMMdd") & ".xls"
            ...
            Using xl
                ...
                wkbk.Worksheets(0).Name = "RptAPRemain"
