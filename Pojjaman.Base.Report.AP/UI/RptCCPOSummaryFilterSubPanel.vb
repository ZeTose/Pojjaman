...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.lblOrderby.Text = "เรียงข้อมูลตาม"
...
#Region " SetLabelText "
        Public Sub SetLabelText()
            ...
            ' Combobox 
            Me.lblOrderby.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCPOSummaryFilterSubPanel.lblOrderby}") 'เรียงข้อมูลตาม
            Me.cmbOrderby.Items.Add(Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCPOSummaryFilterSubPanel.cmbPODocCode}")) 'เลขที่เอกสาร
            Me.cmbOrderby.Items.Add(Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCPOSummaryFilterSubPanel.cmbPODocdate}")) 'วันที่ของเอกสาร
            Me.cmbOrderby.SelectedIndex = 0

            Me.lblDocStatus.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCPOSummaryFilterSubPanel.lblStatus}") 'สถานะ
            Me.cmbStatus.Items.Add(Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCPOSummaryFilterSubPanel.cmbDocAll}")) 'เอกสารสั่งซื้อทั้งหมด
            Me.cmbStatus.Items.Add(Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCPOSummaryFilterSubPanel.cmbDocApprove}")) 'เอกสารสั่งซื้อที่อนุมัติแล้ว
            Me.cmbStatus.Items.Add(Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptCCPOSummaryFilterSubPanel.cmbDocNoApprove}")) 'เอกสารสั่งซื้อที่ยังไม่อนุมัติ
