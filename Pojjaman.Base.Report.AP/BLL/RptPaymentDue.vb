...
#Region "Methods"
		...
		Private Sub CreateHeader()
			...
			If m_showPeriod = 0 Then
				...
				tr("col0") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.SupplierId}")				 '"รหัสผู้ขาย"
				tr("col1") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.SupplierName}")				 '"ชื่อผู้ขาย"
				tr("col2") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.NotInRange}")				 '"ไม่อยู่ในช่วง"
				tr("col3") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Range0_7}")					'"ช่วง 0-7 วัน"
				tr("col4") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Range8_14}")				 '"ช่วง 8-14 วัน"
				tr("col5") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Range15_21}")				 '"ช่วง 15-21 วัน"
				tr("col6") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Range22_28}")				 '"ช่วง 22-28 วัน"
				tr("col7") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.OverRange_28}")				 '"เกิน 28 วัน"
				tr("col8") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Total}")					'"รวม"
				' Level 2.
				If m_showDetailInGrid <> 0 Then
					tr = Me.m_treemanager.Treetable.Childs.Add
					tr("col0") = indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.DueDate}")					'"วันที่กำหนดชำระ"  
					tr("col1") = indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.StockCode}")					'"รหัสใบสั่งซื้อ/รับของ" 

					'Level 3
					tr = Me.m_treemanager.Treetable.Childs.Add
					tr("col0") = indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.DueDate}")					'"วันที่กำหนดชำระ"   
					tr("col1") = indent & indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.BillaDocCode}")				 '"รหัสใบวางบิล"
				End If
			...
			ElseIf m_showPeriod = 1 Then
				...
				tr("col1") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.SupplierName}")				 '"ชื่อผู้ขาย"
				tr("col2") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.NotInRange}")				 '"ไม่อยู่ในช่วง"
				tr("col3") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Range1M}")					'"ช่วง 1 เดือน"
				tr("col4") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Range2M}")				 '"ช่วง 2 เดือน"
				tr("col5") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Range3M}")				 '"ช่วง 3 เดือน"
				tr("col6") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Range4M}")				 '"ช่วง 4 เดือน"
				tr("col7") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Range5M}")				 '"ช่วง 5 เดือน"
				tr("col8") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Range6M}")				 '"ช่วง 6 เดือน"
				tr("col9") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.OverRange6M}")				 '"เกิน 6 เดือน"
				tr("col10") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Total}")					'"รวม"
				' Level 2.
				If m_showDetailInGrid <> 0 Then
					tr = Me.m_treemanager.Treetable.Childs.Add
					tr("col0") = indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.DueDate}")					'"วันที่กำหนดชำระ"     
			...
			ElseIf m_showPeriod = 2 Then
				...
				tr("col1") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.SupplierName}")				 '"ชื่อผู้ขาย"
				tr("col2") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.NotInRange}")				 '"ไม่อยู่ในช่วง"
				tr("col3") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Range1Q}")					'"ช่วง 3 เดือน"
				tr("col4") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Range2Q}")				 '"ช่วง 6 เดือน"
				tr("col5") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Range3Q}")				 '"ช่วง 9 เดือน"
				tr("col6") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Range4Q}")				 '"ช่วง 12 เดือน"
				tr("col7") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.OverRange4Q}")				 '"เกิน 12 เดือน"
				tr("col8") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Total}")					'"รวม"
				' Level 2.
				If m_showDetailInGrid <> 0 Then
					tr = Me.m_treemanager.Treetable.Childs.Add
      ...
      End If
			...
			If Not trSupplier Is Nothing Then
				...
				trSupplier("col1") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.Total}")				'"รวม"
...
#End Region#Region "Properties"		Public Overrides ReadOnly Property ClassName() As String
			Get
				Return "RptPaymentDue"
			End Get
		End Property
		Public Overrides ReadOnly Property DetailPanelTitle() As String
			Get
				Return "${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.DetailLabel}"
			End Get
		End Property
		Public Overrides ReadOnly Property DetailPanelIcon() As String
			Get
				Return "Icons.16x16.RptPaymentDue"
			End Get
		End Property
		...
		Public Overrides ReadOnly Property ListPanelTitle() As String
			Get
				Return "${res:Longkong.Pojjaman.BusinessLogic.RptPaymentDue.ListLabel}"
			End Get
		End Property
