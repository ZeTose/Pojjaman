...
#Region "Methods"
        ...
        Private Sub CreateHeader()
            ...
            Else
                ...
                tr("col16") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptAPRemain.RefDocCode}") '"เลขที่เอกสารอ้างอิง"
                tr("col17") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptAPRemain.VatitemCode}") '"เลขที่ใบกำกับภาษี"
            End If
        End Sub
        Private Sub PopulateData()
            ...
            For Each supplierRow As DataRow In dt.Rows
                ...
                If Not supplierRow.IsNull("Amount") Then
                    If CDec(supplierRow("Amount")) <> 0 Then
                        ...
                        Else
                            trSupplier("col6") = Configuration.FormatToString(CDec(supplierRow("Amount")), DigitConfig.Price)
                        End If
                ...
                If Not supplierRow.IsNull("PayRetention") Then
                    If CDec(supplierRow("PayRetention")) <> 0 Then
                        ...
                        Else
                            trSupplier("col12") = Configuration.FormatToString(CDec(supplierRow("PayRetention")), DigitConfig.Price)
                        End If
                ...
                If Not supplierRow.IsNull("EndingBalanceRetention") Then
                    ...
                    Else
                        trSupplier("col13") = Configuration.FormatToString(CDec(supplierRow("EndingBalanceRetention")), DigitConfig.Price)
                    End If
                    ...
                    For Each detailRow As DataRow In dt2.Select("Supplier=" & supplierRow("Supplier_ID").ToString)
                        ...
                        If Not trSupplier Is Nothing Then
                            ...
                            If Not detailRow.IsNull("PayRetention") Then
                                ...
                                End If
                            End If
                            trDetail("col13") = Configuration.FormatToString(deh.GetValue(Of Decimal)("EndingBalanceRetention"), DigitConfig.Price)
                            trDetail("col14") = indent & deh.GetValue(Of String)("glNote", "-")
                            trDetail("col15") = Configuration.FormatToString(deh.GetValue(Of Decimal)("PaysGross"), DigitConfig.Price)
            ...
            Else
                ...
                If sumAmount > 0 Then
                    trSupplier("col6") = Configuration.FormatToString(sumAmount, DigitConfig.Price)
                End If
                If sumPCNAmount > 0 Then
