						...
						If Not Me.m_entity Is Nothing Then
							...
							For Each col As FFormatColumn In Me.m_entity.ColumnCollection
								If col.WidthPercent > 0 Then
									...
									For i As Integer = startRow To Me.m_entity.ItemCollection.Count							'(tb.RowsPerPage + startRow - 1)
										rowsInPage += 1
										...
										'	Exit For
										'End If
										Dim ffi As FFormatItem = Me.m_entity.ItemCollection(i - 1)
									...
									Next									'i
								End If
							Next				'Each col As FFormatColumn In Me.m_entity.ColumnCollection
						End If
					End If
				Next		 'ctrl
