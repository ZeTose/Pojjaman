      ...
      If CBool(Configuration.GetConfig("ApprovePa")) Then
        ...
        Else
          For Each ctrl As Control In grbDetail.Controls
            ...
            End If
          Next
          Trace.WriteLine(Me.m_entity.IshaveAdvancePayClosed.ToString)
          Trace.WriteLine(Me.m_entity.IsMeLastedPADoc().ToString)
      ...
      Select Case CType(sender, Control).Name.ToLower
        ...
        Case "txtdirectorcode"
          If directorCodeChanged Then
            dirtyFlag = RunningEmployee.GetEmployee(txtDirectorCode, txtDirectorName, Me.m_entity.Receiver)
