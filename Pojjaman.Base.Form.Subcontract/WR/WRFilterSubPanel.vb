...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(WRFilterSubPanel))
      ...
      Me.txtCode.Size = New System.Drawing.Size(233, 21)
      ...
      Me.grbDetail.Size = New System.Drawing.Size(647, 180)
      ...
      Me.grbDocDate.Location = New System.Drawing.Point(399, 11)
      Me.grbDocDate.Name = "grbDocDate"
      Me.grbDocDate.Size = New System.Drawing.Size(239, 69)
      ...
      Me.btnSearch.Location = New System.Drawing.Point(567, 148)
      ...
      Me.btnReset.Location = New System.Drawing.Point(487, 148)
      ...
      Me.grbMainDetail.Size = New System.Drawing.Size(385, 92)
      ...
      Me.btnCostCenterPanel.Location = New System.Drawing.Point(351, 41)
      ...
      Me.txtCostCenterCode.Location = New System.Drawing.Point(96, 41)
      ...
      Me.txtCostCenterName.Location = New System.Drawing.Point(176, 41)
      ...
      Me.btnCostCenterDialog.Location = New System.Drawing.Point(327, 41)
      ...
      Me.lblCC.Location = New System.Drawing.Point(8, 41)
      Me.lblCC.Name = "lblCC"
      ...
      Me.cmbStatus.Location = New System.Drawing.Point(96, 65)
...
#Region "Methods"
    ...
    Private Sub PopulateStatus()
      ...
      Dim maxGRApproveLevel As Integer = CType(Configuration.GetConfig("MaxLevelApproveWR"), Integer)
    ...
    Public Sub SetLabelText()
      ...
      Me.lblCode.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.lblCode}")
      Me.btnSearch.Text = Me.StringParserService.Parse("${res:Global.SearchButtonText}")
      Me.btnReset.Text = Me.StringParserService.Parse("${res:Global.ResetButtonText}")
      Me.grbDocDate.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.grbDocDate}")
      Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.lblDocDateStart}")
      Me.lblDocDateEnd.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.lblDocDateEnd}")
      'Me.lblReceivingDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.lblReceivingDateStart}")
      'Me.lblReceivingDateEnd.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.lblReceivingDateEnd}")
      'Me.lblSupplier.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.lblSupplier}")
      'Me.grbReceivingDate.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.grbReceivingDate}")
      Me.lblCC.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.lblCC}")
      Me.lblStatus.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.lblStatus}")
      'Me.grbItem.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.grbItem}")
      'Me.lblLCI.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.lblLCI}")
      'Me.lblTool.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.lblTool}")
      'Me.lblBlank.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.lblBlank}")
      'Me.grbMainDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.grbMainDetail}")
      Me.grbApprove.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.grbApprove}")
      Me.lblApprovePerson.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.lblApprovePerson}")
      Me.lblApproveLevel.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.WRFilterSubPanel.lblApproveLevel}")
    End Sub
...
#Region "Event Handlers"
    'Private Sub txtSupplierCode_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs)
