...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Protected Sub InitializeComponent()
      ...
      Me.imAttachment.Location = New System.Drawing.Point(629, 110)
      Me.imAttachment.Name = "imAttachment"
      Me.imAttachment.Size = New System.Drawing.Size(29, 31)
      Me.imAttachment.TabIndex = 352
      ...
      Me.btnApprove.Location = New System.Drawing.Point(664, 109)
...
#Region "IListDetail"
    Public Overrides Sub CheckFormEnable()
      ...
      CType(Me.Entity, VO).Closed = Me.chkClosed.Checked
      If CType(Me.Entity, VO).Closed Then
        CheckCancelClosed()
      Else
        CheckClosed()
      End If
    ...
    Private Sub CheckClosed()
      ...
      Dim level As Integer = secSrv.GetAccess(366)            'ตรวจสอบ สิทธิการปิดVO
    ...
    Private Sub CheckCancelClosed()
      Dim secSrv As SecurityService = CType(ServiceManager.Services.GetService(GetType(SecurityService)), SecurityService)
      Dim level As Integer = secSrv.GetAccess(376)            'ตรวจสอบ สิทธิการปิดVO
      Dim checkString As String = BinaryHelper.DecToBin(level, 5)           'เปลี่ยนตัวเลขเป็น รหัส 01 5ตัว ตามค่าตัวเลข
      checkString = BinaryHelper.RevertString(checkString)
      If CBool(checkString.Substring(0, 1)) Then
        Me.chkClosed.Visible = True
...
#Region "Event of Button controls"
    ...
    Private Sub ibtnShowSCDialog_click(ByVal sendr As Object, ByVal e As EventArgs) Handles ibtnShowSCDialog.Click
      ...
      If Me.m_entity.SC Is Nothing OrElse Not Me.m_entity.SC.Originated OrElse msgServ.AskQuestion("${res:Longkong.Pojjaman.Gui.Panels.GoodsReceiptDetail.Message.ChangePO}", "${res:Longkong.Pojjaman.Gui.Panels.GoodsReceiptDetail.Caption.ChangePO}") Then
        ...
        myEntityPanelService.OpenListDialog(New SCForVO, AddressOf SetSC, entities)
      End If
    End Sub
