...
#Region "Methods"
        Public Overrides Sub Run()
            ...
            Dim objArray1 As Object() = New Object() {fileUtlityService.PojjamanRootPath, Path.DirectorySeparatorChar, "doc", Path.DirectorySeparatorChar, "help", Path.DirectorySeparatorChar, "pojjaman.chm"}
