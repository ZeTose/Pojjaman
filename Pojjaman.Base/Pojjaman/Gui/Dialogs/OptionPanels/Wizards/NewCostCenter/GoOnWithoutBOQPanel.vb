...
Namespace Longkong.Pojjaman.Gui.Dialogs.OptionPanels.NewCostCenterWizard
    Public Class GoOnWithoutBOQPanel
...
#Region "Constructors"
        Public Sub New()
            ...
            InitializeComponent()
            SetLabelText()
            Me.NextWizardPanelID = "CreateCostCenterPanel"
        End Sub
#End Region

#Region "Methods"
        Public Sub SetLabelText()
            txtMessage.Lines = Me.StringParserService.Parse("${res:Dialog.Wizards.NewCostCenterWizard.GoOnWithoutBOQPanel.DescriptionText}").Split(New Char() {ChrW(10)})
        End Sub
#End Region
