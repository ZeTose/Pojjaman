...
#Region "Methods"
    ...
    Public Overrides Function ReceiveDialogMessage(ByVal message As DialogMessage) As Boolean
      If ((message = DialogMessage.OK) AndAlso (Not Me.SelectedCulture Is Nothing)) Then
        Dim cultureName As String = Me.SelectedCulture
        Me.m_propertyService.SetProperty(PojjamanOptionPanel.m_uiLanguageProperty, cultureName)
        Me.SetGlobalCaluture(cultureName)
      End If
      Return True
    End Function
    Public Sub SetGlobalCaluture(cultureName As String)
      Try
        SqlHelper.ExecuteNonQuery(RecentCompanies.CurrentCompany.ConnectionString, CommandType.StoredProcedure, "UpdateLanguageSetting", New System.Data.SqlClient.SqlParameter("@culture", cultureName))
