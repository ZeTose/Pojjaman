...
#Region " Windows Form Designer generated code "
        ...
        Friend WithEvents tvLinkReport As System.Windows.Forms.TreeView
        ...
        Friend WithEvents grbReportFormat As Longkong.Pojjaman.Gui.Components.FixedGroupBox
        ...
        <System.Diagnostics.DebuggerStepThrough()> Protected Sub InitializeComponent()
            ...
            Me.tvLinkReport = New System.Windows.Forms.TreeView
            Me.lblForm = New System.Windows.Forms.Label
            Me.grbReportFormat = New Longkong.Pojjaman.Gui.Components.FixedGroupBox
            ...
            Me.grbReportFormat.SuspendLayout()
            ...
            'tvLinkReport
            '
            Me.tvLinkReport.Anchor = CType(((System.Windows.Forms.AnchorStyles.Top Or System.Windows.Forms.AnchorStyles.Bottom) _
                        Or System.Windows.Forms.AnchorStyles.Left), System.Windows.Forms.AnchorStyles)
            Me.tvLinkReport.FullRowSelect = True
            Me.tvLinkReport.HideSelection = False
            Me.tvLinkReport.ImageIndex = -1
            Me.tvLinkReport.Location = New System.Drawing.Point(8, 16)
            Me.tvLinkReport.Name = "tvLinkReport"
            Me.tvLinkReport.SelectedImageIndex = -1
            Me.tvLinkReport.Size = New System.Drawing.Size(224, 408)
            Me.tvLinkReport.TabIndex = 194
            Me.tvLinkReport.TabStop = False
            '
            'lblForm
            '
            ...
            'grbReportFormat
            '
            Me.grbReportFormat.Controls.Add(Me.lblNote)
            Me.grbReportFormat.Controls.Add(Me.txtNote)
            Me.grbReportFormat.Controls.Add(Me.txtFormatName)
            Me.grbReportFormat.Controls.Add(Me.lblFormat)
            Me.grbReportFormat.Controls.Add(Me.chkDefault)
            Me.grbReportFormat.Controls.Add(Me.txtFormatCode)
            Me.grbReportFormat.FlatStyle = System.Windows.Forms.FlatStyle.System
            Me.grbReportFormat.Location = New System.Drawing.Point(240, 64)
            Me.grbReportFormat.Name = "grbReportFormat"
            Me.grbReportFormat.Size = New System.Drawing.Size(576, 96)
            Me.grbReportFormat.TabIndex = 0
            Me.grbReportFormat.TabStop = False
            Me.grbReportFormat.Text = "กำหนดรูปแบบฟอร์ม"
            '
            'txtFormatName
            '
            ...
            Me.Controls.Add(Me.tvLinkReport)
            Me.Controls.Add(Me.grbForm)
            Me.Controls.Add(Me.lblForm)
            Me.Controls.Add(Me.grbReportFormat)
            Me.Name = "LinkReportDetail"
            Me.Size = New System.Drawing.Size(832, 432)
            CType(Me.tgItem, System.ComponentModel.ISupportInitialize).EndInit()
            Me.grbForm.ResumeLayout(False)
            Me.grbReportFormat.ResumeLayout(False)
...
#Region "Members"
        Private m_entity As ReportFormat
...
#Region "Constructors"
        ...
        '    m_entity = New ReportFormat


        '    LinkReport.Populate(Me.tvLinkReport)


        '    Dim dt As TreeTable = ReportFormat.GetSchemaTable()
        '    Dim dst As DataGridTableStyle = ReportFormat.CreateTableStyle()
        ...
        Public Sub New(ByVal entity As ISimpleEntity, ByVal handler As Object, ByVal basket As BasketDialog, ByVal filters As Filter(), ByVal entities As ArrayList)
            ...
            'LinkReport.Populate(Me.tvLinkReport, filters)
...
#Region "ISimpleListPanel"
        ...
        Public Sub SetLabelText() Implements ISimplePanel.SetLabelText
            ...
            Me.lblCode.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.LinkReportDetail.lblCode}")
            Me.grbItem.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.LinkReportDetail.grbItem}")
            Me.lblNote.Text = Me.StringParserService.Parse("${res:Global.NoteText}")
            Me.grbForm.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.LinkReportDetail.grbForm}")
            Me.chkDefault.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.LinkReportDetail.chkDefault}")
            Me.lblFormat.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.LinkReportDetail.lblFormat}")
            Me.lblForm.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.LinkReportDetail.lblForm}")
            Me.grbReportFormat.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.LinkReportDetail.grbReportFormat}")
        End Sub
        ...
        Public Sub UpdateEntityProperties() Implements ISimplePanel.UpdateEntityProperties
            ...
            If m_entity Is Nothing Then
                Return
            End If
            txtCode.Text = m_entity.LinkReport.Code
            txtName.Text = m_entity.LinkReport.Name
        ...
        Public Sub AddNew() Implements ISimpleListPanel.AddNew
            Dim node As TreeNode = Me.tvLinkReport.SelectedNode
            ...
            If TypeOf node.Tag Is IdValuePair Then
                ...
                Select Case item.Value.ToLower
                    Case "linkreport"
                        Dim ff As New ReportFormat(New LinkReport(item.Id))
                        Dim newNode As TreeNode = node.Nodes.Add("<NEW>")
                        newNode.Tag = New IdValuePair(ff.Id, "reportformat")
                        Me.SelectedEntity = ff
                        Me.tvLinkReport.SelectedNode = newNode
                        Return
                    Case "reportformat"
                        Dim parentItem As IdValuePair = CType(node.Parent.Tag, IdValuePair)
                        Dim ff As New ReportFormat(New LinkReport(parentItem.Id))
        ...
        Public Property SelectedEntity() As BusinessLogic.ISimpleEntity Implements ISimpleListPanel.SelectedEntity
            ...
            Set(ByVal Value As BusinessLogic.ISimpleEntity)
                If Not m_entity Is Nothing Then
                    ...
                    Me.m_entity = Nothing
                End If
                Me.m_entity = CType(Value, ReportFormat)
                'Hack:
...
#Region "Event Handlers"
        Private Sub ToggleVisibility(ByVal show As Boolean)
            If Me.SecurityService.CurrentUser.Id = 1 Then
                show = True
            End If
            Me.grbReportFormat.Enabled = show
            ...
            End If
        End Sub
        Private Sub tvLinkReport_BeforeSelect(ByVal sender As Object, ByVal e As System.Windows.Forms.TreeViewCancelEventArgs) Handles tvLinkReport.BeforeSelect
            If Me.IsDirty Then
                ...
                End Select
            End If
            If Me.tvLinkReport.SelectedNode Is Nothing OrElse Not TypeOf Me.tvLinkReport.SelectedNode.Tag Is IdValuePair Then
                Return
            End If
            Dim item As IdValuePair = CType(Me.tvLinkReport.SelectedNode.Tag, IdValuePair)
            If item.Value = "reportformat" And item.Id = 0 Then
                Me.tvLinkReport.SelectedNode.Remove()
            End If
        End Sub
        Private Sub tvLinkReport_AfterSelect(ByVal sender As Object, ByVal e As System.Windows.Forms.TreeViewEventArgs) Handles tvLinkReport.AfterSelect
            If TypeOf e.Node.Tag Is IdValuePair Then
                Dim item As IdValuePair = CType(e.Node.Tag, IdValuePair)
                Select Case item.Value.ToLower
                    Case "reportformat"
                        If item.Id > 0 Then
                            Me.SelectedEntity = New ReportFormat(item.Id)
                        End If
        ...
        End Sub
        Private Sub tvLinkReport_DoubleClick(ByVal sender As Object, ByVal e As System.EventArgs) Handles tvLinkReport.DoubleClick
            ...
            End If
        End Sub
        Private Sub LinkReportDetail_Saved(ByVal sender As Object, ByVal e As SaveEventArgs) Handles MyBase.Saved
            If Not e.Successful Then
                Return
            End If
            Me.tvLinkReport.SelectedNode.Text = Me.m_entity.Code & " - " & Me.m_entity.Name
            Me.tvLinkReport.SelectedNode.Tag = New IdValuePair(Me.m_entity.Id, "reportformat")
            Me.chkDefault.Enabled = Not Me.m_entity.IsDefault
        End Sub
#End Region
...
#Region "IClipboardHandler Overrides"
        Public Overrides ReadOnly Property EnableDelete() As Boolean
            Get
                ...
                End If
                Dim item As IdValuePair = CType(node.Tag, IdValuePair)
                If item.Value <> "reportformat" Then
                    Return False
                End If
        ...
        Public Overrides Sub Delete(ByVal sender As Object, ByVal e As System.EventArgs)
            ...
            If Not IsNumeric(msg) Then
                ...
                Return
            End If
            If Not Me.tvLinkReport.SelectedNode Is Nothing Then
                Me.tvLinkReport.SelectedNode.Remove()
            End If
