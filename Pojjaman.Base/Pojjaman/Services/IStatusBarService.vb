...
Namespace Longkong.Pojjaman.Services
  Public Interface IStatusBarService
    ...
    Sub SetStatusMessage(ByVal message As String, ByVal color As Color)
    Sub SetStatusMessage(ByVal image As Image, ByVal message As String, ByVal color As Color)
    ' Properties
