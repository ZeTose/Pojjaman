...
#Region "IEntityMenuCommand"
    Public Property ForceAccessId As String
    Public Overridable Property IsEnabled() As Boolean Implements IMenuCommand.IsEnabled
      Get
        ...
        If Not secSrv.CurrentUser Is Nothing AndAlso secSrv.CurrentUser.Originated Then
          ...
          If IsNumeric(ForceAccessId) AndAlso ForceAccessId <> "0" Then
            accessID = CInt(ForceAccessId)
          Else
            accessID = Longkong.Pojjaman.BusinessLogic.Entity.GetAccessIdFromFullClassName(Me.Entity)
          End If
          If accessID = 0 Then
