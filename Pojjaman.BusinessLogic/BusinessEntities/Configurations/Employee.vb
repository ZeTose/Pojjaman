...
#Region "Members"
    ...
    Private employee_SignatureImage As Image
#End Region
...
#Region "Constructors"
    ...
    Public Overloads Sub LoadImage(ByVal reader As IDataReader)
      ...
      Me.SignatureImage = Field.GetImage(reader, "employee_signature")
    End Sub
    Public Overloads Sub LoadImage()
      ...
      Dim sql As String = "select employee_image, employee_signature from employeeimage where employee_id=" & Me.Id
...
#Region "Method"
    ...
    Public Shared Function LoadSignator(ByVal reader As IDataReader) As System.Drawing.Image
      Return Field.GetImage(reader, "employee_signature")
    End Function
    Public Shared Function LoadSignator(ByVal id As String) As System.Drawing.Image
      ...
      Dim conn As New SqlConnection(sqlConString)
      Dim sql As String = "select * from employeeimage where employee_id = " + id
    ...
    Public Overloads Overrides Function Save(ByVal currentUserId As Integer) As SaveErrorException
      ...
      Try
        ...
        If Me.Originated Then
          ...
          If Not Me.SignatureImage Is Nothing Then
            paramArrayList.Add(New SqlParameter("@" & Me.Prefix & "_signature", Pojjaman.Graphix.Imaging.ConvertImageToByteArray(Me.SignatureImage)))
          End If
          sqlparams = CType(paramArrayList.ToArray(GetType(SqlParameter)), SqlParameter())
