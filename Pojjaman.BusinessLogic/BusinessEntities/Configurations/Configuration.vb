...
#End Region
        ...
        Public Shared Function BranchString(BranchId As Integer) As String

            Dim str As String = ""

            If BranchId = -1 Then
                str = ""
            ElseIf Len(BranchId.ToString()) < 4 Then
                str = String.Join("", Enumerable.Repeat("0", 4 - Len(BranchId.ToString()))) & BranchId.ToString()
            Else
