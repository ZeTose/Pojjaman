      ...
      Try
        ...
        If IsNumeric(returnVal.Value) Then
          Select Case CInt(returnVal.Value)
            Case -1
              trans.Rollback()
              Return New SaveErrorException("${res:Global.CBSIsReferencedCannotBeDeleted}", Me.Code)
            Case -2
              trans.Rollback()
              Return New SaveErrorException("${res:Longkong.Pojjaman.BusinessLogic.CBS.ChildReferenced}", Me.Code)
            Case Else
          End Select
