...
#Region "Members"
        ...
        Private m_startentity As Tool
        Private m_endentity As Tool
...
#Region "Constructors"
        ...
        Protected Overloads Overrides Sub Construct()
            ...
            With Me
                .m_docdate = Now.Date
                .m_cc = New CostCenter
                .m_startentity = New Tool
                .m_endentity = New Tool
        ...
        Protected Overloads Overrides Sub Construct(ByVal dr As System.Data.DataRow, ByVal aliasPrefix As String)
            ...
            With Me
                ...
                End If
                ' Start entity.
                If dr.Table.Columns.Contains(aliasPrefix & "startentity.tool_id") _
                    AndAlso Not dr.IsNull(aliasPrefix & "startentity.tool_id") Then
                    .m_startentity = New Tool(dr, "startentity.")
                Else
                    ...
                    AndAlso Not dr.IsNull(aliasPrefix & Me.Prefix & "_startEntity") Then
                        .m_startentity = New Tool(CInt(dr(aliasPrefix & Me.Prefix & "_startEntity")))
                    End If
                End If
                ' End entity.
                If dr.Table.Columns.Contains(aliasPrefix & "endentity.tool_id") _
                    AndAlso Not dr.IsNull(aliasPrefix & "endentity.tool_id") Then
                    .m_endentity = New Tool(dr, "endentity.")
                Else
                    ...
                    AndAlso Not dr.IsNull(aliasPrefix & Me.Prefix & "_endEntity") Then
                        .m_endentity = New Tool(CInt(dr(aliasPrefix & Me.Prefix & "_endEntity")))
                    End If
                End If
                ' Process time.
...
#Region "Properties"
        ...
        Public Overrides ReadOnly Property DetailPanelTitle() As String
            Get
                Return "${res:Longkong.Pojjaman.BusinessLogic.ToolStockCount.DetailLabel}"
            End Get
        End Property
        Public Overrides ReadOnly Property DetailPanelIcon() As String
            Get
                Return "Icons.16x16.ToolStockCount"
            End Get
        End Property
        ...
        Public Overrides ReadOnly Property ListPanelTitle() As String
            Get
                Return "${res:Longkong.Pojjaman.BusinessLogic.ToolStockCount.ListLabel}"
            End Get
        End Property
...
#Region "Methods"
        Public Sub ProcessItems()
            ...
            , "GetRemainTOOLListForCCall" _
            , New SqlParameter("@cc_id", IIf(Me.CostCenter.Originated, Me.CostCenter.Id, DBNull.Value)) _
            , New SqlParameter("@tool_codeStart", IIf(Me.StartEntity.Originated, Me.StartEntity.Code, DBNull.Value)) _
            , New SqlParameter("@tool_codeEnd", IIf(Me.EndEntity.Originated, Me.EndEntity.Code, DBNull.Value)) _
            )

            For Each row As DataRow In ds.Tables(0).Rows
                Dim item As New ToolStockCountItem(row)
                item.ToolStockCount = Me
                Me.Add(item)
            Next
        End Sub
        ...
        Private Function SaveDetail(ByVal parentID As Integer, ByVal conn As SqlConnection, ByVal trans As SqlTransaction) As SaveErrorException
            Try
                '----------------HACK------------------------------------
                Try
                    Dim cmd As New SqlCommand("delete ToolStockCountItem where toolci_toolc = " & Me.Id, conn)
                ...
                '***********----WBS ----****************
                Dim da As New SqlDataAdapter("Select * from ToolStockCountItem where 1=2", conn)
                ...
                da.FillSchema(ds, SchemaType.Mapped, "ToolStockCountItem")
                da.Fill(ds, "ToolStockCountItem")

                Dim dtMatCounti As DataTable
                Dim dc As DataColumn
                dtMatCounti = ds.Tables("ToolStockCountItem")
                ...
                For Each tr As TreeRow In Me.m_itemTable.Childs
                    If ValidateRow(tr) Then
                        ...
                        drFi("toolci_toolc") = Me.Id
                        drFi("toolci_linenumber") = tr("toolci_linenumber")
                        drFi("toolci_entity") = tr("toolci_entity")
                        drFi("toolci_entityType") = tr("toolci_entityType")
                        drFi("toolci_unit") = tr("toolci_unit")
                        drFi("toolci_balanceqty") = tr("toolci_balanceqty")
                        drFi("toolci_auditqty") = tr("toolci_auditqty")
                        drFi("toolci_diffqty") = tr("toolci_diffqty")
                        drFi("toolci_note") = tr("toolci_note")
...
#Region "Items"
        ...
        Private Sub LoadItems()
            ...
            ds = SqlHelper.ExecuteDataset(Me.ConnectionString _
            , CommandType.StoredProcedure _
            , "GetToolStockCountItems" _
            , New SqlParameter("@toolci_toolc", Me.Id) _
            )
        ...
        Private Sub LoadItems(ByVal ds As System.Data.DataSet, ByVal aliasPrefix As String)
            For Each dr As DataRow In ds.Tables(0).Rows
                Dim item As New ToolStockCountItem(dr, aliasPrefix)
                item.ToolStockCount = Me
                Me.Add(item)
            Next
        End Sub
        Public Sub AddBlankRow(ByVal count As Integer)
            For i As Integer = 0 To count - 1
                ...
                Dim mtwItem As New ToolStockCountItem
            ...
            Next
        End Sub
        Public Function Add(ByVal item As ToolStockCountItem) As TreeRow
            ...
            Return myRow
        End Function
        Public Function Insert(ByVal index As Integer, ByVal item As ToolStockCountItem) As TreeRow
        ...
        Private Sub ReIndex(ByVal index As Integer)
            ...
            For i As Integer = index To Me.ItemTable.Childs.Count - 1
                Me.ItemTable.Childs(i)("toolci_linenumber") = i + 1
            Next
        End Sub
...
#Region "Shared"
        Public Shared Function GetSchemaTable() As TreeTable
            Dim myDatatable As New TreeTable("ToolStockCount")
            myDatatable.Columns.Add(New DataColumn("toolci_toolc", GetType(Integer)))
            myDatatable.Columns.Add(New DataColumn("toolci_linenumber", GetType(Integer)))
            myDatatable.Columns.Add(New DataColumn("Code", GetType(String)))
            myDatatable.Columns.Add(New DataColumn("Name", GetType(String)))
            myDatatable.Columns.Add(New DataColumn("toolci_entity", GetType(Integer)))
            myDatatable.Columns.Add(New DataColumn("toolci_entitytype", GetType(Integer)))
            ...
            myDatatable.Columns.Add(New DataColumn("toolci_unit", GetType(Integer)))
            myDatatable.Columns.Add(New DataColumn("toolci_balanceqty", GetType(Decimal)))
            myDatatable.Columns.Add(New DataColumn("toolci_auditqty", GetType(Decimal)))
            myDatatable.Columns.Add(New DataColumn("toolci_diffqty", GetType(Decimal)))
            myDatatable.Columns.Add(New DataColumn("toolci_note", GetType(String)))
...
#Region "TreeTable Handlers"
        ...
        Public Sub ValidateRow(ByVal e As DataColumnChangeEventArgs)
            Dim proposedUnit As Object = e.Row("toolci_unit")
        ...
        Public Sub SetQty(ByVal e As DataColumnChangeEventArgs)
            If ValidateRow(CType(e.Row, TreeRow)) Then
                ...
                If Not IsDBNull(e.Row("toolci_balanceqty")) Then
                    balanceQty = CDec(e.Row("toolci_balanceqty"))
                End If
                ...
                e.Row("toolci_diffqty") = Configuration.FormatToString(diffQty, DigitConfig.Price)
            Else
        ...
        Public Sub SetCode(ByVal e As System.Data.DataColumnChangeEventArgs)
            Dim entity As SimpleBusinessEntityBase = New Tool(e.ProposedValue.ToString)

            m_updating = True
            If entity.Originated Then
                e.ProposedValue = entity.Code
                e.Row("toolci_entity") = entity.Id
                e.Row("name") = CType(entity, Tool).Name
                e.Row("toolci_entityType") = CType(entity, Tool).EntityId

                If CType(entity, Tool).Unit.Originated Then
                    e.Row("toolci_unit") = CType(entity, Tool).Unit.Id
                    e.Row("unitcode") = CType(entity, Tool).Unit.Id
                    e.Row("unitname") = CType(entity, Tool).Unit.Id
                End If
                'e.Row("toolci_balanceqty") = DBNull.Value
                'e.Row("toolci_auditqty") = DBNull.Value
                'e.Row("toolci_diffqty") = DBNull.Value
                'e.Row("toolci_note") = DBNull.Value

            Else
                e.ProposedValue = DBNull.Value
                e.Row("toolci_entity") = DBNull.Value
                e.Row("name") = DBNull.Value
                e.Row("toolci_entityType") = DBNull.Value
                e.Row("toolci_unit") = DBNull.Value
...
#Region "IGLAble"
        ...
        '            Dim newLci As Tool = CType(item.Entity, Tool)
        ...
        '        Dim lci As Tool = CType(item.Entity, Tool)
...
#Region "Delete"
        ...
        Public Overrides Function Delete() As SaveErrorException
            ...
            format(0) = Me.Code
            If Not myMessage.AskQuestionFormatted("${res:Global.ConfirmDeleteToolStockCount}", format) Then
            ...
            Try
                ...
                returnVal.Direction = ParameterDirection.ReturnValue
                returnVal.SourceVersion = DataRowVersion.Current
                SqlHelper.ExecuteNonQuery(conn, trans, CommandType.StoredProcedure, "DeleteToolStockCount", New SqlParameter() {New SqlParameter("@" & Me.Prefix & "_id", Me.Id), returnVal})
                If IsNumeric(returnVal.Value) Then
                    Select Case CInt(returnVal.Value)
                        Case -1
                            trans.Rollback()
                            Return New SaveErrorException("${res:Global.ToolStockCountIsReferencedCannotBeDeleted}")
                        Case Else
                    End Select
                ElseIf IsDBNull(returnVal.Value) OrElse Not IsNumeric(returnVal.Value) Then
                    trans.Rollback()
