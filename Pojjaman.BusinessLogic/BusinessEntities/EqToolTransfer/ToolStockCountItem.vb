...
Namespace Longkong.Pojjaman.BusinessLogic
    Public Class ToolStockCountItem

#Region "Members"
        Private m_matstockcount As ToolStockCount
...
#Region "Methods"
        Public Sub CopyToDataRow(ByVal row As TreeRow)
            ...
            Me.ToolStockCount.IsInitialized = False
            ...
            If Me.ToolStockCount.ValidateRow(row) Then
            ...
            Me.ToolStockCount.IsInitialized = True
        End Sub
