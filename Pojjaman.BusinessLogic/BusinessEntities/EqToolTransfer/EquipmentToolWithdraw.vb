...
#Region "Shared"
    Public Shared Function GetSchemaTable() As TreeTable
      Dim myDatatable As New TreeTable("EquipmentToolWithdraw")
      ' Get from StockItem ...
...
#Region "Members"
    Private m_assetWithdraw As EquipmentToolWithdraw
#End Region
