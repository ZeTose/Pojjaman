...
#Region "Properties"
        ...
        Public Overrides ReadOnly Property DetailPanelTitle() As String
            Get
                Return "${res:Longkong.Pojjaman.BusinessLogic.ToolStockAdjust.DetailLabel}"
            End Get
        End Property
        Public Overrides ReadOnly Property DetailPanelIcon() As String
            Get
                Return "Icons.16x16.ToolStockAdjust"
            End Get
        End Property
        ...
        Public Overrides ReadOnly Property ListPanelTitle() As String
            Get
                Return "${res:Longkong.Pojjaman.BusinessLogic.ToolStockAdjust.ListLabel}"
            End Get
        End Property
...
#Region "Methods"
        Public Sub ProcessItems()
            ...
            For Each row As DataRow In ds.Tables(0).Rows
                Dim item As New ToolStockAdjustItem(row)
                item.ToolStockAdjust = Me
                Me.Add(item)
            Next
        End Sub
        ...
        Private Function SaveDetail(ByVal parentID As Integer, ByVal conn As SqlConnection, ByVal trans As SqlTransaction) As SaveErrorException
            Try
                '----------------HACK------------------------------------
                Try
                    Dim cmd As New SqlCommand("delete ToolStockAdjustItem where toolci_toolc = " & Me.Id, conn)
                ...
                '***********----WBS ----****************
                Dim da As New SqlDataAdapter("Select * from ToolStockAdjustItem where 1=2", conn)
                ...
                da.FillSchema(ds, SchemaType.Mapped, "ToolStockAdjustItem")
                da.Fill(ds, "ToolStockAdjustItem")

                Dim dtMatCounti As DataTable
                Dim dc As DataColumn
                dtMatCounti = ds.Tables("ToolStockAdjustItem")
...
#Region "Items"
        ...
        Private Sub LoadItems(ByVal ds As System.Data.DataSet, ByVal aliasPrefix As String)
            For Each dr As DataRow In ds.Tables(0).Rows
                Dim item As New ToolStockAdjustItem(dr, aliasPrefix)
                item.ToolStockAdjust = Me
                Me.Add(item)
            Next
        End Sub
        Public Sub AddBlankRow(ByVal count As Integer)
            For i As Integer = 0 To count - 1
                ...
                Dim mtwItem As New ToolStockAdjustItem
            ...
            Next
        End Sub
        Public Function Add(ByVal item As ToolStockAdjustItem) As TreeRow
            ...
            Return myRow
        End Function
        Public Function Insert(ByVal index As Integer, ByVal item As ToolStockAdjustItem) As TreeRow
...
#Region "Shared"
        Public Shared Function GetSchemaTable() As TreeTable
            Dim myDatatable As New TreeTable("ToolStockAdjust")
...
#Region "TreeTable Handlers"
        ...
        Private Sub SetEntity(ByVal e As DataColumnChangeEventArgs)
            Dim item As New ToolStockAdjustItem
