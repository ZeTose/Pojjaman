...
#Region "Constructors"
        ...
        Protected Overloads Overrides Sub Construct()
            ...
            With Me
                ...
                .m_recieveperson = New Employee
                .m_recievecc = New CostCenter
            End With
            ReLoadItems()
            'WrapperArrayList.AddItemAddedHandler(m_itemTable, AddressOf PRItemAdded)
            AddHandler m_itemTable.ColumnChanging, AddressOf Treetable_ColumnChanging
        ...
        Protected Overloads Overrides Sub Construct(ByVal dr As System.Data.DataRow, ByVal aliasPrefix As String)
            ...
            With Me
                ...
                End If
                ' return Person
                If dr.Table.Columns.Contains(aliasPrefix & "returnperson.employee_id") Then
                    If Not dr.IsNull("returnperson.employee_id") Then
                        .m_returnperson = New Employee(dr, "returnperson.")
                    End If
                Else
                ...
                End If
                ' Recieve Person
                If dr.Table.Columns.Contains(aliasPrefix & "Recieveperson.employee_id") Then
                    If Not dr.IsNull("Recieveperson.employee_id") Then
                        .m_Recieveperson = New Employee(dr, "Recieveperson.")
                    End If
                Else
                    If dr.Table.Columns.Contains(aliasPrefix & Me.Prefix & "_fromCCPerson") Then
                        If Not dr.IsNull(aliasPrefix & Me.Prefix & "_fromCCPerson") Then
                            .m_Recieveperson = New Employee(CInt(dr(aliasPrefix & Me.Prefix & "_fromCCPerson")))
                        End If
                    End If
                End If
                ' Recieve Costcenter
                If dr.Table.Columns.Contains(aliasPrefix & "Recievecostcenter.cc_id") Then
                    If Not dr.IsNull("Recievecostcenter.cc_id") Then
                        .m_Recievecc = New CostCenter(dr, "Recievecostcenter.")
                    End If
                Else
                    If dr.Table.Columns.Contains(aliasPrefix & Me.Prefix & "_fromcc") Then
                        If Not dr.IsNull(aliasPrefix & Me.Prefix & "_fromcc") Then
                            .m_Recievecc = New CostCenter(CInt(dr(aliasPrefix & Me.Prefix & "_fromcc")))
                        End If
                    End If
                End If
...
#Region "Properties"
        ...
        Public Overrides ReadOnly Property DetailPanelTitle() As String
            Get
                Return "${res:Longkong.Pojjaman.BusinessLogic.toolreturn.DetailLabel}"
            End Get
        End Property
        Public Overrides ReadOnly Property DetailPanelIcon() As String
            Get
                Return "Icons.16x16.toolreturn"
            End Get
        End Property
        ...
        Public Overrides ReadOnly Property ListPanelTitle() As String
            Get
                Return "${res:Longkong.Pojjaman.BusinessLogic.toolreturn.ListLabel}"
            End Get
        End Property
...
#Region "Methods"
        ...
        Public Overloads Overrides Function Save(ByVal currentUserId As Integer) As SaveErrorException
            With Me
                ...
                paramArrayList.Add(New SqlParameter("@" & Me.Prefix & "_fromCCPerson", IIf(Me.Recieveperson.Originated, Me.Recieveperson.Id, DBNull.Value)))
                paramArrayList.Add(New SqlParameter("@" & Me.Prefix & "_fromcc", IIf(Me.RecieveCostcenter.Originated, Me.RecieveCostcenter.Id, DBNull.Value)))
                paramArrayList.Add(New SqlParameter("@" & Me.Prefix & "_toCCPerson", IIf(Me.ReturnPerson.Originated, Me.m_returnperson.Id, DBNull.Value)))
                paramArrayList.Add(New SqlParameter("@" & Me.Prefix & "_tocc", IIf(Me.ReturnCostcenter.Originated, Me.ReturnCostcenter.Id, DBNull.Value)))
                paramArrayList.Add(New SqlParameter("@" & Me.Prefix & "_note", Me.Note))
                paramArrayList.Add(New SqlParameter("@" & Me.Prefix & "_type", Me.EntityId))
                ' Hack :
                paramArrayList.Add(New SqlParameter("@" & Me.Prefix & "_status", 2)) 'Me.Status.Value
        ...
        Private Function SaveDetail(ByVal parentID As Integer, ByVal conn As SqlConnection, ByVal trans As SqlTransaction) As SaveErrorException
            ...
            GenSprocText += "EXEC [InsertFIFOToolReturn] "
            GenSprocText += "@stocki_stock, @stocki_lineNumber, @stocki_cc, @stocki_fromcc"
            GenSprocText += ", @stocki_tocc, @stocki_toacct, @stocki_toAcctType, @stocki_refSequence, @stocki_entity"
            GenSprocText += ", @stocki_entityType, @stocki_itemname, @stocki_unit , @stocki_unitcost"
            GenSprocText += ", @stocki_amt, @stocki_qty, @stocki_stockqty, @stocki_iscancelled, @stocki_Note"
            GenSprocText += ", @stocki_type, @stocki_status, @includingCost"
            ...
            With ds.Tables("stockitem")
                For Each row As TreeRow In Me.ItemTable.Childs
                    If ValidateRow(row) Then
                        ...
                        dr("stocki_tocc") = Me.ValidIdOrDBNull(Me.RecieveCostcenter)
                        dr("stocki_toacct") = DBNull.Value
                        dr("stocki_toAcctType") = 3

                        dr("stocki_refSequence") = DBNull.Value
...
#Region "Items"
        ...
        Public Sub AddBlankRow(ByVal count As Integer)
            For i As Integer = 0 To count - 1
                ...
                myItem.CostCenter = Me.RecieveCostcenter
...
#Region "TreeTable Handlers"
        ...
        Public Sub SetEntityValue(ByVal e As System.Data.DataColumnChangeEventArgs)
            ...
            Dim entity As Tool
            entity = New Tool(e.ProposedValue.ToString)
...
#Region "IPrintableEntity"
        ...
        Public Function GetDocPrintingEntries() As DocPrintingItemCollection Implements IPrintableEntity.GetDocPrintingEntries
            ...
            If Not Me.ReturnPerson Is Nothing AndAlso Me.ReturnPerson.Originated Then
                'Requestor
                dpi = New DocPrintingItem
            ...
            If Not Me.ReturnCostcenter Is Nothing AndAlso Me.ReturnCostcenter.Originated Then
                'ReturnCC
                dpi = New DocPrintingItem
                dpi.Mapping = "ReturnCC"
                dpi.Value = Me.ReturnCostcenter.Code & ":" & Me.ReturnCostcenter.Name
                dpi.DataType = "System.String"
                dpiColl.Add(dpi)
            End If

            If Not Me.Recieveperson Is Nothing AndAlso Me.Recieveperson.Originated Then
                'StorePerson
                dpi = New DocPrintingItem
                dpi.Mapping = "StorePerson"
                dpi.Value = Me.Recieveperson.Code & ":" & Me.Recieveperson.Name
                dpi.DataType = "System.String"
                dpiColl.Add(dpi)
            End If

            If Not Me.RecieveCostcenter Is Nothing AndAlso Me.RecieveCostcenter.Originated Then
                'DestCC
                dpi = New DocPrintingItem
                dpi.Mapping = "DestCC"
                dpi.Value = Me.RecieveCostcenter.Code & ":" & Me.RecieveCostcenter.Name
                dpi.DataType = "System.String"
                dpiColl.Add(dpi)
            End If
...
#Region "Delete"
        ...
        Public Overrides Function Delete() As SaveErrorException
            ...
            format(0) = Me.Code
            If Not myMessage.AskQuestionFormatted("${res:Global.ConfirmDeleteToolReturn}", format) Then
            ...
            Try
                ...
                returnVal.Direction = ParameterDirection.ReturnValue
                returnVal.SourceVersion = DataRowVersion.Current
                SqlHelper.ExecuteNonQuery(conn, trans, CommandType.StoredProcedure, "DeleteToolReturn", New SqlParameter() {New SqlParameter("@" & Me.Prefix & "_id", Me.Id), returnVal})
                If IsNumeric(returnVal.Value) Then
                    Select Case CInt(returnVal.Value)
                        Case -1
                            trans.Rollback()
                            Return New SaveErrorException("${res:Global.ToolReturnIsReferencedCannotBeDeleted}")
                        Case Else
                    End Select
                ElseIf IsDBNull(returnVal.Value) OrElse Not IsNumeric(returnVal.Value) Then
                    trans.Rollback()
...
#End Region
        ...
        Public Property FromCC() As CostCenter Implements IHasFromCostCenter.FromCC
            Get
                Return Me.ReturnCostcenter
            End Get
            Set(ByVal Value As CostCenter)
                Me.ReturnCostcenter = Value
            End Set
        End Property

        Public Property ToCC() As CostCenter Implements IHasToCostCenter.ToCC
            Get
                Return Me.RecieveCostcenter
            End Get
            Set(ByVal Value As CostCenter)
                Me.RecieveCostcenter = Value
            End Set
        End Property
    End Class
