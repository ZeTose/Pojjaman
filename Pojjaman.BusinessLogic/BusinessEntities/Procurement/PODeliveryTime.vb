...
#Region "Properties"
        ...
        Public Overrides ReadOnly Property ClassName() As String
            Get
                Return "PODeliveryTime"
            End Get
        End Property
        Public Overrides ReadOnly Property DetailPanelTitle() As String
            Get
                Return "${res:Longkong.Pojjaman.BusinessLogic.PODeliveryTime.DetailLabel}"
            End Get
        End Property
        Public Overrides ReadOnly Property DetailPanelIcon() As String
            Get
                Return "Icons.16x16.PODeliveryTime"
            End Get
        End Property
        ...
        Public Overrides ReadOnly Property ListPanelTitle() As String
            Get
                Return "${res:Longkong.Pojjaman.BusinessLogic.PODeliveryTime.ListLabel}"
            End Get
        End Property
...
#Region "Shared"
        Public Shared Function GetPODeliveryTime(ByVal txtCode As TextBox, ByVal txtName As TextBox, ByRef oldPODeliveryTime As PODeliveryTime) As Boolean
            Dim myPODeliveryTime As New PODeliveryTime(txtCode.Text)
            If txtCode.Text.Length <> 0 AndAlso Not myPODeliveryTime.Originated Then
                MessageBox.Show(txtCode.Text & " ไม่มีในระบบ")
                myPODeliveryTime = oldPODeliveryTime
            End If
            txtCode.Text = myPODeliveryTime.Code
            txtName.Text = myPODeliveryTime.Name
            If oldPODeliveryTime.Id <> myPODeliveryTime.Id Then
                oldPODeliveryTime = myPODeliveryTime
                Return True
            End If
            Return False
        End Function
        Public Shared Sub ListInComboBox(ByVal cmb As ComboBox, Optional ByVal includeNothing As Boolean = False)
            ...
            For Each row As DataRow In dt.Rows
                Dim item As New IdValuePair(CInt(row("podeliverytime_id")), CStr(row("podeliverytime_name")))
                cmb.Items.Add(item)
            Next
