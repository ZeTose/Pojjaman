...
#End Region
  ...
  Public Class GoodsReceipt
   ...
   , ICloseStatusAble, IApproveStatusAble, IShowStatusColorAble, INewGLAble, INewPrintableEntity, IDocStatus
...
#Region "Methods"
    ...
    Private Function SubSaveDocApprove(ByVal conn As SqlConnection, ByVal currentUserId As Integer) As SaveErrorException
      ...
      Try
        Dim mldoc As New DocMultiApproval(Me.Id, Me.EntityId, Me.Code, Me.DocDate, Me.AfterTax, currentUserId, m_DocMethod, "", Me.ToCostCenter.Id, Me.Supplier.Id, Me)
