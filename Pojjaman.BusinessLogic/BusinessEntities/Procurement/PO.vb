...
Namespace Longkong.Pojjaman.BusinessLogic
  ...
  Public Class PO
    ...
    Implements IPrintableEntity, IApprovAble, ICancelable, IHasIBillablePerson, IHasToCostCenter _
      ...
      , IHasCurrency, IAbleExceptAccountPeriod, ICloseStatusAble, IApproveStatusAble, IShowStatusColorAble, INewPrintableEntity, IDocStatus, IDocumentPersonAble
...
#Region "Methods"
    ...
    Private Function SubSaveDocApprove(ByVal oldconn As SqlConnection, ByVal currentUserId As Integer) As SaveErrorException
      ...
      Try
                'Dim mldoc As New DocMultiApproval(Me.Id, Me.EntityId, Me.Code, Me.DocDate, Me.AfterTax, currentUserId, m_DocMethod, Me.ApproveDocColl.GetLastedApproveDoc.Comment, Me.CostCenter.Id, Me.Supplier.Id, Me)
                Dim mldoc As DocMultiApproval
                If Not (Me.ApproveDocColl Is Nothing) Then
                    mldoc = New DocMultiApproval(Me.Id, Me.EntityId, Me.Code, Me.DocDate, Me.AfterTax, currentUserId, m_DocMethod, Me.ApproveDocColl.GetLastedApproveDoc.Comment, Me.CostCenter.Id, Me.Supplier.Id, Me)
                Else
                    mldoc = New DocMultiApproval(Me.Id, Me.EntityId, Me.Code, Me.DocDate, Me.AfterTax, currentUserId, m_DocMethod, "", Me.CostCenter.Id, Me.Supplier.Id, Me)
                End If
