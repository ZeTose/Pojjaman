...
#Region "Properties"
    ...
    Public ReadOnly Property StockQty() As Decimal
      Get
        ...
        'เปลี่ยนเพราะทำให้ ปัดเศษก่อนเอาไปใช้ ทำให้ตัวเลขดึงไปจัดสรรเพี้ยน #1694
        ...
        Select Case e.Name.ToLower
          ...
          Case "wbs"
            ...
            If wbsd.IsMarkup Then
              wbsd.BudgetRemain = newWBS.GetTotalMarkUpFromDB - newWBS.GetWBSActualFromDB(Me.GoodsReceipt.Id, Me.GoodsReceipt.EntityId, Me.ItemType.Value)
              wbsd.QtyRemain = 0
            Else
