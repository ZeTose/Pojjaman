      ...
      With Me
        ...
        Else
          If dr.Table.Columns.Contains(aliasPrefix & "pri_unit") AndAlso Not dr.IsNull(aliasPrefix & "pri_unit") Then
            .m_unit = Unit.GetUnitById(CInt(dr(aliasPrefix & "pri_unit")))
            ...
            Case 42, 0
              ...
              If bitem.ULC <> 0 Then              '88 -> Lab
                ...
                If itemType = 42 Then
                  ...
                  labDoc.EntityName = bitem.EntityName
                Else
                  labDoc.EntityName = bitem.EntityName
                End If
              ...
              If bitem.UEC <> 0 Then              '89 -> EQ
                ...
                If itemType = 42 Then
                  ...
                  eqDoc.EntityName = bitem.EntityName
                Else
                  eqDoc.EntityName = bitem.EntityName
                End If
