...
#Region "Properties"
    ...
    Public Property DocDate() As Date Implements IGLAble.Date, ICheckPeriod.DocDate, IVatable.Date, IWitholdingTaxable.Date, IAdvancePayItemAble.DocDate
      Get
        Return m_docdate
      End Get
    ...
    Public Property AdvancePay() As AdvancePay
      ...
      Set(ByVal Value As AdvancePay)
        ...
        If m_advancepayitemcoll Is Nothing Then
          m_advancepayitemcoll = New AdvancePayItemCollection
        End If
        AdvancepayItemColl.Clear()
        Dim advpi As New AdvancePayItem
        advpi.AdvancePay = m_advancepay
        advpi.Amount = Me.Amount
        advpi.LineNumber = 1
        advpi.Note = Me.Note
        advpi.RefDocDate = Me.DocDate
        AdvancepayItemColl.Add(advpi)
    ...
    Public Property Note() As String Implements IGLAble.Note, IAdvancePayItemAble.Note
      Get
        Return m_note
      End Get
    ...
    Public Property RemainAmount() As Decimal
      ...
      Set(ByVal Value As Decimal)
        m_remainamt = Value
        If m_advancepayitemcoll IsNot Nothing AndAlso AdvancepayItemColl.Count > 0 Then
          AdvancepayItemColl.Item(0).Amount = Value
        End If
      End Set
    End Property
    ...
    Public Property Supplier() As Supplier Implements IAdvancePayItemAble.Supplier
      ...
      End Set
    End Property
    Public Property AdvancepayItemColl As AdvancePayItemCollection Implements IAdvancePayItemAble.AdvancePayItemCollection
      Get
...
#End Region
    ...
    Public Sub SetremainAVP()
      ...
      Dim remain As Decimal = Vat.GetExcludedVatAmount(RemainAmount) - Me.AvpVatBaseNotDueRemain
      If remain <= 0 Then
        Me.m_taxbase = 0
      Else
        Me.m_taxbase = remain
