...
#Region "IPrintableEntity"
    ...
    Public Function GetDocPrintingEntries() As DocPrintingItemCollection Implements IPrintableEntity.GetDocPrintingEntries
      ...
      '            เลขที่ใบกำกับภาษี(RefDoc)
      '            วันที่(RefDate)
      '            ผู้ขาย(SupplierInfo)
      '            รหัสผู้ขาย(SupplierCode)
      '            ชื่อผู้ขาย(SupplierName)
      '            CostCenter(CostCenterInfo)
      'รหัส CostCenter	CostCenterCode
      'ชื่อ CostCenter	CostCenterName
      '            เครดิต(CreditPeriod)
      '            ประเภท(TaxType)
      '            อัตราภาษี(TaxRate)
      '            ครบกำหนด(DueDate)
      '            จำนวนเงินก่อนภาษี(BeforeTax)
      '            ภาษีมูลค่าเพิ่ม(TaxAmount)
      '            มูลค่ารวมภาษี(AfterTax)
      '            ยอดเงินมัดจำคงเหลือ(Amount)
      '            หมายเหตุ(Note)
