...
#Region "Constructors"
    ...
    Public Sub New(ByVal stockid As Integer, ByVal line As Integer)
      ...
      For Each wbsRow As DataRow In ds.Tables(1).Select("stockiw_sequence=" & Me.Sequence & "and stockiw_direction=1")
        ...
        Me.MatTransfer.SetActual(wbsd.WBS, 0, wbsd.Amount, False)
      Next
    End Sub
...
#Region "Properties"
    ...
    'End Property    Public Function GetAmountFromSproc(ByVal lci_id As Integer, ByVal cc As Integer) As Decimal
      ...
      End Try
    End Function    Public Function CheckDupplicateLciCode(ByVal theCode As String) As Boolean      For Each itm As MatTransferItem In Me.MatTransfer.ItemCollection
    ...
    Public Sub WBSChangedHandler(ByVal sender As Object, ByVal e As PropertyChangedEventArgs)
      ...
      If TypeOf sender Is WBSDistribute Then
        ...
        Select Case e.Name.ToLower
          Case "percent"
            If Not Me.m_matTransfer Is Nothing Then
          ...
          Case "wbs"
            ...
            If wbsd.IsMarkup Then
              wbsd.BudgetRemain = newWBS.GetTotalMarkUpFromDB - newWBS.GetWBSActualFromDB(Me.MatTransfer.Id, Me.MatTransfer.EntityId, 42)
              wbsd.QtyRemain = 0
            Else
