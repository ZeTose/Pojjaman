          ...
          If Not Me.m_je.DontSave Then
            ...
            Try
              ...
              If Not Me.JournalEntry.ManualFormat Then
                ...
                Me.ItemCollection = New MatOperationReturnItemCollection(Me, True)
                '********************************************
      ...
      For Each item As MatOperationReturnItem In itemColl
        ...
        If Not originMatched Then
          ...
          If item.InWbsdColl Is Nothing Then
            ...
            ji.AtomNote = "คืนล้าง WIP มา store "
            jiColl.Add(ji)
          Else
            For Each iwbs As WBSDistribute In item.InWbsdColl
              ji = New JournalEntryItem
        ...
        If Not realAccount Is Nothing AndAlso realAccount.Originated Then
          If Not lciMatched Then
            ...
            If item.InWbsdColl Is Nothing Then
              ...
              ji.EntityItemType = 42
              ji.table = Me.TableName & "item"
              ji.AtomNote = "รับคืน WIP มา store "
              jiColl.Add(ji)
            Else
              For Each iwbs As WBSDistribute In item.InWbsdColl
                ji = New JournalEntryItem
...
#Region "INewPrintableEntity"
    Public Function GetDocPrintingColumnsEntries() As DocPrintingItemCollection Implements INewPrintableEntity.GetDocPrintingColumnsEntries
      ...
      dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Item.Total", "System.Int32", "Item"))
