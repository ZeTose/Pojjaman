...
Namespace Longkong.Pojjaman.BusinessLogic
    Public Class MatStockAdjustItem

#Region "Members"
        Private m_matstockcount As MatStockAdjust
...
#Region "Methods"
        Public Sub CopyToDataRow(ByVal row As TreeRow)
            ...
            Me.MatStockAdjust.IsInitialized = False
            ...
            If Me.MatStockAdjust.ValidateRow(row) Then
            ...
            Me.MatStockAdjust.IsInitialized = True
        End Sub
