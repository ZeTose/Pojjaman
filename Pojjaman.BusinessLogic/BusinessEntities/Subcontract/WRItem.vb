...
#Region "Constructors"
    ...
    Protected Sub Construct(ByVal dr As DataRow, ByVal aliasPrefix As String)
      With Me
        ...
        End If
        If dr.Table.Columns.Contains(aliasPrefix & "wrio_amount") AndAlso Not dr.IsNull(aliasPrefix & "wrio_amount") Then
...
#Region "Properties"
    ...
    End Function    Public Sub SetItemCode(ByVal theCode As String)      Dim unitPrice As Decimal = 0
      ...
      Select Case Me.ItemType.Value
        Case 289
          msgServ.ShowMessage("${res:Global.Error.wrItemCannotHaveCode}")
          Return
        Case 160, 162
...
#Region "Methods"
    ...
    Public Function IsHasChild() As Boolean
      ...
      For i As Integer = startIndex To Me.wr.ItemCollection.Count - 1
        ...
        If i > startIndex Then
          If Me.wr.ItemCollection(i).Level = 0 Then
            Exit For
          End If
          lastIndex = i
        End If
    ...
    Public Sub SetItems(ByVal items As BasketItemCollection, Optional ByVal targetType As Integer = -1)
      ...
      For i As Integer = 0 To items.Count - 1
        ...
        ElseIf TypeOf items(i).Tag Is BoqItem Then
          ...
          Dim matDoc As WRItem
          Dim labDoc As WRItem
          Dim eqDoc As WRItem
