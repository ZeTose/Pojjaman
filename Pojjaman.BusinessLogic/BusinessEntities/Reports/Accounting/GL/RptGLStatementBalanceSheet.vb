...
Namespace Longkong.Pojjaman.BusinessLogic
    Public Class RptGLStatementBalanceSheet
        Inherits Report
...
#End Region#Region "Properties"        Public Overrides ReadOnly Property ClassName() As String
            Get
                Return "RptGLStatementBalanceSheet"
            End Get
        End Property
        Public Overrides ReadOnly Property DetailPanelTitle() As String
            Get
                Return "${res:Longkong.Pojjaman.BusinessLogic.RptGLStatementBalanceSheet.DetailLabel}"
            End Get
        End Property
        Public Overrides ReadOnly Property DetailPanelIcon() As String
            Get
                Return "Icons.16x16.RptGLStatementBalanceSheet"
            End Get
        End Property
        ...
        Public Overrides ReadOnly Property ListPanelTitle() As String
            Get
                Return "${res:Longkong.Pojjaman.BusinessLogic.RptGLStatementBalanceSheet.ListLabel}"
            End Get
        End Property
