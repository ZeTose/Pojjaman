...
#Region "Methods"
    Public Function GetDataSource() As DataSet
      ...
      Return ds
    End Function
    Public Function GetCompanyConfig() As DataSet
      Dim ds As DataSet = SqlHelper.ExecuteDataset(SimpleBusinessEntityBase.ConnectionString,
                                               CommandType.StoredProcedure,
    ...
    '    Return Me.ReportPath & drh.GetValue(Of String)("report_name") & ".repx"
    '  End If
    'End Function
    ...
    '    Dim drh As New DataRowHelper(CType(hashAllReport(key.Id), DataRow))
    '    myReport = Me.ReportPath & drh.GetValue(Of String)("report_name") & ".repx"
    ...
    'End Sub
#End Region#Region "Shared"
#End Region#Region "Properties"    Private ReadOnly Property StoreProcedureName As String      Get
        Return "Get" & Me.ReportName & "List"
      End Get
    ...
    End Property    Public ReadOnly Property FullReportName As String      Get
        Return Me.ReportPath & Me.ReportName & ".repx"
      End Get
    ...
    Public Overrides ReadOnly Property DetailPanelTitle() As String
      Get
        Return "${res:Longkong.Pojjaman.BusinessLogic.XtraReport.DetailLabel}"
      End Get
    End Property
    Public Overrides ReadOnly Property DetailPanelIcon() As String
      Get
        Return "Icons.16x16.XtraReport"
      End Get
    End Property
    ...
    Public Overrides ReadOnly Property ListPanelTitle() As String
      Get
        Return "${res:Longkong.Pojjaman.BusinessLogic.XtraReport.ListLabel}"
      End Get
    End Property
