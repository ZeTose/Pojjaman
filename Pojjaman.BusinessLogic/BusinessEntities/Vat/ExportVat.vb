...
#Region "Members"
    Private m_ListOfExportVat As List(Of ExportVatItem)
#End Region

#Region "Properties"
    Public ExportDate As DateTime
    Public Property WitholdingTaxIdList As List(Of Integer)
    ...
    Public Property SendType1 As String
    Public Property SendType2 As String
    Public Property SendType3 As String
    Public Property TotincYear As String
    Public Property TotincMonth As String

    Public Property ListOfExportVat As List(Of ExportVatItem)
      Get
        If m_ListOfExportVat Is Nothing Then
          m_ListOfExportVat = New List(Of ExportVatItem)
        End If
        Return m_ListOfExportVat
      End Get
      Set(ByVal value As List(Of ExportVatItem))
        m_ListOfExportVat = value
      End Set
    End Property
#End Region

#Region "Constructor"
    Public Sub New(ByVal taxYear As String, ByVal taxMonth As String, ByVal type As String, ByVal ds As DataSet)
      Dim sendType() As String = type.Split("|"c)

      'เลขประจำตัวผู้เสียภาษี
      Me.TaxIdNo = Mid(Configuration.GetConfig("CompanyTaxId").ToString.Trim, 1, 10)
      Me.TotincYear = taxYear
      Me.TotincMonth = taxMonth
      Dim branch As Object = Configuration.GetConfig("CompanyTaxBranchId").ToString
      If branch Is Nothing OrElse CStr(branch).Length = 0 Then
        Me.BranchId = "00000"
      Else
        Me.BranchId = CStr(branch)
      End If
      Me.SendType1 = sendType(0)
      Me.SendType2 = sendType(1)
      Me.SendType3 = sendType(2)
      'Me.IndicationSubmit = ""

      For Each row As DataRow In ds.Tables(0).Rows
        Dim drh As New DataRowHelper(row)

        Dim expitem As New ExportVatItem(row)
        'expitem.IndicationSubmit = drh.GetValue(Of Integer)("wht_indicationSubmit")
        'expitem.SubmitNo = drh.GetValue(Of Integer)("wht_submitNo")
        'expitem.PayDate = drh.GetValue(Of Date)("docdate")
        'expitem.TaxRate = drh.GetValue(Of Decimal)("taxrate")
        'expitem.TaxBase = drh.GetValue(Of Decimal)("beforetax")
        'expitem.TaxAmount = drh.GetValue(Of Decimal)("whtamt")
        'expitem.ConditionType = drh.GetValue(Of String)("whtpaymenttype")

        ListOfExportVat.Add(expitem)
      Next
    End Sub
    ...
    '  VatType = drh.GetValue(Of Integer)("expv_vattype")
    '  PinNo = drh.GetValue(Of String)("expv_pinno")
    '  RegistrationNo = drh.GetValue(Of String)("expv_registrationno")
    '  TaxIdNo = drh.GetValue(Of String)("expv_taxidno")
    '  BranchId = drh.GetValue(Of String)("expv_branchid")
    '  IndicateSubmit = drh.GetValue(Of String)("expv_indicatesubmit")
    '  SubmitNo = drh.GetValue(Of Integer)("expv_submitno")
    '  SendType1 = drh.GetValue(Of String)("expv_sendtype1")
    '  SendType2 = drh.GetValue(Of String)("expv_sendtype2")
    '  SendType3 = drh.GetValue(Of String)("expv_sendtype3")
    '  TotincYear = drh.GetValue(Of String)("expv_totincyear")
    '  TotincMonth = drh.GetValue(Of String)("expv_totincmonth")

    '  ListOfExportVat = Me.GetListOfExportVat
...
#Region "Method"
    ...
    'Public Function GetExportEntity() As DataSet
    '  Dim ds As DataSet = SqlHelper.ExecuteDataset(SimpleBusinessEntityBase.ConnectionString, CommandType.StoredProcedure, "GetExportEntity")
    'End Function

    'Public Function GetListOfExportVat() As List(Of ExportVatItem)
    '  'Dim ds As DataSet = SqlHelper.ExecuteDataset(SimpleBusinessEntityBase.ConnectionString,
    '  '                                              CommandType.StoredProcedure,
    '  '                                              "GetListOfExportVat",
    '  '                                              New SqlParameter("expv_id", Me.Id)
    '  ')
    '  'Dim lexVat As New List(Of ExportVatItem)
    '  'For Each row As DataRow In ds.Tables(0).Rows
    '  '  Dim item As New ExportVatItem(row)
    '  '  item.ExportVat = Me
    '  '  lexVat.Add(item)
    '  'Next
    '  'Return lexVat
...
#Region "Properties"
    Public Property ExportVat As ExportVat
    ...
    'Public Property TaxIdNo As String
    'Public Property BranchId As String
    'Public Property IndicateSubmit As String
    'Public Property SubmitNo As Integer
    'Public Property SendType1 As String
    'Public Property SendType2 As String
    'Public Property SendType3 As String
    'Public Property TotincYear As String
    'Public Property TotincMonth As String
    Public Property WitholdingTaxId As Integer

    Public Property IndicationSubmit As Integer
    Public Property SubmitNo As Integer
    Public Property RevenuePinNo As String
    Public Property RevenueRegistrationNo As String
    Public Property RevenueBranchId As String
    Public Property RevenueTitleName As String
    Public Property RevenueFirstName As String
    Public Property RevenueLastName As String
    ...
    Public Property IndicationType As String
...
#Region "Constructor"
    Public Sub New(ByVal row As DataRow)
      ...
      WitholdingTaxId = drh.GetValue(Of Integer)("wht_id")

      RevenuePinNo = drh.GetValue(Of String)("exportentity_idno")
      RevenueRegistrationNo = drh.GetValue(Of String)("exportentity_registrationno")
      RevenueBranchId = drh.GetValue(Of String)("exportentity_branchid")
      RevenueTitleName = drh.GetValue(Of String)("exportentity_titlename")
      RevenueFirstName = drh.GetValue(Of String)("exportentity_firstname")
      RevenueLastName = drh.GetValue(Of String)("exportentity_lastname")
      BuildingName = drh.GetValue(Of String)("exportentity_buildingname")
      VillageName = drh.GetValue(Of String)("exportentity_villagename")
      RoomNo = drh.GetValue(Of String)("exportentity_roomnumber")
      FloorNo = drh.GetValue(Of String)("exportentity_floor")
      AddressNo = drh.GetValue(Of String)("exportentity_address")
      Moo = drh.GetValue(Of String)("exportentity_moo")
      SubStreet = drh.GetValue(Of String)("exportentity_substreet")
      Street = drh.GetValue(Of String)("exportentity_street")
      Tambon = drh.GetValue(Of String)("exportentity_tambon")
      District = drh.GetValue(Of String)("exportentity_district")
      Province = drh.GetValue(Of String)("exportentity_province")
      PostCode = drh.GetValue(Of String)("exportentity_postcode")
      PhoneNumber = drh.GetValue(Of String)("exportentity_phonenumber")
      Note = drh.GetValue(Of String)("exportentity_note")

      IndicationSubmit = drh.GetValue(Of Integer)("wht_indicationSubmit")
      SubmitNo = drh.GetValue(Of Integer)("wht_submitNo")
      PayDate = drh.GetValue(Of Date)("docdate")
      TaxRate = drh.GetValue(Of Decimal)("taxrate")
      TaxBase = drh.GetValue(Of Decimal)("beforetax")
      TaxAmount = drh.GetValue(Of Decimal)("whtamt")
      ConditionType = drh.GetValue(Of String)("whtpaymenttype")
    End Sub
#End Region
