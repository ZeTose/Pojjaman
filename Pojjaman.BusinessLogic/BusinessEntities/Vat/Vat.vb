...
#End Region
    ...
    Public Class Vat
        ...
        Implements IPrintableEntity, IHasMainDoc, INewPrintableEntity, IDocStatus
        ...
        Protected Overloads Overrides Sub Construct(ByVal dr As System.Data.DataRow, ByVal aliasPrefix As String)
            ...
            With Me
                ...
                If entityType = 10 AndAlso dr.Table.Columns.Contains(aliasPrefix & "supplier_id") AndAlso Not dr.IsNull(aliasPrefix & "supplier_id") Then
                    ...
                    .vat_entity = CType(New Supplier(CInt(dr("supplier_id"))), IBillablePerson)
                Else
...
#Region "Shared"
    ...
    , ByVal vati_refdoctype As Integer, ByVal vat_refdoc As Integer, ByVal vat_refdoctype As Integer, ByVal conn As SqlConnection, ByVal trans As SqlTransaction) As SimpleVat
            ...
            If ds.Tables(0).Rows.Count = 1 Then
                ...
                'End If
                sv.TaxBase = drh.GetValue(Of Decimal)("TaxBase")
                sv.VatAmt = drh.GetValue(Of Decimal)("VatAmt")
            End If
            Return sv
        End Function
        Public Shared Function GetTaxBaseDeductedWithoutThisRefDoc(ByVal vati_refdoc As Integer _
      , ByVal vati_refdoctype As Integer, ByVal vat_refdoc As Integer, ByVal vat_refdoctype As Integer) As SimpleVat
            Dim sv As New SimpleVat
            ...
            Return sv
        End Function
        Public Shared Function GetVatValue(ByVal vati_refdoc As Integer _
     , ByVal vati_refdoctype As Integer) As SimpleVat
            Dim sv As New SimpleVat
            Dim ds As DataSet = SqlHelper.ExecuteDataset(SimpleBusinessEntityBase.ConnectionString _
            , CommandType.StoredProcedure _
            , "GetVatValueFromDoc" _
            , New SqlParameter("@vati_refdoc", vati_refdoc) _
            , New SqlParameter("@vati_refdoctype", vati_refdoctype) _
            )
            If ds.Tables(0).Rows.Count = 1 Then
...
#Region "Methods"
        ...
        Private Function DupInside(ByVal target As VatItem) As String
            For Each item As VatItem In Me.ItemCollection
                If Not item Is target Then
                    If Not item.Code Is Nothing AndAlso Not target.Code Is Nothing AndAlso (item.Code.ToLower = target.Code.ToLower) Then
                        Return item.Code
                    End If
                End If
            Next
        ...
        Public Function BeforeSave(ByVal currentUserId As Integer) As SaveErrorException
            ...
            If Me.Direction.Value = 0 AndAlso TypeOf Me.RefDoc Is IVatAndVatDetailAble Then
                For Each item As VatItem In Me.ItemCollection
                    If item.Code Is Nothing OrElse item.Code.Trim.Length = 0 Then
                        Dim newCode As String = CodeGenerator.Generate(ptn, lastCode, Me.RefDoc) 'Me.RefDoc)
                        item.Code = newCode
                        lastCode = newCode
                    End If
                Next
        ...
        Private Function SaveDetail(ByVal parentID As Integer, ByVal conn As SqlConnection, ByVal trans As SqlTransaction) As Integer
            ...
            'pattern = CodeGenerator.GetPattern(pattern)
            'Dim lastCode As String = vi.GetLastCode(pattern, conn, trans)
            ...
            With ds.Tables("Vatitem")
                ...
                For Each item As VatItem In Me.ItemCollection
                    ...
                    '  item.Code = item.GetNextCode(conn, trans)
...
#Region "IPrintableEntity"
        ...
        Public Function GetDocPrintingEntries() As DocPrintingItemCollection Implements IPrintableEntity.GetDocPrintingEntries
            ...
            If Me.ItemCollection.Count = 1 Then
                ...
                dpi.Value = Me.ItemCollection.Item(0).PrintAddress
                dpi.DataType = "System.String"
                dpiColl.Add(dpi)
...
#Region "INewPrintableEntity"
        Public Function GetDocPrintingColumnsEntries() As DocPrintingItemCollection Implements INewPrintableEntity.GetDocPrintingColumnsEntries
            ...
            dpiColl.RelationList.Add("general>vat_id>item>vati_vat")

            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("vat_id", "System.String"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Code", "System.String"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("PORefCode", "System.String"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("AdvanceReceiveAmount", "System.String"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("AdvanceReceiveVATAmount", "System.String"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("DocDate", "System.DateTime"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("VatItemCodes", "System.String"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("InvoiceCode", "System.String"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("VatItemDates", "System.String"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Note", "System.String"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Note2", "System.String"))
            ...
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("vati_vat", "System.String", "Item"))
            ...
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Item.RefDoc", "System.String", "Item"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Item.PrintName", "System.String", "Item"))
            ...
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Item.TaxRate", "System.String", "Item"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Item.TaxAmount", "System.String", "Item"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Item.Note", "System.String", "Item"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Item.TypeName", "System.String", "Item"))
        ...
        Public ReadOnly Property DocStatus As String Implements IDocStatus.DocStatus
            Get
                If Me.Status.Value = 0 Then
                    Return "Canceled"
                Else
                    'Dim obj As Object = Configuration.GetConfig("ApproveGR")
                    'If CBool(obj) Then
...
#End Region
    ...
    Public Class VatItem
        ...
        , IHasFromCostCenter, IHasGroup, IPrintableEntity, ICanSaveTreeTable, INewPrintableEntity, IDocStatus
...
#Region "ICodeGeneratable"
        'Public Function GetLastCode(ByVal prefixPattern As String, ByVal conn As System.Data.SqlClient.SqlConnection, ByVal trans As System.Data.SqlClient.SqlTransaction) As String
        ...
        '  Return ""
        'End Function
        'Public Function GetNextCode(ByVal conn As System.Data.SqlClient.SqlConnection, ByVal trans As System.Data.SqlClient.SqlTransaction) As String
        '  Dim ptn As String = Entity.GetAutoCodeFormat(Me.EntityId)
        '  Dim pattern As String = CodeGenerator.GetPattern(ptn, Me)
        '  pattern = CodeGenerator.GetPattern(pattern)
        '  Dim newCode As String = CodeGenerator.Generate(ptn, Me.GetLastCode(pattern, conn, trans), Me)
        '  While DuplicateCode(newCode, conn, trans)
        '    newCode = CodeGenerator.Generate(Entity.GetAutoCodeFormat(Me.EntityId), newCode, Me)
        '  End While
        '  Return newCode
        'End Function
        'Public Function DuplicateCode(ByVal newCode As String, ByVal conn As System.Data.SqlClient.SqlConnection, ByVal trans As System.Data.SqlClient.SqlTransaction) As Boolean
...
#Region "IPrintableEntity"
        ...
        Public Function GetDocPrintingEntries() As DocPrintingItemCollection Implements IPrintableEntity.GetDocPrintingEntries
                ...
                If TypeOf Me.Vat.RefDoc Is PaySelection Then
                    ...
                    For Each pi As BillAcceptanceItem In py.ItemCollection
                        If pi.ParentType = 60 Then
                            If Not refdocEntityList.Contains(pi.ParentCode) Then
                ...
                ElseIf TypeOf Me.Vat.RefDoc Is ReceiveSelection Then
                    ...
                    For Each sb As SaleBillIssueItem In rs.ItemCollection
                        If sb.ParentType = 81 Then
                            If Not refdocEntityList.Contains(sb.ParentCode) Then
            ...
            If Not ls Is Nothing Then
                ...
                For Each lineText As String In ls
                    ...
                    If Not showSpecificLineOnly OrElse (j = Me.LineNumber OrElse ls.Count <> myCount) Then
                        ...
                        If lineTexts.Length > 1 Then
                            ...
                            If lineTexts.Length = 15 AndAlso IsNumeric(lineTexts(13)) Then
                            ...
                            If Not (typeValue = 160 OrElse typeValue = 162) Then
                                ...
                                dpi = New DocPrintingItem
                                dpi.Mapping = "Item.Qty"
                                If IsNumeric(lineTexts(9)) Then
                                    dpi.Value = Configuration.FormatToString(CDec(lineTexts(9)), DigitConfig.Qty)
                                End If
                                dpi.DataType = "System.String"
                                dpi.Row = i + 1
                                dpi.Table = "Item"
                                ...
                                dpi = New DocPrintingItem
                                dpi.Mapping = "Item.UnitPrice"
                                If IsNumeric(lineTexts(1)) Then
                                    dpi.Value = Configuration.FormatToString(CDec(lineTexts(1)) * typeValue, DigitConfig.Price)
                                End If
                                dpi.DataType = "System.String"
                                dpi.Row = i + 1
                                dpi.Table = "Item"
                                ...
                                dpi = New DocPrintingItem
                                dpi.Mapping = "Item.Amount"
                                If IsNumeric(lineTexts(2)) Then
                                    dpi.Value = Configuration.FormatToString(CDec(lineTexts(2)) * typeValue, DigitConfig.Price)
                                End If
                                dpi.DataType = "System.String"
                                dpi.Row = i + 1
                                dpi.Table = "Item"
                                ...
                                If IsNumeric(lineTexts(4)) Then
                                    dpi.Value = Configuration.FormatToString(CDec(lineTexts(4)) * typeValue, DigitConfig.Price)
                                End If
                                dpi.DataType = "System.Decimal"
                                dpi.Row = i + 1
                                dpi.Table = "Item"
                                ...
                                If IsNumeric(lineTexts(6)) Then
                                    dpi.Value = Configuration.FormatToString(CDec(lineTexts(6)) * typeValue, DigitConfig.Price)
                                End If
                                dpi.DataType = "System.String"
                                dpi.Row = i + 1
                                dpi.Table = "Item"
                                ...
                                If IsNumeric(lineTexts(12)) Then
                                    dpi.Value = Configuration.FormatToString(CDec(lineTexts(12)) * typeValue, DigitConfig.Price)
                                End If
                                dpi.DataType = "System.String"
                                dpi.Row = i + 1
                                dpi.Table = "Item"
                ...
                '************************************Copy Item table**********************************************
                Dim listAcceptName As List(Of String) = New List(Of String)(New String() {"vati_vat", "item.name", "item.linenumber"})

                Dim nTableName As String = "ItemStyle1"
                Dim ndpiColl As New DocPrintingItemCollection
                For Each dpin As DocPrintingItem In dpiColl
                    If Not dpin.Table Is Nothing AndAlso dpin.Table.ToLower().Equals("item") Then
                        Dim newMapping As String = dpin.Mapping
                        If dpin.Mapping.IndexOf("."c) > 0 Then
                            Dim m As String = dpin.Mapping.Split("."c)(1)
                            newMapping = String.Format("{0}.{1}", nTableName, m)
                        End If
                        If dpin.Level = 0 Then
                            If listAcceptName.Contains(dpin.Mapping.ToLower()) Then
                                dpi = New DocPrintingItem
                                dpi.Mapping = newMapping
                                dpi.Value = dpin.Value
                                dpi.DataType = dpin.DataType
                                dpi.Row = dpin.Row
                                dpi.Table = nTableName
                                ndpiColl.Add(dpi)
                            End If
                        Else
                            dpi = New DocPrintingItem
                    ...
                    End If
                Next
                dpiColl.AddRange(ndpiColl)

                nTableName = "ItemStyle2"
                ndpiColl = New DocPrintingItemCollection
                Dim dic As Dictionary(Of String, Integer)
                ...
                For Each dpin As DocPrintingItem In dpiColl
                    If Not dpin.Table Is Nothing AndAlso dpin.Table.ToLower().Equals("item") Then
                        ...
                        Else
                            If dpin.Mapping.ToLower().Equals("vati_vat") Then
                                rowIndex += 1
                            End If
                            dpi = New DocPrintingItem
                            dpi.Mapping = newMapping
...
#Region "IPrintableEntity"
        Public Function GetDocPrintingColumnsEntries() As DocPrintingItemCollection Implements INewPrintableEntity.GetDocPrintingColumnsEntries
            ...
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("RefDocCode", "System.String"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("TaxAmount", "System.Decimal"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("BeforeTaxAmount", "System.Decimal"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("AfterTax", "System.Decimal"))
            ...
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("AfterRetionAmount", "System.Decimal"))
            ...
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Item.Qty", "System.String", "Item"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Item.UnitPrice", "System.String", "Item"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Item.RealUnitPrice", "System.String", "Item"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Item.Amount", "System.String", "Item"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Item.DiscountRate", "System.String", "Item"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Item.DiscountAmount", "System.Decimal", "Item"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Item.Note", "System.Decimal", "Item"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Item.UnitPriceWithoutDeduct", "System.Decimal", "Item"))
            dpiColl.Add(EntitySimpleSchema.NewDocPrintingItem("Item.AmountWithoutDeduct", "System.Decimal", "Item"))
