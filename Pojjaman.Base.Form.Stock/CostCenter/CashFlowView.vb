...
Public Class CashFlowView
  ...
  Private Sub CashFlowView_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Me.lblProjectName.Text = CostCenter.Name & " " & CostCenter.Code
  ...
  Public Sub PopulateRow(ByVal c As CBS, ByVal tr As GridViewDataRowInfo)
    ...
    For Each p As CBSValue In c.Plan(CostCenter.BoqId)
    ...
    tr.Cells("Planned").Value = Configuration.FormatToString(c.GetPlannedValue(CostCenter.BoqId), DigitConfig.Price)
  ...
  Public CostCenter As CostCenter
  Private Sub UpdateWeeks()
    ...
    Dim ws As List(Of Week) = New Budget(CostCenter.BoqId).GetWeeks
    Dim i As Integer = 0
