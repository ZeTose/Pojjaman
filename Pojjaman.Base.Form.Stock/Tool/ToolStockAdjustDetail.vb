...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class ToolStockAdjustDetail
...
#Region "Initialize"
        ...
        Protected Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(ToolStockAdjustDetail))
...
#Region "Overrides"
        ...
        Public Overrides Sub SetLabelText()
            ...
            'Me.lblCode.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ToolStockAdjustDetail.lblCode}")
            'Me.lblDocDate.Text = Me.StringParserService.Parse("${res:Global.DocDateText}")
            'Me.lblProjectName.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ToolStockAdjustDetail.lblProjectName}")
