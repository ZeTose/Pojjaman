...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Protected Sub InitializeComponent()
            ...
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(MatLabDetail))
...
#Region "Constructor"
        Public Sub New()
            ...
            Dim dt As TreeTable = LCILaborCostLink.GetSchemaTable
...
#Region "Style"
        Public Function CreateTableStyle() As DataGridTableStyle
            ...
            csUnit.HeaderText = myStringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.MatLabDetail.UnitHeaderText}")
            csUnit.NullText = ""
            ...
            csNote.HeaderText = myStringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.MatLabDetail.NoteHeaderText}")
            csNote.NullText = ""
            ...
            csCostDate.HeaderText = myStringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.MatLabDetail.CostDateHeaderText}")
            csCostDate.NullText = ""
...
#Region "IListDetail"
        ...
        Public Overrides Sub SetLabelText()
            ...
            Me.lblItem.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.MatLabDetail.lblItem}")
            Me.lblAltName.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.MatLabDetail.lblAltName}")
            Me.lblName.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.MatLabDetail.lblName}")
            Me.grbLCI.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.MatLabDetail.grbLCI}")
            Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.MatLabDetail.grbDetail}")
        End Sub
        ...
        Public Overrides Sub UpdateEntityProperties()
            ...
            If Me.m_entity Is Nothing Then
                Return
            End If
            If Me.m_entity.LCILaborCostLink Is Nothing Then
                Return
            End If
            ...
            Me.m_treeManager.Treetable = Me.m_entity.LCILaborCostLink.ItemTable
            AddHandler Me.m_entity.LCILaborCostLink.PropertyChanged, AddressOf PropChanged
        ...
        Public Overrides Property Entity() As ISimpleEntity
            ...
            Set(ByVal Value As ISimpleEntity)
                If Not Object.ReferenceEquals(Me.m_entity, Value) Then
                    ...
                    If Not Me.m_entity.LCILaborCostLink Is Nothing Then
                        RemoveHandler Me.m_entity.LCILaborCostLink.PropertyChanged, AddressOf PropChanged
                    End If
                End If
                If Not Me.m_entity.LCILaborCostLink Is Nothing Then
                    Me.m_entity.LCILaborCostLink.OnTabPageTextChanged(m_entity, EventArgs.Empty)
                End If
...
#Region "Event Handlers"
        Public Sub LaborButtonClick(ByVal e As ButtonColumnEventArgs)
            Dim myEntityPanelService As IEntityPanelService = CType(ServiceManager.Services.GetService(GetType(IEntityPanelService)), IEntityPanelService)
            Dim filters(0) As Filter
            filters(0) = New Filter("IDList", GenIDListFromDataTable())
            myEntityPanelService.OpenListDialog(New Labor, AddressOf SetItems, filters)
        End Sub
        Private Function GenIDListFromDataTable() As String
            Dim idlist As String = ""
            For Each row As TreeRow In Me.m_entity.LCILaborCostLink.ItemTable.Rows
                If Not IsDBNull(row("lcil_labor")) Then
                    idlist &= CStr(row("lcil_labor")) & ","
                End If
            Next
        ...
        Private Sub SetItems(ByVal items As BasketItemCollection)
            ...
            For i As Integer = items.Count - 1 To 0 Step -1
                ...
                If i = items.Count - 1 Then
                    If Me.m_entity.LCILaborCostLink.ItemTable.Childs.Count = 0 Then
                        Me.m_entity.LCILaborCostLink.AddBlankRow(1)
                        Me.m_entity.LCILaborCostLink.ItemTable.Childs(0)("Code") = item.Code
                    Else
                        Me.m_entity.LCILaborCostLink.ItemTable.Childs(index)("Code") = item.Code
                    End If
                Else
                    Me.m_entity.LCILaborCostLink.Insert(index, New LCILaborCostLinkItem)
                    Me.m_entity.LCILaborCostLink.ItemTable.Childs(index)("Code") = item.Code
                End If
                Me.m_entity.LCILaborCostLink.ItemTable.AcceptChanges()
            Next
        ...
        Private Sub ibtnBlank_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ibtnBlank.Click
            Dim index As Integer = tgItem.CurrentRowIndex
            Dim myItem As New LCILaborCostLinkItem
            myItem.Labor = New Labor
            Me.m_entity.LCILaborCostLink.Insert(index, myItem)
            Me.m_entity.LCILaborCostLink.ItemTable.AcceptChanges()
            tgItem.CurrentRowIndex = index
            RefreshBlankGrid()
        End Sub
        Private Sub ibtnDelRow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ibtnDelRow.Click
            ...
            Me.m_entity.LCILaborCostLink.Remove(index)
...
#Region "Grid Resizing"
        ...
        Private Sub RefreshBlankGrid()
            ...
            Do Until Me.m_entity.LCILaborCostLink.ItemTable.Rows.Count > tgItem.VisibleRowCount
                'เพิ่มแถวจนเต็ม
                Me.m_entity.LCILaborCostLink.AddBlankRow(1)
            Loop
            ...
            If Me.m_entity.LCILaborCostLink.MaxRowIndex = Me.m_entity.LCILaborCostLink.ItemTable.Childs.Count - 1 Then
