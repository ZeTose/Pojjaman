...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Protected Sub InitializeComponent()
      ...
      Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(UnitListView))
      ...
      Me.tgItem.Size = New System.Drawing.Size(656, 296)
      ...
      Me.ibtnBlank.Location = New System.Drawing.Point(128, 56)
      ...
      Me.ibtnDelRow.Location = New System.Drawing.Point(152, 56)
      ...
      Me.cmbUnitType.Location = New System.Drawing.Point(120, 32)
      ...
      Me.lblUnitType.Location = New System.Drawing.Point(16, 32)
...
#Region "Members"
    ...
    Private m_unitCollection As UnitCollection
...
#Region "Properties"
    Public Property UnitCollection() As UnitCollection      Get        Return m_unitCollection      End Get      Set(ByVal Value As UnitCollection)        m_unitCollection = Value      End Set    End Property
#End Region
...
#Region "ISimpleListPanel"
    ...
    Public Sub SetLabelText() Implements ISimplePanel.SetLabelText
      ...
      Me.lblItem.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.UnitListView.lblItem}")
...
#Region "Style"
    Public Function CreateTableStyle() As DataGridTableStyle
      ...
      dst.MappingName = "Unit"

      Dim csLineNumber As New TreeTextColumn
      csLineNumber.MappingName = "LineNumber"
      csLineNumber.HeaderText = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.UnitListView.LineNumberHeaderText}")
      ...
      csCode.HeaderText = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.UnitListView.CodeHeaderText}")
      csCode.NullText = ""
      csCode.Width = 100
      ...
      csName.HeaderText = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.UnitListView.NameHeaderText}")
      csName.NullText = ""
      csName.Width = 100
    ...
    Public Function GetSchemaTable() As TreeTable
      Dim myDatatable As New TreeTable("Unit")
...
#Region "TreeTable Handlers"
    ...
    Public Sub ValidateRow(ByVal e As DataColumnChangeEventArgs)
      ...
      If Not isBlankRow Then
        If IsDBNull(code) OrElse CStr(code).Length = 0 Then
          e.Row.SetColumnError("code", Me.StringParserService.Parse("${res:Global.Error.NoUnitCode}"))
        Else
          e.Row.SetColumnError("code", "")
        End If
        If IsDBNull(name) OrElse CStr(name).Length = 0 Then
          e.Row.SetColumnError("name", Me.StringParserService.Parse("${res:Global.Error.NoUnitName}"))
        Else
    ...
    Private Function DupCodeOrName(ByVal e As DataColumnChangeEventArgs) As Boolean
      ...
      For Each row As TreeRow In Me.m_treeManager.Treetable.Rows
        ...
        End If
      Next
      Dim testUnit As New Unit(e.ProposedValue.ToString)
      If m_unit Is Nothing OrElse m_unit.Originated Then
        If testUnit.Originated Then
          Return True
        End If
      End If
      If Not m_unit Is Nothing AndAlso m_unit.Originated Then
        If testUnit.Originated And testUnit.Id <> m_unit.Id Then
          Return True
        End If
      End If
      Return False
    ...
    Public Sub SetCode(ByVal e As System.Data.DataColumnChangeEventArgs)
      ...
      If m_unit.IsDefault Then
        Me.MessageService.ShowMessageFormatted("${res:Global.Error.DefaultUnitCannotBeModified}", New String() {m_unit.Code})
        e.ProposedValue = e.Row(e.Column)
        m_updating = False
        Return
      End If
      If DupCodeOrName(e) Then
        msgServ.ShowMessageFormatted("${res:Global.Error.AlreadyHasCodeOrName}", New String() {m_unit.DetailPanelTitle, e.ProposedValue.ToString})
        e.ProposedValue = e.Row(e.Column)
        m_updating = False
        Return
      End If
      If Not m_unit.Code.Equals(e.ProposedValue.ToString) Then
        m_unit.IsDirty = True
      End If
      m_unit.Code = e.ProposedValue.ToString
      m_updating = False
    End Sub
...
#Region "Event Handlers"
    Private Sub ibtnBlank_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ibtnBlank.Click
      Dim newItem As New Unit
      Me.m_unitCollection.Add(newItem)
    ...
    Private Sub ibtnDelRow_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ibtnDelRow.Click
      ...
      If theRow Is Nothing Then
        Return
      End If
      If Not TypeOf theRow.Tag Is Unit Then
        Return
      End If
      If Me.m_unit Is Nothing Then
        Return
      End If
      If m_unit.IsDefault Then
        Me.MessageService.ShowMessageFormatted("${res:Global.Error.DefaultUnitCannotBeDeleted}", New String() {m_unit.Name})
        Return
      End If
      Me.m_unitCollection.Remove(m_unit)
      m_unit = Nothing
    ...
    Private Sub tgItem_CurrentCellChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles tgItem.CurrentCellChanged
      ...
      If m_oldRow Is theRow Then
        Return
      End If
      If TypeOf theRow.Tag Is Unit Then
        m_unit = CType(theRow.Tag, Unit)
      Else
        m_unit = Nothing
      End If
    ...
    Private Sub btnSearch_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSearch.Click
      ...
      If otherLength > 0 Then
        ...
        Next
      End If
      Me.m_unitCollection = New UnitCollection(newfilters)

      Me.m_tableInitialized = False
      Me.m_unitCollection.PopulateTable(Me.m_treeManager.Treetable)
      Me.m_tableInitialized = True
      Me.IsDirty = False
    End Sub
