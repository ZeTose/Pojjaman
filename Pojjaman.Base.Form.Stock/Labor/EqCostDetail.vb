...
#Region " Windows Form Designer generated code "
        ...
        Friend WithEvents lblSelectEq As System.Windows.Forms.Label
        ...
        <System.Diagnostics.DebuggerStepThrough()> Protected Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(EqCostDetail))
            ...
            Me.lblSelectEq = New System.Windows.Forms.Label
            ...
            Me.grbDetail.Controls.Add(Me.lblSelectEq)
            ...
            Me.grbDetail.Size = New System.Drawing.Size(656, 456)
            Me.grbDetail.TabIndex = 0
            Me.grbDetail.TabStop = False
            Me.grbDetail.Text = "ข้อมูลค่าเครื่องจักร:"
            '
            'chkAutorun
            '
            ...
            Me.lblCostDate.Size = New System.Drawing.Size(80, 18)
            ...
            Me.lblStatus.Location = New System.Drawing.Point(3, 436)
            ...
            Me.btnUnitFind.Location = New System.Drawing.Point(400, 96)
            ...
            Me.btnUnitEdit.Location = New System.Drawing.Point(424, 96)
            ...
            Me.tgSelectedMat.Location = New System.Drawing.Point(8, 200)
            ...
            'lblSelectEq
            '
            Me.lblSelectEq.Font = New System.Drawing.Font("Tahoma", 9.75!, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, CType(222, Byte))
            Me.lblSelectEq.ForeColor = System.Drawing.Color.Black
            Me.lblSelectEq.Location = New System.Drawing.Point(8, 184)
            Me.lblSelectEq.Name = "lblSelectEq"
            Me.lblSelectEq.Size = New System.Drawing.Size(232, 18)
            Me.lblSelectEq.TabIndex = 17
            Me.lblSelectEq.Text = "รายการ/หมวดวัสดุที่ใช้ค่าเครื่องจักรนี้"
            Me.lblSelectEq.TextAlign = System.Drawing.ContentAlignment.MiddleLeft
            '
            'lblCost
            '
            ...
            Me.txtUnitName.Size = New System.Drawing.Size(208, 21)
            ...
            Me.txtCostDate.Location = New System.Drawing.Point(320, 144)
            ...
            Me.dtpCostDate.Location = New System.Drawing.Point(320, 144)
            ...
            Me.txtGroupName.Size = New System.Drawing.Size(208, 21)
            Me.txtGroupName.TabIndex = 326
            ...
            Me.btnGroupEdit.Location = New System.Drawing.Point(424, 120)
            Me.btnGroupEdit.Name = "btnGroupEdit"
            Me.btnGroupEdit.Size = New System.Drawing.Size(24, 23)
            Me.btnGroupEdit.TabIndex = 328
            ...
            Me.btnGroupFind.Location = New System.Drawing.Point(400, 120)
            Me.btnGroupFind.Name = "btnGroupFind"
            Me.btnGroupFind.Size = New System.Drawing.Size(24, 23)
            Me.btnGroupFind.TabIndex = 327
            ...
            Me.Name = "EqCostDetail"
            Me.Size = New System.Drawing.Size(672, 472)
...
#Region " SetLabelText "
        Public Overrides Sub SetLabelText()
            ...
            Me.lblName.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.EqCostDetail.lblName}")
            Me.Validator.SetDisplayName(txtName, lblName.Text)

            Me.lblAltName.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.EqCostDetail.lblAltName}")
            ...
            Me.lblSelectEq.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.EqCostDetail.lblSelectEq}")

            Me.lblCostDate.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.LaborDetailView.lblCostDate}")
            Me.Validator.SetDisplayName(txtCostDate, lblCostDate.Text)

        End Sub
#End Region

#Region "Member"
        Private m_entity As New EqCost
...
#Region "IListDetail"
        ...
        Public Sub ChangeProperty(ByVal sender As Object, ByVal e As EventArgs)
            ...
            Select Case CType(sender, Control).Name.ToLower
                ...
                Case "txtgroupcode"
                    dirtyFlag = EqCostGroup.GetEqCostGroup(txtGroupCode, txtGroupName, Me.m_entity.Group)
                Case "dtpcostdate"
...
#Region " Event of Buttons "
        Private Sub ShowNewPanels(ByVal entity As ISimpleEntity)
            ...
            If Not myEntityPanelService.IsOpen(entity) Then
        ...
        Private Sub btnGroupEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGroupEdit.Click
            Dim myEntityPanelService As IEntityPanelService = CType(ServiceManager.Services.GetService(GetType(IEntityPanelService)), IEntityPanelService)
            myEntityPanelService.OpenPanel(New EqCostGroup)
        End Sub

        Private Sub btnGroupFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGroupFind.Click
            Dim myEntityPanelService As IEntityPanelService = CType(ServiceManager.Services.GetService(GetType(IEntityPanelService)), IEntityPanelService)
            myEntityPanelService.OpenTreeDialog(New EqCostGroup, AddressOf SetEqCostGroup)
        End Sub

        Private Sub SetEqCostGroup(ByVal e As ISimpleEntity)
            Me.txtGroupCode.Text = e.Code
            Me.WorkbenchWindow.ViewContent.IsDirty = Me.WorkbenchWindow.ViewContent.IsDirty Or _
            EqCostGroup.GetEqCostGroup(txtGroupCode, txtGroupName, Me.m_entity.Group)
        End Sub
#End Region
