...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents ibtnSort As Longkong.Pojjaman.Gui.Components.ImageButton
    ...
    <System.Diagnostics.DebuggerStepThrough()> Protected Sub InitializeComponent()
      ...
      Me.tgItem.Size = New System.Drawing.Size(692, 149)
      ...
      Me.lblItem.Location = New System.Drawing.Point(6, 170)
      ...
      Me.grbDetail.Controls.Add(Me.ibtnSort)
      ...
      'ibtnDown
      '
      Me.ibtnDown.FlatStyle = System.Windows.Forms.FlatStyle.System
      Me.ibtnDown.Location = New System.Drawing.Point(237, 166)
      Me.ibtnDown.Name = "ibtnDown"
      Me.ibtnDown.Size = New System.Drawing.Size(45, 32)
      Me.ibtnDown.TabIndex = 345
      Me.ibtnDown.TabStop = False
      Me.ibtnDown.ThemedImage = CType(resources.GetObject("ibtnDown.ThemedImage"), System.Drawing.Bitmap)
      Me.ToolTip1.SetToolTip(Me.ibtnDown, "เลื่อนแถวลง")
      '
      'ibtnUp
      '
      Me.ibtnUp.FlatStyle = System.Windows.Forms.FlatStyle.System
      Me.ibtnUp.Location = New System.Drawing.Point(192, 166)
      Me.ibtnUp.Name = "ibtnUp"
      Me.ibtnUp.Size = New System.Drawing.Size(45, 32)
      Me.ibtnUp.TabIndex = 344
      Me.ibtnUp.TabStop = False
      Me.ibtnUp.ThemedImage = CType(resources.GetObject("ibtnUp.ThemedImage"), System.Drawing.Bitmap)
      Me.ToolTip1.SetToolTip(Me.ibtnUp, "เลื่อนแถวขึ้น")
      '
      'ibtnSort
      '
      Me.ibtnSort.FlatStyle = System.Windows.Forms.FlatStyle.System
      Me.ibtnSort.Location = New System.Drawing.Point(283, 166)
      Me.ibtnSort.Name = "ibtnSort"
      Me.ibtnSort.Size = New System.Drawing.Size(32, 32)
      Me.ibtnSort.TabIndex = 343
      Me.ibtnSort.TabStop = False
      Me.ibtnSort.ThemedImage = CType(resources.GetObject("ibtnSort.ThemedImage"), System.Drawing.Bitmap)
      Me.ToolTip1.SetToolTip(Me.ibtnSort, "เรียงรายการตามเดบิต/เครดิต")
      '
      'TabControl1
      '
      ...
      Me.TabControl1.Location = New System.Drawing.Point(6, 192)
      Me.TabControl1.Name = "TabControl1"
      Me.TabControl1.SelectedIndex = 0
      Me.TabControl1.Size = New System.Drawing.Size(706, 181)
      ...
      Me.TabPage1.Size = New System.Drawing.Size(698, 155)
      ...
      Me.TabPage2.Size = New System.Drawing.Size(698, 155)
      ...
      Me.tgItem2.Size = New System.Drawing.Size(692, 149)
      ...
      Me.ibtnBlank.Location = New System.Drawing.Point(133, 167)
      ...
      Me.ibtnDelRow.Location = New System.Drawing.Point(157, 167)
...
#Region "IListDetail"
    ...
    Public Overrides Sub UpdateEntityProperties()
      ...
      If Not Me.m_je.Originated Then
        Dim Config As Object = Configuration.GetConfig("TabDetailNoteToOtherTab")
        If CBool(Config) Then
          If Me.m_je.Note Is Nothing OrElse Me.m_je.Note.Length = 0 Then
            Me.m_je.Note = m_je.RefDoc.Note
          End If
        End If
      End If
...
#Region ""
    Private Sub ibtnSort_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ibtnSort.Click
      Me.m_je.SortDebitCredit()
    ...
    Private Sub ibtnUp_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ibtnUp.Click
      Dim item As JournalEntryItem = CurrentItem
      If item Is Nothing Then
        Return
      End If
      Me.m_je.ItemCollection.MoveItemUp(item)
      Me.UpdateEntityProperties()
      tgItem.CurrentRowIndex = Me.m_je.ItemCollection.IndexOf(item)
      Me.WorkbenchWindow.ViewContent.IsDirty = True
    End Sub
    ...
    Private Sub ibtnDown_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ibtnDown.Click
      ...
      If item Is Nothing Then
        Return
      End If
      Me.m_je.ItemCollection.MoveItemDown(item)
      Me.UpdateEntityProperties()
      tgItem.CurrentRowIndex = Me.m_je.ItemCollection.IndexOf(item)
      Me.WorkbenchWindow.ViewContent.IsDirty = True
    End Sub
#End Region
    ...
    Private Sub ibtnRefresh_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ibtnRefresh.Click
      If TypeOf Me.m_entity Is SimpleBusinessEntityBase Then
        CType(Me.m_entity, SimpleBusinessEntityBase).OnGlChanged()
      End If
