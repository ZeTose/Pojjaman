...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class SaleDNFilterSubPanel
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(SaleDNFilterSubPanel))
            ...
            Me.grbDetail.Size = New System.Drawing.Size(760, 192)
            ...
            Me.grbDocDate.Location = New System.Drawing.Point(368, 112)
            ...
            Me.btnSearch.Location = New System.Drawing.Point(680, 160)
            ...
            Me.btnReset.Location = New System.Drawing.Point(600, 160)
            ...
            Me.btnCustomerPanel.Location = New System.Drawing.Point(312, 110)
            ...
            Me.txtCustomerCode.Location = New System.Drawing.Point(112, 111)
            ...
            Me.btnCustomerDialog.Location = New System.Drawing.Point(288, 110)
            ...
            Me.btnFromCostCenterPanel.Location = New System.Drawing.Point(312, 64)
            ...
            Me.btnFromCostCenterDialog.Location = New System.Drawing.Point(288, 64)
            ...
            Me.btnFromCCPersonPanel.Location = New System.Drawing.Point(312, 40)
            ...
            Me.btnFromCCPersonDialog.Location = New System.Drawing.Point(288, 40)
            ...
            '
            'SaleDNFilterSubPanel
            '
            Me.Controls.Add(Me.grbDetail)
            Me.Name = "SaleDNFilterSubPanel"
            Me.Size = New System.Drawing.Size(776, 208)
...
#Region "Methods"
        ...
        Public Sub SetLabelText()
            Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleDNFilterSubPanel.grbDetail}")
            Me.lblCode.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleDNFilterSubPanel.lblCode}")
            Me.btnSearch.Text = Me.StringParserService.Parse("${res:Global.SearchButtonText}")
            Me.btnReset.Text = Me.StringParserService.Parse("${res:Global.ResetButtonText}")
            Me.grbDocDate.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleDNFilterSubPanel.grbDocDate}")
            Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleDNFilterSubPanel.lblDocDateStart}")
            Me.lblDocDateEnd.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleDNFilterSubPanel.lblDocDateEnd}")
            Me.lblFromCCPerson.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleDNFilterSubPanel.lblFromCCPerson}")
            Me.lblFromCC.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleDNFilterSubPanel.lblFromCC}")
            Me.lblStatus.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleDNFilterSubPanel.lblStatus}")
            Me.grbItem.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleDNFilterSubPanel.grbItem}")
            Me.lblLCI.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleDNFilterSubPanel.lblLCI}")
            Me.lblTool.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleDNFilterSubPanel.lblTool}")
            Me.lblBlank.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleDNFilterSubPanel.lblBlank}")
            Me.lblCustomer.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleDNFilterSubPanel.lblCustomer}")
            Me.grbMainDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleDNFilterSubPanel.grbMainDetail}")
        End Sub
...
#End Region
        ...
        Private Sub EntityRefresh()
            ...
            For Each entity As ISimpleEntity In Entities
                ...
                If TypeOf entity Is SaleDN Then
                    Dim obj As SaleDN
                    obj = CType(entity, SaleDN)
                    ' Customer ...
