...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class SaleCNFilterSubPanel
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(SaleCNFilterSubPanel))
            ...
            Me.btnCustomerPanel.Location = New System.Drawing.Point(312, 64)
            ...
            Me.txtCustomerCode.Location = New System.Drawing.Point(112, 64)
            ...
            Me.txtCustomerName.Location = New System.Drawing.Point(192, 64)
            ...
            Me.btnCustomerDialog.Location = New System.Drawing.Point(288, 64)
            ...
            '
            'SaleCNFilterSubPanel
            '
            Me.Controls.Add(Me.grbDetail)
            Me.Name = "SaleCNFilterSubPanel"
...
#Region "Methods"
        ...
        Private Sub PopulateStatus()
            CodeDescription.ListCodeDescriptionInComboBox(cmbStatus, "salecn_status", True)
        End Sub
        Public Sub SetLabelText()
            Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleCNFilterSubPanel.grbDetail}")
            Me.lblCode.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleCNFilterSubPanel.lblCode}")
            Me.btnSearch.Text = Me.StringParserService.Parse("${res:Global.SearchButtonText}")
            Me.btnReset.Text = Me.StringParserService.Parse("${res:Global.ResetButtonText}")
            Me.grbDocDate.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleCNFilterSubPanel.grbDocDate}")
            Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleCNFilterSubPanel.lblDocDateStart}")
            Me.lblDocDateEnd.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleCNFilterSubPanel.lblDocDateEnd}")
            Me.lblStatus.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleCNFilterSubPanel.lblStatus}")
            Me.grbItem.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleCNFilterSubPanel.grbItem}")
            Me.lblLCI.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleCNFilterSubPanel.lblLCI}")
            Me.lblTool.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleCNFilterSubPanel.lblTool}")
            Me.lblBlank.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleCNFilterSubPanel.lblBlank}")
            Me.lblCustomer.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleCNFilterSubPanel.lblCustomer}")
            Me.grbMainDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.SaleCNFilterSubPanel.grbMainDetail}")
        End Sub
...
#Region "Event Handlers"
        'Private Sub txtToCCPersonCode_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs)
        ...
        End Sub
        'Private Sub btnToCCPersonDialog_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        '    Dim myEntityPanelService As IEntityPanelService = CType(ServiceManager.Services.GetService(GetType(IEntityPanelService)), IEntityPanelService)
        ...
        '    Employee.GetEmployee(txtToCCPersonCode, txtToCCPersonName, Me.m_ToCCPerson)
        'End Sub
        Private Sub btnToCCPersonPanel_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
            Dim myEntityPanelService As IEntityPanelService = CType(ServiceManager.Services.GetService(GetType(IEntityPanelService)), IEntityPanelService)
...
#End Region
        ...
        Private Sub EntityRefresh()
            ...
            For Each entity As ISimpleEntity In Entities
                ...
                If TypeOf entity Is SaleCN Then
                    Dim obj As SaleCN
                    obj = CType(entity, SaleCN)
                    ' Customer ...
