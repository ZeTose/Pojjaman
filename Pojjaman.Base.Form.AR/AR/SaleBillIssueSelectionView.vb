...
Namespace Longkong.Pojjaman.Gui.Panels
  Public Class SaleBillIssueSelectionView
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      '
      'SaleBillIssueSelectionView
      '
      Me.Controls.Add(Me.tgItem)
      Me.Controls.Add(Me.Splitter1)
      Me.Controls.Add(Me.pnlFilter)
      Me.Name = "SaleBillIssueSelectionView"
...
#Region "Constructors"
    Public Sub New(ByVal entity As ISimpleEntity, ByVal handler As Object, ByVal basket As BasketDialog, ByVal filters As Filter(), ByVal entities As ArrayList)
      ...
      'Hack
      m_filterSubPanel = New SaleBillIssueFilterSubPanel
...
#Region "Methods"
    ...
    Public Sub SearchData(ByVal order As String)
      ...
      Dim dt As TreeTable = SaleBillIssueItem.GetSelectionListDatatable(newfilters)
...
#Region "Style"
    Public Function CreateListTableStyle() As DataGridTableStyle
      ...
      dst.MappingName = "SaleBillIssueItems"
          ...
          For Each childRow As TreeRow In row.Childs
            If Not IsDBNull(childRow("Selected")) Then
              If CBool(childRow("Selected")) Then
                ...
                Dim fullClassName As String = "Longkong.Pojjaman.BusinessLogic.SaleBillIssueItem"
                ...
                newItem.ParentType = sbi.EntityId
                ...
                If Not childRow.IsNull("salebillii_unreceivedamt") Then
                  newItem.UnreceivedAmount = CDec(childRow("salebillii_unreceivedamt")) 'receivable.GetRemainingAmountReceiveSelection(receives_id)
                End If
