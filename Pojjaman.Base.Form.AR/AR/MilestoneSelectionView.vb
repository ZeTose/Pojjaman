...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.Name = "MilestoneSelectionView"
...
#Region "Constructors"
        Public Sub New(ByVal entity As ISimpleEntity, ByVal mode As Selection, ByVal basket As BasketDialog, ByVal filters As Filter(), ByVal entities As ArrayList)
            ...
            'Hack
            m_filterSubPanel = New BillIssueFilterSubPanel
...
#Region "Methods"
        ...
        Public Sub SearchData(ByVal order As String)
            ...
            Dim dt As TreeTable = Milestone.GetSelectionListDatatableForCustomer(newfilters)
                ...
                For Each row As TreeRow In myTable.Childs
                    For Each childRow As TreeRow In row.Childs
                        If Not IsDBNull(childRow("Selected")) Then
                            If CBool(childRow("Selected")) Then
                                Dim id As Integer = CInt(childRow("cc_id"))
                                Dim miId As Integer = CInt(childRow("milestone_id"))
                                ...
                                Dim item As New Milestone(miId)
                                item = item.Clone(item.Type)
                                Dim bi As New StockBasketItem(id, stockCode, fullClassName, textInBasket, item.Id, 0, entityName)
                                bi.Tag = item
