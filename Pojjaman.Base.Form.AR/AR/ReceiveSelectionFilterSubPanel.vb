...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class ReceiveSelectionFilterSubPanel
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(ReceiveSelectionFilterSubPanel))
            ...
            Me.grbDetail.Size = New System.Drawing.Size(648, 120)
            ...
            Me.grbGeneral.Size = New System.Drawing.Size(424, 96)
            ...
            Me.txtRVCodeEnd.Location = New System.Drawing.Point(264, 64)
            ...
            Me.lblRVEnd.Location = New System.Drawing.Point(240, 64)
            ...
            Me.txtRVCodeStart.Location = New System.Drawing.Point(104, 64)
            ...
            Me.lblRVStart.Location = New System.Drawing.Point(8, 64)
            ...
            Me.btnRVStartFind.Location = New System.Drawing.Point(208, 64)
            ...
            Me.btnRVEndFind.Location = New System.Drawing.Point(368, 64)
            ...
            Me.btnSearch.Location = New System.Drawing.Point(560, 88)
            ...
            Me.btnReset.Location = New System.Drawing.Point(472, 88)
            ...
            '
            'ReceiveSelectionFilterSubPanel
            '
            Me.Controls.Add(Me.grbDetail)
            Me.Name = "ReceiveSelectionFilterSubPanel"
            Me.Size = New System.Drawing.Size(664, 136)
...
#Region " SetLabelText "
        Public Sub SetLabelText()
            ...
            Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ReceiveSelectionFilterSubPanel.grbDetail}")
            Me.grbGeneral.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ReceiveSelectionFilterSubPanel.grbGeneral}")
            Me.grbDocDate.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ReceiveSelectionFilterSubPanel.grbDocDate}")

            Me.btnSearch.Text = Me.StringParserService.Parse("${res:Global.SearchButtonText}")
            Me.btnReset.Text = Me.StringParserService.Parse("${res:Global.ResetButtonText}")

            Me.lblCode.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ReceiveSelectionFilterSubPanel.lblCode}")

            Me.lblCustomer.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ReceiveSelectionFilterSubPanel.lblCustomer}")

            Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ReceiveSelectionFilterSubPanel.lblDocDateStart}")
            Me.Validator.SetDisplayName(txtDocdateStart, lblDocDateStart.Text)

            Me.lblDocDateEnd.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ReceiveSelectionFilterSubPanel.lblDocDateEnd}")
            Me.Validator.SetDisplayName(txtDocDateEnd, lblDocDateEnd.Text)

            Me.lblRVStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ReceiveSelectionFilterSubPanel.lblRVStart}")
            Me.lblRVEnd.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ReceiveSelectionFilterSubPanel.lblRVEnd}")
        End Sub
#End Region
...
#Region "Methods"
        ...
        Private Sub ClearCriterias()
            ...
            Dim dtStart As Date = Date.Now.AddMonths(-1)
        ...
        Public Overrides Function GetFilterArray() As Filter()
            ...
            arr(4) = New Filter("RVCodeStart", IIf(txtRVCodeStart.TextLength > 0, txtRVCodeStart.Text, DBNull.Value))
            arr(5) = New Filter("RVCodeEnd", IIf(txtRVCodeEnd.TextLength > 0, txtRVCodeEnd.Text, DBNull.Value))
            Return arr
        End Function
