...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class PMAFilterSubPanel
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(PMAFilterSubPanel))
            ...
            Me.txtCustomerCode.Location = New System.Drawing.Point(112, 16)
            ...
            Me.grbMainDetail.Size = New System.Drawing.Size(584, 96)
            ...
            Me.btnCustomerPanel.Location = New System.Drawing.Point(552, 16)
            ...
            Me.btnCustomerDialog.Location = New System.Drawing.Point(528, 16)
            ...
            Me.btnCostCenterPanel.Location = New System.Drawing.Point(552, 40)
            ...
            Me.btnCostCenterDialog.Location = New System.Drawing.Point(528, 40)
            ...
            Me.btnSearch.Location = New System.Drawing.Point(336, 64)
            ...
            Me.btnReset.Location = New System.Drawing.Point(256, 64)
            ...
            Me.Name = "PMAFilterSubPanel"
            Me.Size = New System.Drawing.Size(600, 112)
...
#Region "Methods"
        ...
        Public Sub SetLabelText()
            ...
            Me.lblCC.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.PMAFilterSubPanel.lblCC}")
            Me.lblStatus.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.PMAFilterSubPanel.lblStatus}")
            Me.grbMainDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.PMAFilterSubPanel.grbMainDetail}")
            Me.lblCustomer.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.PMAFilterSubPanel.lblCustomer}")
        End Sub
        ...
        Public Overrides ReadOnly Property EnablePaste() As Boolean
            Get
                ...
                If data.GetDataPresent(m_cc.FullClassName) Then
                    ...
                    End Select
                End If
                If data.GetDataPresent((New Project).FullClassName) Then
                    Select Case Me.ActiveControl.Name.ToLower
...
#End Region
        ...
        Private Sub EntityRefresh()
            ...
            For Each entity As ISimpleEntity In Entities
                ...
                If TypeOf entity Is PaymentApplication Then
                    Dim obj As PaymentApplication
                    obj = CType(entity, PaymentApplication)
                    ' Customer ...
