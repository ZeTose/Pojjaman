...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Protected Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(ReceiveDetail))
      ...
      Me.grbDetail.Size = New System.Drawing.Size(737, 576)
      ...
      'ibtnOtherCredit
      '
      Me.ibtnOtherCredit.FlatStyle = System.Windows.Forms.FlatStyle.System
      ...
      Me.tgItem.Location = New System.Drawing.Point(10, 96)
      Me.tgItem.Name = "tgItem"
      Me.tgItem.Size = New System.Drawing.Size(718, 272)
      ...
      Me.lblItem.Location = New System.Drawing.Point(32, 76)
      ...
      Me.Size = New System.Drawing.Size(757, 592)
...
#Region "Event Handlers"
    Public Sub BAButtonClick(ByVal e As ButtonColumnEventArgs)
      ...
      ElseIf CInt(Me.m_receive.ItemTable.Rows(e.Row)("receivei_entityType")) = 0 Then
        Return
      End If
      If CInt(Me.m_receive.ItemTable.Rows(e.Row)("receivei_entityType")) <> 72 Then
        If Me.m_receive.ItemTable.Rows(e.Row).IsNull("receivei_entity") Then
          Return
        Else
      ...
      'filters(0) = New Filter() {New Filter("bankId", chk.Bank.Id)}
      'Dim entities(0) As ISimpleEntity
      'entities(0) = New BankAccount
      Dim myEntityPanelService As IEntityPanelService = CType(ServiceManager.Services.GetService(GetType(IEntityPanelService)), IEntityPanelService)
    ...
    Private Sub SetItems(ByVal items As BasketItemCollection)
      ...
      For i As Integer = items.Count - 1 To 0 Step -1
        ...
        itemCode = item.Code
        Dim incheck As IncomingCheck = Nothing
        Dim itemType As Integer
        Select Case item.FullClassName.ToLower
          Case "longkong.pojjaman.businesslogic.incomingcheck"
            itemType = 27
            incheck = New IncomingCheck(item.Id)
        ...
        If Not itemType = 0 Then
          If i = items.Count - 1 Then
            If Me.m_receive.ItemTable.Childs.Count = 0 Then
              ...
              If incheck IsNot Nothing AndAlso incheck.BankAccount IsNot Nothing Then
                Me.m_receive.ItemTable.Childs(0)("bacode") = incheck.BankAccount.Code
                Me.m_receive.ItemTable.Childs(0)("BAName") = incheck.BankAccount.Name
                Me.m_receive.ItemTable.Childs(0)("receivei_bankacct") = incheck.BankAccount.Id
              End If
            Else
              Me.m_receive.ItemTable.Childs(index)("receivei_entityType") = itemType
              Me.m_receive.ItemTable.Childs(index)("Code") = itemCode
              If incheck IsNot Nothing AndAlso incheck.BankAccount IsNot Nothing Then
                Me.m_receive.ItemTable.Childs(index)("bacode") = incheck.BankAccount.Code
                Me.m_receive.ItemTable.Childs(index)("BAName") = incheck.BankAccount.Name
                Me.m_receive.ItemTable.Childs(index)("receivei_bankacct") = incheck.BankAccount.Id
              End If
            End If
          Else
