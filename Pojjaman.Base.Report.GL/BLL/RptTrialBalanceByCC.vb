...
#Region "Style"
    ...
    Private Sub CreateHeader()
      ...
      tr("openningdocdr") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptTrialBalanceByCC.OpenningBalance}") '"ยอดยกมา"
      tr("docdr") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptTrialBalanceByCC.Period}") '"ยอดประจำงวด"
      tr("sumdr") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptTrialBalanceByCC.Summary}") '"ยอดสะสม"

      tr = Me.m_treemanager.Treetable.Childs.Add
      tr("acct_code") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptJournalEntry.CostCenterCode}") '"รหัส Cost Center"
      tr("acct_name") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptJournalEntry.CostCenterName}") '"ชื่อ Cost Center"
      tr("openningdocdr") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptTrialBalanceByCC.DocDr}") '"เครดิต"
      tr("openningdoccr") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptTrialBalanceByCC.DocCr}") '"เดบิต"
      tr("docdr") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptTrialBalanceByCC.DocDr}") '"เครดิต"
      tr("doccr") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptTrialBalanceByCC.DocCr}") '"เดบิต"
      tr("sumdr") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptTrialBalanceByCC.DocDr}") '"เครดิต"
      tr("sumcr") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptTrialBalanceByCC.DocCr}") '"เดบิต"
      ...
      'tr("doccr") = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptTrialBalanceByCC.DocCr}") '"CR ในช่วง"
      ' Level 2.
      'tr = Me.m_treemanager.Treetable.Childs.Add
