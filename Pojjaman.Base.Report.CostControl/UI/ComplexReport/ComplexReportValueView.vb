...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class ComplexReportValueView
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Protected Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(ComplexReportValueView))
            ...
            Me.Name = "ComplexReportValueView"
...
#Region "IListDetail"
        ...
        Public Overrides Sub SetLabelText()
            ...
            Me.lblItem.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ComplexReportValueView.lblItem}")
            Me.lblCode.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ComplexReportValueView.lblCode}")
            Me.lblName.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ComplexReportValueView.lblName}")
        End Sub
        ...
        Public Sub SetFontStyle(ByVal e As ButtonColumnEventArgs)
            ...
            With dialog
                ...
                Select Case e.Column
                    Case 3
                        .Font = ComplexReport.StringToFont(CStr(IIf(theRow.IsNull("crpti_namestyle"), "", theRow("crpti_namestyle"))))
                    Case 6
                        .Font = ComplexReport.StringToFont(CStr(IIf(theRow.IsNull("crpti_notestyle"), "", theRow("crpti_notestyle"))))
                    Case 8
                        .Font = ComplexReport.StringToFont(CStr(IIf(theRow.IsNull("crpti_formulastyle"), "", theRow("crpti_formulastyle"))))
                    Case Else
            ...
            Dim fntstr As String = ComplexReport.FontToString(fnt)
            Select Case e.Column
                Case 3
                    theRow("crpti_namestyle") = fntstr
                Case 6
                    theRow("crpti_notestyle") = fntstr
                Case 8
                    theRow("crpti_formulastyle") = fntstr
                Case Else
