...
using Longkong.Pojjaman.Gui.Components;
namespace Longkong.ShapeControl
{
	...
	public class ShapeControl : BasePropertyControl
	{
		...
		[ControlProperty("‡∂Á°", Description="§≈È“¬Êº—∫", Category="≈—°…≥–"),Category("Shape"),Description("Text to display")]
