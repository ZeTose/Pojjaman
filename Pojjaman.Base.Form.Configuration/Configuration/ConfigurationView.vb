...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Protected Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(ConfigurationView))
            ...
            Me.Validator.SetMaxValue(Me.txtOwner, "")
            ...
            Me.Size = New System.Drawing.Size(672, 360)
...
#Region "Members"
        ...
        Public ConfigFilters(12) As Filter
...
#Region "IListDetail"
        ...
        Public Sub SetLabelText()
            Me.lblTaxType.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ConfigurationView.lblTaxType}")
            Me.lblPhone.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ConfigurationView.lblPhone}")
            Me.lblFax.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ConfigurationView.lblFax}")
            Me.lblAddress.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ConfigurationView.lblAddress}")
            Me.lblName.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ConfigurationView.lblName}")
            Me.lblTaxID.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ConfigurationView.lblTaxID}")
            Me.Label8.Text = Me.StringParserService.Parse("${res:Global.PercentText}")
            Me.lblBillingAddress.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ConfigurationView.lblBillingAddress}")
            Me.lblInvMethod.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ConfigurationView.lblInvMethod}")
            Me.lblostMethod.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ConfigurationView.lblostMethod}")
            Me.lblAltName.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ConfigurationView.lblAltName}")
            Me.lblOwner.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ConfigurationView.lblOwner}")
            Me.lblTaxRate.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ConfigurationView.lblTaxRate}")
            Me.grbTax.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.ConfigurationView.grbTax}")
        End Sub
