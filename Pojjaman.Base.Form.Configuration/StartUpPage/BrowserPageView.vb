...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Protected Sub InitializeComponent()
      ...
      Me.grbDetail.Controls.Add(Me.WebBrowser1)
      ...
      Me.WebBrowser1.Size = New System.Drawing.Size(751, 483)
...
#Region "Members"
    Private m_entity As BrowserPage
...
#Region "Constructors"
    Public Sub New(ByVal entity As ISimpleEntity, ByVal handler As Object, ByVal basket As BasketDialog, ByVal filters As Filter(), ByVal entities As ArrayList)
      ...
      m_entity = New BrowserPage
      m_entity.CurrentUserId = User.CurrentUser.Id

      '--Fix--
      Dim defaultURL As String = Configuration.GetConfig("DefaultURL")
...
#End Region
    ...
    Private Sub rGrid_ChildViewExpanding(ByVal sender As Object, ByVal e As Telerik.WinControls.UI.ChildViewExpandingEventArgs)
