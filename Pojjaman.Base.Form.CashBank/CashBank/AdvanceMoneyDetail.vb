...
#Region "Constructs"
    Public Sub New()
      ...
      Dim dst As DataGridTableStyle = AdvanceMoneyDetail.CreateTableStyle()
...
#Region " Style "
    Public Shared Function CreateTableStyle() As DataGridTableStyle
      ...
      csLineNumber.MappingName = "advm_linenumber"
      ...
      csLineNumber.TextBox.Name = "advm_linenumber"
...
#Region "Event Handlers"
    Private Sub CellDblClick(ByVal sender As Object, ByVal e As System.EventArgs)
      ...
      Dim docId As Integer = CInt(tr("refDocId")) 'drh.GetValue(Of Integer)("DocId")
      Dim docType As Integer = CInt(tr("refDocType")) 'doc.drh.GetValue(Of Integer)("DocType")
