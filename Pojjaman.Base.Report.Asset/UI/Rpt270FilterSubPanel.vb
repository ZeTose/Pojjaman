...
Namespace Longkong.Pojjaman.Gui.Panels
  Public Class Rpt270FilterSubPanel
...
#Region " Windows Form Designer generated code "
    ...
    Friend WithEvents ChkOpb As System.Windows.Forms.CheckBox
        Friend WithEvents ChkNonRepair As System.Windows.Forms.CheckBox
        ...
        Friend WithEvents ChkDetailDoc As System.Windows.Forms.CheckBox
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            Me.components = New System.ComponentModel.Container()
            Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Rpt270FilterSubPanel))
            ...
            Me.ChkDetailDoc = New System.Windows.Forms.CheckBox()
            Me.ChkNonRepair = New System.Windows.Forms.CheckBox()
            ...
            Me.grbMaster.Size = New System.Drawing.Size(435, 246)
            ...
            Me.grbDetail.Controls.Add(Me.ChkDetailDoc)
            Me.grbDetail.Controls.Add(Me.ChkNonRepair)
            Me.grbDetail.Controls.Add(Me.ChkOpb)
            ...
            Me.grbDetail.Size = New System.Drawing.Size(408, 192)
            ...
            'btnLcistart
            '
            Me.btnLcistart.FlatStyle = System.Windows.Forms.FlatStyle.System
            ...
            Me.btnLcistart.Location = New System.Drawing.Point(368, 111)
            Me.btnLcistart.Name = "btnLcistart"
            Me.btnLcistart.Size = New System.Drawing.Size(24, 22)
            Me.btnLcistart.TabIndex = 23
            ...
            Me.txtnameCode.Location = New System.Drawing.Point(112, 112)
            ...
            Me.lblnameCode.Location = New System.Drawing.Point(38, 111)
            Me.lblnameCode.Name = "lblnameCode"
            Me.lblnameCode.Size = New System.Drawing.Size(66, 18)
            Me.lblnameCode.TabIndex = 35
            Me.lblnameCode.Text = "วัสดุ"
            Me.lblnameCode.TextAlign = System.Drawing.ContentAlignment.MiddleRight
            '
            'ChkDetailDoc
            '
            Me.ChkDetailDoc.Location = New System.Drawing.Point(216, 137)
            Me.ChkDetailDoc.Name = "ChkDetailDoc"
            Me.ChkDetailDoc.Size = New System.Drawing.Size(160, 24)
            Me.ChkDetailDoc.TabIndex = 34
            Me.ChkDetailDoc.Text = "แสดงรายละเอียดเอกสาร"
            '
            'ChkNonRepair
            '
            Me.ChkNonRepair.Location = New System.Drawing.Point(24, 161)
            Me.ChkNonRepair.Name = "ChkNonRepair"
            Me.ChkNonRepair.Size = New System.Drawing.Size(288, 24)
            Me.ChkNonRepair.TabIndex = 33
            Me.ChkNonRepair.Text = "แสดงสินทรัพย์ที่ไม่มีรายการซ่อมบำรุงในช่วงเวลาค้นหา"
            '
            'ChkOpb
            '
            Me.ChkOpb.Location = New System.Drawing.Point(24, 137)
            Me.ChkOpb.Name = "ChkOpb"
            Me.ChkOpb.Size = New System.Drawing.Size(104, 24)
            Me.ChkOpb.TabIndex = 32
            ...
            Me.txtDocDateStart.Size = New System.Drawing.Size(85, 21)
            ...
            Me.btnSearch.Location = New System.Drawing.Point(347, 214)
            ...
            Me.btnReset.Location = New System.Drawing.Point(267, 214)
            ...
            '
            'Rpt270FilterSubPanel
            '
            Me.Controls.Add(Me.grbMaster)
            Me.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(222, Byte))
            Me.Name = "Rpt270FilterSubPanel"
            Me.Size = New System.Drawing.Size(451, 266)
...
#Region " SetLabelText "
        Public Sub SetLabelText()
            ...
            Me.lblAssetStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt270FilterSubPanel.lblAssetStart}")
            Me.Validator.SetDisplayName(txtAssetCodeStart, lblAssetStart.Text)

            Me.lblAssetTypeStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt270FilterSubPanel.lblAssetTypeStart}")
            Me.Validator.SetDisplayName(txtAssetTypeCodeStart, lblAssetTypeStart.Text)

            Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt270FilterSubPanel.lblDocDateStart}")
            Me.Validator.SetDisplayName(txtDocDateStart, lblDocDateStart.Text)

            Me.lblCCStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt270FilterSubPanel.lblCCStart}")
            ...
            ' GroupBox
            Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt270FilterSubPanel.grbMaster}")
            Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt270FilterSubPanel.grbDetail}")

            Me.lblnameCode.Text = Me.StringParserService.Parse("${res:MainMenu.MatetialStock}")
            Me.ChkOpb.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt270FilterSubPanel.ChkOpb}")
            Me.ChkDetailDoc.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt270FilterSubPanel.ChkDetailDoc}")
...
#Region "Methods"
        ...
        Private Sub ClearCriterias()
            ...
            Me.ChkDetailDoc.Checked = False
            Me.ChkNonRepair.Checked = False
        ...
        Public Overrides Function GetFilterArray() As Filter()
            ...
            arr(9) = New Filter("ChkDetailDoc", IIf(ChkDetailDoc.Checked, 1, 0))
            arr(10) = New Filter("ChkNonRepair ", IIf(ChkNonRepair.Checked, 1, 0))
            arr(11) = New Filter("ChkOpb ", IIf(ChkOpb.Checked, 1, 0))
            arr(12) = New Filter("lci", IIf(txtnameCode.TextLength > 0, txtnameCode.Text, DBNull.Value))
...
#Region " ChangeProperty "
        Private Sub EventWiring()
            ...
            AddHandler ChkDetailDoc.CheckedChanged, AddressOf Me.ChangeProperty
            AddHandler ChkNonRepair.CheckedChanged, AddressOf Me.ChangeProperty
            AddHandler ChkOpb.CheckedChanged, AddressOf Me.ChangeProperty
...
#End Region
        ...
        Private Sub ImageButton1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnLcistart.Click
