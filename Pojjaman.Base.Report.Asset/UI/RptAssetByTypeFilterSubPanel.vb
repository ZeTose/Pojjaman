...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class RptAssetByTypeFilterSubPanel
...
#Region " Windows Form Designer generated code "
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RptAssetByTypeFilterSubPanel))
      ...
      Me.Name = "RptAssetByTypeFilterSubPanel"
...
#Region " SetLabelText "
        Public Sub SetLabelText()
            ...
            Me.lblAssetStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAssetByTypeFilterSubPanel.lblAssetStart}")
            Me.Validator.SetDisplayName(txtAssetCodeStart, lblAssetStart.Text)

            Me.lblAssetTypeStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAssetByTypeFilterSubPanel.lblAssetTypeStart}")
            Me.Validator.SetDisplayName(txtAssetTypeCodeStart, lblAssetTypeStart.Text)

            Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAssetByTypeFilterSubPanel.lblDocDateStart}")
            Me.Validator.SetDisplayName(txtDocDateStart, lblDocDateStart.Text)

            Me.lblCCStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAssetByTypeFilterSubPanel.lblCCStart}")
            ...
            ' GroupBox
            Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAssetByTypeFilterSubPanel.grbMaster}")
            Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptAssetByTypeFilterSubPanel.grbDetail}")
        End Sub
#End Region
