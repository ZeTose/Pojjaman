...
Namespace Longkong.Pojjaman.Gui.Panels
  Public Class Rpt266FilterSubPanel
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(Rpt266FilterSubPanel))
      ...
      Me.grbMaster.Controls.Add(Me.ChkDetailDoc)
      Me.grbMaster.Controls.Add(Me.ChkNonRepair)
      ...
      Me.grbMaster.Size = New System.Drawing.Size(440, 216)
      ...
      Me.btnSearch.Location = New System.Drawing.Point(352, 184)
      ...
      Me.btnReset.Location = New System.Drawing.Point(272, 184)
      ...
      '
      'Rpt266FilterSubPanel
      '
      Me.Controls.Add(Me.grbMaster)
      Me.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(222, Byte))
      Me.Name = "Rpt266FilterSubPanel"
      Me.Size = New System.Drawing.Size(456, 240)
...
#Region " SetLabelText "
    Public Sub SetLabelText()
      ...
      Me.lblAssetStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt266FilterSubPanel.lblAssetStart}")
      Me.Validator.SetDisplayName(txtAssetCodeStart, lblAssetStart.Text)

      Me.lblAssetTypeStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt266FilterSubPanel.lblAssetTypeStart}")
      Me.Validator.SetDisplayName(txtAssetTypeCodeStart, lblAssetTypeStart.Text)

      Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt266FilterSubPanel.lblDocDateStart}")
      Me.Validator.SetDisplayName(txtDocDateStart, lblDocDateStart.Text)

      Me.lblCCStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt266FilterSubPanel.lblCCStart}")
      ...
      ' GroupBox
      Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt266FilterSubPanel.grbMaster}")
      Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt266FilterSubPanel.grbDetail}")

      Me.ChkDetailDoc.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt266FilterSubPanel.ChkDetailDoc}")
      Me.ChkNonRepair.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt266FilterSubPanel.ChkNonRepair}")
      Me.ChkOpb.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.Rpt266FilterSubPanel.ChkOpb}")
