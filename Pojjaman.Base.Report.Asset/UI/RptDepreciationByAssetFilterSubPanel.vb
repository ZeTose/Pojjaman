...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class RptDepreciationByAssetFilterSubPanel
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Me.lblPeriodStart.Text = "§Ç´ºÑ­ªÕ"
...
#Region " SetLabelText "
        Public Sub SetLabelText()
            ...
            ' GroupBox
            Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptDepreciationByAssetFilterSubPanel.grbMaster}")
            Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptDepreciationByAssetFilterSubPanel.grbDetail}")
            Me.lblYearAcct.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptDepreciationByAssetFilterSubPanel.lblYearAcct}") '"»ÕÀÒÉÕ"
            Me.lblPeriodStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptDepreciationByAssetFilterSubPanel.lblPeriodStart}") '"§Ç´ºÑ­ªÕ"
