...
#Region "Methods"
    ...
    Private Sub CreateHeader()
      ...
      m_grid(1, 1).Text = indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.Rpt266.groupExpenses}")  '"รหัสประเภท"

      m_grid(2, 1).Text = indent & indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.Rpt266.assetCode}") '"รหัสประเภท"
      m_grid(2, 2).Text = indent & indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.Rpt266.assetName}") '"ชื่อประเภทสินทรัพย์"

      m_grid(3, 1).Text = indent & indent & indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.Rpt266.DocDate}")  '"No."
      m_grid(3, 2).Text = indent & indent & indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.Rpt266.materialCode}")  '"รหัสสินทรัพย์"
      m_grid(3, 3).Text = indent & indent & indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.Rpt266.expensesDetail}")  '"ชื่อสินทรัพย์"
      m_grid(3, 4).Text = indent & indent & indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.Rpt266.unit}")   '"วันที่ซื้อ"
      m_grid(3, 5).Text = indent & indent & indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.Rpt266.amount}")  '"รหัสสินทรัพย์"
      m_grid(3, 6).Text = indent & indent & indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.Rpt266.priceOfUnit}")  '"ชื่อสินทรัพย์"
      m_grid(3, 7).Text = indent & indent & indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.Rpt266.discamt}")   '"วันที่ซื้อ"
      m_grid(3, 8).Text = indent & indent & indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.Rpt266.Total}")  '"ชื่อสินทรัพย์"
      m_grid(3, 9).Text = indent & indent & indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.Rpt266.DocNo}")   '"วันที่ซื้อ"
