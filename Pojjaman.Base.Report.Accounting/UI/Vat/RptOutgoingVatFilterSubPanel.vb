...
Namespace Longkong.Pojjaman.Gui.Panels
  Public Class RptOutgoingVatFilterSubPanel
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(RptOutgoingVatFilterSubPanel))
      ...
      Me.grbDetail.Text = "Outgoing Vat Report"
      '
      'grbFixValue
      '
      ...
      Me.lblMonth.Location = New System.Drawing.Point(232, 14)
      Me.lblMonth.Name = "lblMonth"
      Me.lblMonth.Size = New System.Drawing.Size(56, 24)
      ...
      'grbDocDate
      '
      Me.grbDocDate.Controls.Add(Me.lblOrderBy)
      Me.grbDocDate.Controls.Add(Me.chkIncludeChildren)
      Me.grbDocDate.Controls.Add(Me.cmbOrderBy)
      ...
      'btnVatgEnd
      '
      Me.btnVatgEnd.FlatStyle = System.Windows.Forms.FlatStyle.System
      ...
      'btnVatgStart
      '
      Me.btnVatgStart.FlatStyle = System.Windows.Forms.FlatStyle.System
      ...
      Me.lblVatgStart.Location = New System.Drawing.Point(8, 62)
      Me.lblVatgStart.Name = "lblVatgStart"
      Me.lblVatgStart.Size = New System.Drawing.Size(96, 18)
      ...
      Me.lblOrderBy.Location = New System.Drawing.Point(227, 111)
      Me.lblOrderBy.Name = "lblOrderBy"
      Me.lblOrderBy.Size = New System.Drawing.Size(61, 18)
      ...
      '
      'RptOutgoingVatFilterSubPanel
      '
      Me.Controls.Add(Me.grbDetail)
      Me.Name = "RptOutgoingVatFilterSubPanel"
...
#Region " SetLabelText "
    Public Sub SetLabelText()
      ...
      Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingVatFilterSubPanel.lblDocDateStart}")
      Me.Validator.SetDisplayName(txtDocDateStart, lblDocDateStart.Text)

      Me.lblYear.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingVatFilterSubPanel.lblYear}")
      Me.lblMonth.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingVatFilterSubPanel.lblMonth}")

      Me.lblSubmitalDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingVatFilterSubPanel.lblSubmitalDateStart}")
      Me.Validator.SetDisplayName(txtSubmitalDateStart, lblSubmitalDateStart.Text)

      Me.lblVatgStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingVatFilterSubPanel.lblVatgStart}")
      ...
      ' GroupBox
      Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingVatFilterSubPanel.grbDetail}")
      Me.grbDocDate.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingVatFilterSubPanel.grbDocDate}")
      Me.grbFixValue.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingVatFilterSubPanel.grbFixValue}")
      'Checkbox
            Me.chkIncludeChildren.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingVatFilterSubPanel.chkIncludeChildren}")

            Me.lblOrderBy.Text = Me.StringParserService.Parse("${res:Global.OrderBy}")
    End Sub
#End Region
...
#Region "Methods"
    ...
    Public Overrides Function GetFilterArray() As Filter()
      ...
      arr(9) = New Filter("OrderBy", Me.cmbOrderBy.SelectedIndex)
      Return arr
    End Function
