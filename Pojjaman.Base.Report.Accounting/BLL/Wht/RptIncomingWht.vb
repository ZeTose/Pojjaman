...
#Region "Methods"
    ...
    Private Sub CreateHeader()
      ...
      m_grid.ColWidths(12) = 120   '"เลขประจำตัวผู้เสียภาษี"
      ...
      m_grid(0, 1).CellValue = indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptIncomingWht.PayDate}")    '"วันที่หัก ณ ที่จ่าย"
      m_grid(0, 2).CellValue = indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptIncomingWht.InVoid}")     '"เลขที่หัก ณ ที่จ่าย"
