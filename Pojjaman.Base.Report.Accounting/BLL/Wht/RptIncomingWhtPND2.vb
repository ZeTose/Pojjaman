...
Namespace Longkong.Pojjaman.BusinessLogic
  Public Class RptIncomingWhtPND2
...
#Region "Methods"
    ...
    '  m_grid(0, 1).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptIncomingWhtPND2.CostCenterID}") '"รหัส Cost Center"
    '  m_grid(0, 2).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.CRptIncomingWhtPND2.CostCenterName}") '"ชื่อ Cost Center"

    '  m_grid(1, 1).Text = indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.CRptIncomingWhtPND2.StockID}") '"รหัสวัสดุ"
    '  m_grid(1, 2).Text = indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.CRptIncomingWhtPND2.StockName}")  '"ชื่อวัสดุ"
    '  m_grid(1, 3).Text = indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.CRptIncomingWhtPND2.UnitName}")  '"ชื่อหน่วยนับ"
    '  m_grid(1, 4).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.CRptIncomingWhtPND2.Num}")  '"จำนวน"
    '  m_grid(1, 5).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.CRptIncomingWhtPND2.AvgPrice}")  '"ราคาเฉลี่ย"
    '  m_grid(1, 6).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.CRptIncomingWhtPND2.Capital}")  '"ต้นทุน"
    ...
    '        m_grid(currItemIndex, 5).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.CRptIncomingWhtPND2.ZeroStock}")
    '      Else
    '        m_grid(currItemIndex, 5).CellValue = Configuration.FormatToString(CDec(row("Costamt")) / CDec(row("QTY")), DigitConfig.Price)
    '      End If
    '    Else
    '      m_grid(currItemIndex, 5).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.CRptIncomingWhtPND2.NoCost}")
    '    End If
    ...
    '    Else
    '      m_grid(currItemIndex, 6).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.CRptIncomingWhtPND2.NoCost}")
    '    End If
...
#End Region#Region "Properties"    Public Overrides Property ReportName As String
      Get
        Return "RptIncomingWhtPND2"
        'Return "CRptIncomingWhtPND2"
      End Get
    ...
    Public Overrides ReadOnly Property DetailPanelTitle() As String
      Get
        Return "${res:Longkong.Pojjaman.BusinessLogic.RptIncomingWhtPND2.DetailLabel}"
      End Get
    End Property
    Public Overrides ReadOnly Property DetailPanelIcon() As String
      Get
        Return "Icons.16x16.RptIncomingWhtPND2"
      End Get
    End Property
    ...
    Public Overrides ReadOnly Property ListPanelTitle() As String
      Get
        Return "${res:Longkong.Pojjaman.BusinessLogic.RptIncomingWhtPND2.ListLabel}"
      End Get
    End Property
