...
#Region "Methods"
        ...
        Private Sub CreateHeader()
            ...
            m_grid(0, 5).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptIncomingVat.VatRunNumber}") '"เลขที่รัน"
            m_grid(0, 6).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptIncomingVat.RelatedDoc}") '"เลขที่เอกสารเกี่ยวข้อง"
            m_grid(0, 7).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptIncomingVat.SupplierName}") '"ชื่อผู้ขาย"
            m_grid(0, 8).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptIncomingVat.GroupName}") '"กลุ่มภาษี"
            m_grid(0, 9).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptIncomingVat.BeforeTax}") '"มูลค่าสินค้า/บริการ"
            m_grid(0, 10).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptIncomingVat.TaxAmount}") '"จำนวนเงินภาษี"
            m_grid(0, 11).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptIncomingVat.AfterTax}") '"รวม"
        ...
        Private Sub PopulateData()
            ...
            m_grid.RowStyles(currDocIndex).ReadOnly = True
            m_grid(currDocIndex, 8).CellValue = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptIncomingVat.SumAll}") '"รวมทั้งหมด"
            m_grid(currDocIndex, 9).CellValue = Configuration.FormatToString(SumBeforeTax, DigitConfig.Price)
            m_grid(currDocIndex, 10).CellValue = Configuration.FormatToString(SumTaxAmount, DigitConfig.Price)
            m_grid(currDocIndex, 11).CellValue = Configuration.FormatToString(SumAfterTax, DigitConfig.Price)
        End Sub
#End Region#Region "Shared"
