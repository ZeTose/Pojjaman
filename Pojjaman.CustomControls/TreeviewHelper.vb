...
Namespace Longkong.Pojjaman.Gui.Components
  ...
  Public Delegate Sub NodeActionWithObject(ByVal n As TreeNode, ByVal o As Object)
  Public NotInheritable Class TreeViewHelper
    ...
    Public Shared Sub TraverseNode(ByVal n As TreeNode, ByVal na As NodeAction)
      ...
      Next
    End Sub
    Public Shared Sub TraverseNodeWithObject(ByVal n As TreeNode, ByVal o As Object, ByVal na As NodeActionWithObject)
      na(n, o)
      For Each aNode As TreeNode In n.Nodes
        TraverseNodeWithObject(aNode, o, na)
      Next
    End Sub
