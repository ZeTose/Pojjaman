...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class RptOutgoingCheckPettyCashFilterSubPanel
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(RptOutgoingCheckPettyCashFilterSubPanel))
            ...
            Me.lblDocDateEnd.Location = New System.Drawing.Point(264, 24)
            ...
            Me.lblCheckDueDateEnd.Location = New System.Drawing.Point(264, 48)
            ...
            Me.lblCheckPassDateEnd.Location = New System.Drawing.Point(264, 72)
            ...
            '
            'RptOutgoingCheckPettyCashFilterSubPanel
            '
            Me.Controls.Add(Me.grbMaster)
            Me.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(222, Byte))
            Me.Name = "RptOutgoingCheckPettyCashFilterSubPanel"
...
#Region " SetLabelText "
        Public Sub SetLabelText()
            ...
            Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingCheckPettyCashFilterSubPanel.lblDocDateStart}")
            Me.Validator.SetDisplayName(txtDocDateStart, lblDocDateStart.Text)

            Me.lblCheckDueDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingCheckPettyCashFilterSubPanel.lblCheckDueDateStart}")
            Me.Validator.SetDisplayName(txtCheckDueDateStart, lblCheckDueDateStart.Text)

            Me.lblCheckPassDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingCheckPettyCashFilterSubPanel.lblCheckPassDateStart}")
            Me.Validator.SetDisplayName(txtCheckPassDateStart, lblCheckPassDateStart.Text)

            Me.lblBankAcctStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingCheckPettyCashFilterSubPanel.lblBankAcctStart}")
            Me.Validator.SetDisplayName(txtBankAcctCodeStart, lblBankAcctStart.Text)

            Me.lblSupplierStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingCheckPettyCashFilterSubPanel.lblSupplierStart}")
            ...
            ' GroupBox
            Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingCheckPettyCashFilterSubPanel.grbMaster}")
            Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingCheckPettyCashFilterSubPanel.grbDetail}")

            Me.lblChkStatus.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingCheckPettyCashFilterSubPanel.lblChkStatus}")
            Me.lblSort.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptOutgoingCheckPettyCashFilterSubPanel.lblSort}")
        End Sub
#End Region
