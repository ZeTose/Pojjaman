...
Namespace Longkong.Pojjaman.Gui.Panels
  Public Class RptIncomingCheckEnumerateFilterSubPanel
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(RptIncomingCheckEnumerateFilterSubPanel))
      ...
      Me.txtTemp.Location = New System.Drawing.Point(784, 32)
      ...
      Me.txtBankAcctCodeEnd.TabIndex = 10
      ...
      Me.txtBankAcctCodeStart.TabIndex = 9
      ...
      Me.btnCustomerStartFind.Location = New System.Drawing.Point(200, 96)
      ...
      Me.txtCustomerCodeStart.Location = New System.Drawing.Point(104, 96)
      ...
      Me.lblCustomerStart.Size = New System.Drawing.Size(88, 18)
      ...
      '
      'RptIncomingCheckEnumerateFilterSubPanel
      '
      Me.Controls.Add(Me.grbMaster)
      Me.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(222, Byte))
      Me.Name = "RptIncomingCheckEnumerateFilterSubPanel"
...
#Region " SetLabelText "
    Public Sub SetLabelText()
      ...
      Me.lblDocDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptIncomingCheckEnumerateFilterSubPanel.lblDocDateStart}")
      Me.Validator.SetDisplayName(txtDocDateStart, lblDocDateStart.Text)

      Me.lblCheckDueDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptIncomingCheckEnumerateFilterSubPanel.lblCheckDueDateStart}") '
      Me.Validator.SetDisplayName(txtCheckDueDateStart, lblCheckDueDateStart.Text)

      Me.lblCheckPassDateStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptIncomingCheckEnumerateFilterSubPanel.lblCheckPassDateStart}") '
      Me.Validator.SetDisplayName(txtCheckPassDateStart, lblCheckPassDateStart.Text)

      Me.lblBankAcctStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptIncomingCheckEnumerateFilterSubPanel.lblBankAcctStart}")
      Me.Validator.SetDisplayName(txtBankAcctCodeStart, lblBankAcctStart.Text)

      Me.lblCustomerStart.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptIncomingCheckEnumerateFilterSubPanel.lblCustomerStart}")
      ...
      ' GroupBox
      Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptIncomingCheckEnumerateFilterSubPanel.grbMaster}")
      Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptIncomingCheckEnumerateFilterSubPanel.grbDetail}")

      Me.lblChkStatus.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptIncomingCheckEnumerateFilterSubPanel.lblChkStatus}")
      Me.lblSort.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.RptIncomingCheckEnumerateFilterSubPanel.lblSort}")
    End Sub
#End Region
