...
#Region "Methods"
        ...
        Private Sub CreateHeader()
            ...
            m_grid(0, 3).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptAdvanceMoney.AdvmDate}") '"วันที่เงินทดรองจ่าย"
            m_grid(0, 4).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptAdvanceMoney.PVcode}") '"ใบสำคัญจ่าย"

            m_grid(0, 7).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptAdvanceMoney.AdvmOpen}") '"เงินทดรองจ่าย ยกมา"
            m_grid(0, 8).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptAdvanceMoney.AdvmAmt}") '"วงเงินทดรองจ่าย"
            m_grid(0, 10).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptAdvanceMoney.AdvmAmt}") '"วงเงินทดรองจ่าย"
            m_grid(0, 11).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptAdvanceMoney.Note}") '"หมายเหตุ"
            ...
            m_grid(1, 9).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptAdvanceMoney.PayAmt}") '"ยอดตัดจ่าย"
            m_grid(1, 10).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptAdvanceMoney.Remain}") '"ยอดคงเหลือ"
            m_grid(1, 11).Text = indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptAdvanceMoney.Note}") '"หมายเหตุ"
            ...
            m_grid(2, 11).Text = indent & indent & Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptAdvanceMoney.Note}") '"หมายเหตุ"
