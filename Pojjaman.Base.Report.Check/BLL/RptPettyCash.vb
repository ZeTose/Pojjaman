...
#Region "Methods"
    ...
    Private Sub CreateHeader()
      ...
      m_grid(0, 4).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPettyCash.PCOwnerCode}") '"สังกัดรัหส"
      m_grid(0, 5).Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.BusinessLogic.RptPettyCash.PCOwnerName}") '"สังกัดชื่อ"
    ...
    Private Sub PopulateData()
      ...
      For Each PCrow As DataRow In PCDt.Rows
        If PCrow("DocId").ToString <> currentPCCode Then
          ...
          m_grid.RowCount += 1
          currPCIndex = m_grid.RowCount
          m_hashData(m_grid.RowCount) = PCrow
          ...
          m_grid(currPCIndex, 4).CellValue = PCrow("employee_code")
          m_grid(currPCIndex, 5).CellValue = PCrow("employee_name")
