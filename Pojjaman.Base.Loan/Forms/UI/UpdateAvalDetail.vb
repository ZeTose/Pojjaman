...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Protected Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(UpdateAvalDetail))
...
#Region "Constructors"
    Public Sub New()
      ...
      'Dim dst As DataGridTableStyle = UpdateOutgoingAval.CreateTableStyle()
...
#Region "Event Handlers"
    Public Sub CheckButtonClick(ByVal e As ButtonColumnEventArgs)
      ...
      obj.DocStatus = New OutgoingCheckDocStatus(1)   ' แสดง เช็คในมือ เท่านั้น ...
      entities.Add(obj)
...
#Region "Overrides"
    Public Overrides ReadOnly Property TabPageIcon() As String
      Get
        Return (New UpdateOutgoingAval).DetailPanelIcon
      End Get
    End Property
#End Region
...
#Region "Rows Manager Button"
    ...
    Private Sub ibtnBlank_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ibtnBlank.Click
      ...
      Dim checkItem As New UpdateOutgoingAvalItem
...
#Region "Private Methods"
    Private Sub SetSummaryText()
      Dim totalamount As Decimal = Me.m_entity.OutgoingAvalTotalAmount
      txtSumCheck.Text = Configuration.FormatToString(Me.m_entity.OutgoingAvalItem, DigitConfig.Int)
