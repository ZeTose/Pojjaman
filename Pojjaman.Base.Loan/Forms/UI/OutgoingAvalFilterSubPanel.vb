...
Namespace Longkong.Pojjaman.Gui.Panels
  Public Class OutgoingAvalFilterSubPanel
...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
      ...
      Dim resources As System.ComponentModel.ComponentResourceManager = New System.ComponentModel.ComponentResourceManager(GetType(OutgoingAvalFilterSubPanel))
      ...
      Me.grbDetail.Size = New System.Drawing.Size(683, 188)
      ...
      Me.btnSearch.Location = New System.Drawing.Point(591, 159)
      ...
      Me.btnReset.Location = New System.Drawing.Point(513, 158)
      ...
      Me.txtLoanName.Location = New System.Drawing.Point(208, 144)
      ...
      Me.txtLoanName.Size = New System.Drawing.Size(168, 21)
      Me.txtLoanName.TabIndex = 23
      '
      'btnLoanEdit
      '
      Me.btnLoanEdit.FlatStyle = System.Windows.Forms.FlatStyle.System
      Me.btnLoanEdit.Font = New System.Drawing.Font("Tahoma", 8.25!, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, CType(222, Byte))
      Me.btnLoanEdit.Location = New System.Drawing.Point(400, 144)
      Me.btnLoanEdit.Name = "btnLoanEdit"
      Me.btnLoanEdit.Size = New System.Drawing.Size(24, 23)
      Me.btnLoanEdit.TabIndex = 25
      ...
      Me.lblLoan.Location = New System.Drawing.Point(8, 144)
      Me.lblLoan.Name = "lblLoan"
      Me.lblLoan.Size = New System.Drawing.Size(104, 18)
      Me.lblLoan.TabIndex = 21
      Me.lblLoan.Text = "วเงินกู้:"
      ...
      Me.btnLoanFind.Location = New System.Drawing.Point(376, 144)
      Me.btnLoanFind.Name = "btnLoanFind"
      Me.btnLoanFind.Size = New System.Drawing.Size(24, 23)
      Me.btnLoanFind.TabIndex = 24
      ...
      Me.txtLoanCode.Location = New System.Drawing.Point(120, 144)
      ...
      Me.txtLoanCode.Size = New System.Drawing.Size(88, 21)
      Me.txtLoanCode.TabIndex = 22
      '
      'OutgoingCheckFilterSubPanel
      '
      Me.Controls.Add(Me.grbDetail)
      Me.Name = "OutgoingCheckFilterSubPanel"
      Me.Size = New System.Drawing.Size(698, 207)
...
#Region "Methods"
    ...
    Private Sub ClearCriterias()
      ...
      Dim generalDocDateStartBeforeToday As Long = CLng(Configuration.GetConfig("GeneralDocDateStartBeforeToday"))
      Dim generalDocDateEndAfterToday As Long = CLng(Configuration.GetConfig("GeneralDocDateEndAfterToday"))
      Dim generalDueDateStartBeforeToday As Long = CLng(Configuration.GetConfig("GeneralDueDateStartBeforeToday"))
      Dim generalDueDateEndAfterToday As Long = CLng(Configuration.GetConfig("GeneralDueDateEndAfterToday"))
      ...
      Me.txtDueDateStart.Text = Me.MinDateToNull(DateAdd(DateInterval.Day, generalDocDateStartBeforeToday, Now.Date), "")
      Me.txtDueDateEnd.Text = Me.MinDateToNull(DateAdd(DateInterval.Day, generalDocDateEndAfterToday, Now.Date), "")
    ...
    Public Overrides Function GetFilterArray() As Filter()
      ...
      arr(4) = New Filter("bankaccount", IIf(Me.Loan.Originated, Me.Loan.Id, DBNull.Value))
...
#Region "Event Handlers"
    ...
    End Sub
    ' BLoan
    Private Sub txtLoanCode_Validated(ByVal sender As System.Object, ByVal e As System.EventArgs)
      Loan.GetLoan(txtLoanCode, txtLoanName, Me.Loan)
    End Sub
    Private Sub btnLoanEdit_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
      Dim myEntityPanelService As IEntityPanelService = CType(ServiceManager.Services.GetService(GetType(IEntityPanelService)), IEntityPanelService)
      myEntityPanelService.OpenPanel(New Loan)
    End Sub
    Private Sub btnLoanFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
      Dim myEntityPanelService As IEntityPanelService = CType(ServiceManager.Services.GetService(GetType(IEntityPanelService)), IEntityPanelService)
...
#End Region
    ...
    Public Sub SetLabelText()
      ...
      Me.grbDetail.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.OutgoingAvalFilterSubPanel.grbDetail}")
      ...
      Me.lblLoan.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.OutgoingAvalFilterSubPanel.lblLoan}")
    ...
    Private Sub EntityRefresh()
      ...
      For Each entity As ISimpleEntity In Entities
        ...
        If TypeOf entity Is OutgoingAval Then
          ' set me.Includeref
          Me.IncludeRef = False

          Dim obj As OutgoingAval = CType(entity, OutgoingAval)
          ...
          End If
          ' Loan 
          If obj.Loan.Originated Then
            Me.SetLoanDialog(obj.Loan)
            Me.txtLoanCode.Enabled = False
            Me.txtLoanName.Enabled = False
            Me.btnLoanEdit.Enabled = False
            Me.btnLoanFind.Enabled = False
          End If
        End If
