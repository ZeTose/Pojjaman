...
Namespace Longkong.Pojjaman.BusinessLogic
  Public Class UpdateOutgoingAval
...
#Region "Member"
    ...
    Private m_outgoingavalremoved As String
#End Region
...
#Region "Constructors"
    ...
    Protected Overloads Overrides Sub Construct()
      ...
      With Me
        ...
        .m_updatedstatus = New OutgoingCheckDocStatus(3)    ' ผ่าน ...
        .Status = New CheckStatus(-1)
        .m_je = New JournalEntry(Me)
        .m_outgoingavalremoved = ""
    ...
    Protected Overloads Overrides Sub Construct(ByVal dr As System.Data.DataRow, ByVal aliasPrefix As String)
      ...
      With Me
        ...
        If dr.Table.Columns.Contains(aliasPrefix & Me.Prefix & "_bankacct") _
          ...
          .m_loan = New Loan(CInt(dr(aliasPrefix & Me.Prefix & "_bankacct")))
        End If
        ' Total amount ...
...
#Region "Properties"
    ...
    Public ReadOnly Property OutgoingAvalTotalAmount() As Decimal
      Get
      ...
      End Get
    End Property
    Public ReadOnly Property OutgoingAvalItem() As Integer
      Get
      ...
      End Get
    End Property
    Public ReadOnly Property BankAccount() As BankAccount
      Get
    ...
    Public ReadOnly Property CheckRemovedInItemTable() As String
      Get
        Return m_outgoingavalremoved   ' จะมีค่าเมื่อ remove item.
      End Get
    End Property
    Public ReadOnly Property CheckInItemTable() As String
      Get
        Dim outgoinglist As String = ""
        For Each tr As TreeRow In Me.ItemTable.Childs
          If Me.ValidateRow(tr) Then
            If tr.Table.Columns.Contains("cqupdatei_entity") AndAlso Not tr.IsNull("cqupdatei_entity") Then
              outgoinglist += "|" & CInt(tr("cqupdatei_entity")) & "|"
            End If
          End If
        Next
        Return outgoinglist
...
#Region "Overrides"
    ...
    Public Overrides ReadOnly Property DetailPanelTitle() As String
      Get
        Return "${res:Longkong.Pojjaman.BusinessLogic.UpdateOutgoingAval.DetailLabel}"
      End Get
    End Property
    ...
    Public Overrides ReadOnly Property ListPanelTitle() As String
      Get
        Return "${res:Longkong.Pojjaman.BusinessLogic.UpdateOutgoingAval.ListLabel}"
      End Get
    End Property
...
#Region "Shared"
    Public Shared Function GetSchemaTable() As TreeTable
      ...
      ' Loan
      myDatatable.Columns.Add(New DataColumn("loan_id", GetType(Integer)))
      myDatatable.Columns.Add(New DataColumn("loan_code", GetType(String)))
      myDatatable.Columns.Add(New DataColumn("loan_name", GetType(String)))
      ...
      myDatatable.Columns.Add(New DataColumn("check_interest", GetType(Decimal)))
...
#Region "Methods"
      ...
      Try
        ...
        With ds.Tables("CheckUpdateItem")
          ...
          For n As Integer = 0 To Me.MaxRowIndex
            ...
            If ValidateRow(row) Then
              Dim item As New UpdateOutgoingAvalItem
    ...
    Private Function UpdateOldItemStatus(ByVal conn As SqlConnection, ByVal trans As SqlTransaction, Optional ByVal changeAll As Boolean = False) As SaveErrorException
      ...
      " where paymenti_entitytype = 336 and paymenti_status <> 0)" _
      , conn) '-----> มีใน checkupdate และ payment

        Dim daOldStatusRef As New SqlDataAdapter("select * from outgoingheck " & _
        "where check_id in (select cqupdatei_entity from CheckUpdateItem " & _
        " where cqupdatei_cqupdateid =" & Me.Id & ")" & _
...
#Region "Items"
    ...
    Private Sub LoadItems()
      ...
      For Each row As DataRow In ds.Tables(0).Rows
        Dim item As New UpdateOutgoingAvalItem(row, "")
        item.UpdateOutgoingAval = Me
        ' Hack : Huaneng ...
        Me.Add(item)
      Next
    End Sub
    Private Sub LoadItems(ByVal ds As System.Data.DataSet, ByVal aliasPrefix As String)
      For Each dr As DataRow In ds.Tables(1).Rows
        Dim item As New UpdateOutgoingAvalItem(dr, aliasPrefix)
        item.UpdateOutgoingAval = Me
        Me.Add(item)
      Next
    End Sub
    Public Sub AddBlankRow(ByVal count As Integer)
      ...
      Next
    End Sub
    Public Function Add(ByVal item As UpdateOutgoingAvalItem) As TreeRow
      ...
      Return myRow
    End Function
    Public Function Insert(ByVal index As Integer, ByVal item As UpdateOutgoingAvalItem) As TreeRow
    ...
    Public Sub Remove(ByVal index As Integer)
      ...
      Else
        ...
        If row.Table.Columns.Contains("cqupdatei_entity") AndAlso Not row.IsNull("cqupdatei_entity") Then
          m_outgoingavalremoved += "|" & CInt(row("cqupdatei_entity")) & "|"
        End If
    ...
    Public Overrides Function Delete() As SaveErrorException
      ...
      Try
        ...
        For Each tr As TreeRow In Me.ItemTable.Childs
          If Me.ValidateRow(tr) Then
            If tr.Table.Columns.Contains("cqupdatei_entity") AndAlso Not tr.IsNull("cqupdatei_entity") Then
              m_outgoingavalremoved += "|" & CInt(tr("cqupdatei_entity")) & "|"
            End If
          End If
        Next
...
#End Region
  ...
  ' Update check items
  Public Class UpdateOutgoingAvalItem

#Region "Members"
    Private m_updateoutgoingaval As UpdateOutgoingAval
    Private m_lineNumber As Integer
    Private m_entity As OutgoingAval
...
#Region "Properties"
    ...
    Public Property UpdateOutgoingAval() As UpdateOutgoingAval
      Get
        Return m_updateoutgoingaval
      End Get
      Set(ByVal Value As UpdateOutgoingAval)
        m_updateoutgoingaval = Value
      End Set
    End Property

    Public Property BeforeStatus() As OutgoingCheckDocStatus
      Get
    ...
    Public Property LineNumber() As Integer
      ...
      End Set
    End Property
    Public Property Entity() As OutgoingAval
      Get
        Return m_entity
      End Get
      Set(ByVal Value As OutgoingAval)
        m_entity = Value
      End Set
    End Property
...
#Region "Methods"
    Public Sub CopyToDataRow(ByVal row As TreeRow)
      If row Is Nothing Then
        Return
      End If
      Me.UpdateOutgoingAval.IsInitialized = False
      ...
      If Not Me.Entity Is Nothing Then
        ...
        row("check_duedate") = Entity.IssueDate
        row("check_recipient") = Entity.Recipient

        If Not Entity.Supplier Is Nothing Then
          row("check_supplier") = Entity.Supplier.Id
        End If
        If Not Me.Entity.Loan Is Nothing Then
          row("check_bankacct") = Me.Entity.Loan.Id
          row("bankacct_id") = Me.Entity.Loan.Id
          row("bankacct_code") = Me.Entity.Loan.Code
          row("bankacct_name") = Me.Entity.Loan.Name
        End If
        'If Not Me.Entity.Loan.BankAccount Is Nothing Then
        ...
        row("check_interest") = Me.Entity.InterestAmt
      ...
      Else
        ...
        row("check_interest") = DBNull.Value
      ...
      Me.UpdateOutgoingAval.IsInitialized = True
    End Sub
    Public Sub CopyFromDataRow(ByVal row As TreeRow)
      ...
      Try
        ...
        If row.Table.Columns.Contains("check_id") AndAlso Not row.IsNull(("check_id")) Then
          Me.Entity = New OutgoingAval(row, "")
        Else
          If row.Table.Columns.Contains("cqupdatei_entity") _
              AndAlso Not row.IsNull(("cqupdatei_entity")) Then
            Me.Entity = New OutgoingAval(CInt(row("cqupdatei_entity")))
          End If
        End If
