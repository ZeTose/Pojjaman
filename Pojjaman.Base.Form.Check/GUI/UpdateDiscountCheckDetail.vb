...
#Region "Properties"
    Private ReadOnly Property CurrentItem() As UpdateCheckDiscountItem
      Get
        Dim row As TreeRow = Me.m_treeManager.SelectedRow
        If row Is Nothing Then
          Return Nothing
        End If
        Dim doc As New UpdateCheckDiscountItem
...
#Region "Event Handlers"
    ...
    Private Sub CellDblClick(ByVal sender As Object, ByVal e As System.EventArgs)
      ...
      Dim doc As UpdateCheckDiscountItem = Me.CurrentItem
      If doc Is Nothing Then
        Return
      End If
