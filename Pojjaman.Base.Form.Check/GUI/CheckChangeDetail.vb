...
#Region " SetLabelText "
        Public Overrides Sub SetLabelText()
            ...
            Me.grbMaster.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.CheckChangeDetail.grbMaster}")
            Me.lblOldItem.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.CheckChangeDetail.lblOldItem}")
            Me.lblNewItem.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.CheckChangeDetail.lblNewItem}")
            Me.lblCash.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.CheckChangeDetail.lblCash}")
        End Sub
