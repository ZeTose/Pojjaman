...
Namespace Longkong.Pojjaman.Gui.Panels
    Public Class PLE_OutgoingCheckDetailView
...
#Region " Windows Form Designer generated code "
        ...
        <System.Diagnostics.DebuggerStepThrough()> Protected Sub InitializeComponent()
            ...
            Dim resources As System.Resources.ResourceManager = New System.Resources.ResourceManager(GetType(PLE_OutgoingCheckDetailView))
            ...
            Me.ibtnDelRow.Location = New System.Drawing.Point(192, 248)
            ...
            '
            'PLE_OutgoingCheckDetailView
            '
            Me.Controls.Add(Me.grbOutgoingCheck)
            Me.Name = "PLE_OutgoingCheckDetailView"
...
#Region " SetLabelText "
        Public Overrides Sub SetLabelText()
            ...
            Me.lblCode.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.PLE_OutgoingCheckDetailView.lblCode}")
            Me.Validator.SetDisplayName(txtCode, lblCode.Text)

            Me.lblCqCode.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.PLE_OutgoingCheckDetailView.lblCqCode}")
            Me.Validator.SetDisplayName(txtCqCode, lblCqCode.Text)

            Me.lblIssueDate.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.PLE_OutgoingCheckDetailView.lblIssueDate}")
            ...
            Me.lblrecipient.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.PLE_OutgoingCheckDetailView.lblrecipient}")
            Me.Validator.SetDisplayName(txtrecipient, lblrecipient.Text)

            Me.lblSupplier.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.PLE_OutgoingCheckDetailView.lblSupplier}")
            ...
            Me.lblBank.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.PLE_OutgoingCheckDetailView.lblBank}")
            Me.Validator.SetDisplayName(txtBankAccountCode, lblBankAccount.Text)

            Me.lblAmount.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.PLE_OutgoingCheckDetailView.lblAmount}")
            ...
            Me.lblCheckStatus.Text = Me.StringParserService.Parse("${res:Longkong.Pojjaman.Gui.Panels.PLE_OutgoingCheckDetailView.lblCheckStatus}")
        End Sub
#End Region
